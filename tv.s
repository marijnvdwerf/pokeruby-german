...
sub_80BE478: @ 80BE478
	...
	adds r4, r0
	lsls r4, 2
	ldr r0, _080BE57C @ =gSaveBlock1 + 0x2738
	adds r4, r0
	movs r6, 0x5
	strb r6, [r4]
	movs r5, 0x1
...
_080BE57C: .4byte gSaveBlock1 + 0x2738
...
sub_80BE65C: @ 80BE65C
	...
	adds r4, r0
	lsls r4, 2
	ldr r0, _080BE69C @ =gSaveBlock1 + 0x2738
	adds r4, r0
	movs r5, 0
	movs r0, 0x2
	strb r0, [r4]
...
_080BE69C: .4byte gSaveBlock1 + 0x2738
...
_080BE78C:
	...
	cmp r6, 0
	bne _080BE836
	ldr r7, _080BE84C @ =gSaveBlock1 + 0x2738
	adds r0, r7, 0
	bl sub_80BF720
