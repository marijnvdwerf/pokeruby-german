...
sub_80BE478: @ 80BE478
	...
	push {r5-r7}
	bl sub_80BF478
	ldr r0, _080BE564 @ =gScriptResult
	ldrh r0, [r0]
	cmp r0, 0x1
	beq _080BE554
	ldr r0, _080BE568 @ =gSpecialVar_0x8004
	mov r9, r0
	ldrh r0, [r0]
	movs r1, 0x64
	mov r8, r1
	...
	muls r1, r0
	adds r0, r1, 0
	ldr r7, _080BE56C @ =gPlayerParty
	adds r0, r7
	ldr r4, _080BE570 @ =gStringVar1
	movs r1, 0x2
	adds r2, r4, 0
	bl GetMonData
	ldr r0, _080BE574 @ =gSaveBlock2
	mov r10, r0
	bl StringLength
	lsls r0, 16
	lsrs r0, 16
	...
	cmp r0, 0x1
	bls _080BE554
	ldr r0, _080BE578 @ =gUnknown_03005D38
	ldrb r0, [r0]
	lsls r0, 24
	asrs r0, 24
	lsls r4, r0, 3
...
_080BE554:
	...
	bx r0
	.align 2, 0
_080BE564: .4byte gScriptResult
_080BE568: .4byte gSpecialVar_0x8004
_080BE56C: .4byte gPlayerParty
_080BE570: .4byte gStringVar1
_080BE574: .4byte gSaveBlock2
_080BE578: .4byte gUnknown_03005D38
_080BE57C: .4byte 0x02027e6c
...
sub_80BE65C: @ 80BE65C
	push {r4,r5,lr}
	ldr r0, _080BE698 @ =gUnknown_03005D38
	ldrb r0, [r0]
	lsls r0, 24
	asrs r0, 24
	lsls r4, r0, 3
	...
	bx r0
	.align 2, 0
_080BE698: .4byte gUnknown_03005D38
_080BE69C: .4byte 0x02027e6c
_080BE6A0: .4byte gSaveBlock2
...
sub_80BF4F4: @ 80BF4F4
	...
	movs r1, 0x64
	muls r1, r0
	ldr r0, _080BF548 @ =gPlayerParty
	adds r5, r1, r0
	ldr r6, _080BF54C @ =gStringVar1
	adds r0, r5, 0
	movs r1, 0x2
	adds r2, r6, 0
	bl GetMonData
	...
	movs r1, 0xB
	muls r0, r1
	ldr r1, _080BF550 @ =gSpeciesNames
	adds r0, r1
	adds r1, r6, 0
	bl StringCompareWithoutExtCtrlCodes
	cmp r0, 0
	...
	b _080BF556
	.align 2, 0
_080BF548: .4byte gPlayerParty
_080BF54C: .4byte gStringVar1
_080BF550: .4byte gSpeciesNames
_080BF554:
	movs r0, 0x1
_080BF556:
	add sp, 0x4
...
_080BFDE8:
	...
	lsls r3, 3
	adds r2, r5, r3
	ldr r3, _080BFE20 @ =0x02027e6c
	adds r0, r5, 0
	bl sub_80BFE24
_080BFDFC:
	ldr r4, _080BFE20 @ =0x02027e6c
	adds r0, r4, 0
	bl sub_80BF588
	bl sub_80C04A0
	adds r0, r4, 0
