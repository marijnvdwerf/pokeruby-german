...
sub_812C220: @ 812C220
	...
	adds r0, r4, 0
	bl oamt_set_x3A_32
	ldr r1, _0812C260 @ =0x04000050
	movs r2, 0xFD
	lsls r2, 6
	adds r0, r2, 0
	strh r0, [r1]
	ldr r2, _0812C264 @ =0x04000052
	ldrh r1, [r4, 0x30]
	movs r0, 0x10
	subs r0, r1
	lsls r0, 8
...
_0812F13E:
	...
	orrs r4, r0
	strb r4, [r5, 0x5]
	ldr r1, _0812F228 @ =0x04000050
	movs r2, 0xFD
	lsls r2, 6
	adds r0, r2, 0
	strh r0, [r1]
	ldr r3, _0812F22C @ =0x04000052
...
_0812F388:
	...
	cmp r0, 0x1
	bne _0812F3DC
	ldr r0, _0812F3C8 @ =0x04000014
	str r0, [sp]
	ldr r1, _0812F3CC @ =0x04000050
...
_0812F3DC:
	ldr r0, _0812F454 @ =0x04000018
	str r0, [sp]
	ldr r1, _0812F458 @ =0x04000050
...
_08135498:
	...
	adds r0, r1
	lsls r0, 3
	ldr r1, _081354B0 @ =0x0840f5ac
	adds r0, r1
	bl sub_813545C
	b _081354C4
	.align 2, 0
_081354B0: .4byte 0x0840f5ac
_081354B4:
	ldrb r1, [r1]
	movs r0, 0xA4
	muls r0, r1
...
_081360EC:
	cmp r0, 0x1
	bne _081360FC
	ldr r0, _081360F8 @ =0x02025364
	bl sub_813545C
	b _08136102
	.align 2, 0
_081360F8: .4byte 0x02025364
_081360FC:
	ldr r0, _08136108 @ =0x02025358
	bl sub_813545C
_08136102:
	pop {r0}
	bx r0
...
_0813649A:
	...
	str r1, [r0, 0x8]
	ldr r0, [r0, 0x8]
	ldr r0, _081364D0 @ =0x04000016
	strh r2, [r0]
	subs r0, 0x2
	strh r2, [r0]
	ldr r1, _081364D4 @ =0x0400000a
	movs r2, 0xF8
	lsls r2, 5
	adds r0, r2, 0
	strh r0, [r1]
...
_08136538:
	ldr r1, _08136584 @ =0x04000040
	movs r0, 0xF0
	strh r0, [r1]
	adds r1, 0x2
	movs r0, 0x9B
	strh r0, [r1]
	ldr r0, _08136588 @ =0x04000044
	ldr r2, _0813658C @ =0x00003273
	adds r1, r2, 0
	strh r1, [r0]
	adds r0, 0x2
	strh r1, [r0]
	ldr r1, _08136590 @ =0x04000048
