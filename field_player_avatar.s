...
sub_80587B4: @ 8058AF4
	...
	adds r0, r2
	lsls r0, 2
	ldr r2, _08058B10 @ =gMapObjects
	adds r0, r2
	ldr r2, _08058B14 @ =sub_80587D8
	bl meta_step
	pop {r0}
	bx r0
	.align 2, 0
...
player_step: @ 8058B1C
	...
	lsls r2, 16
	lsrs r6, r2, 16
	ldr r4, _08058B8C @ =gPlayerAvatar
	ldrb r1, [r4, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _08058B90 @ =gMapObjects
	adds r5, r0, r1
	adds r0, r5, 0
	bl sub_8059D60
	ldrb r0, [r4, 0x6]
...
npc_clear_strange_bits: @ 8058BE8
	...
	ands r1, r2
	strb r1, [r0, 0x1]
	ldr r2, _08058C08 @ =gPlayerAvatar
	ldrb r1, [r2]
	movs r0, 0x7F
	ands r0, r1
	strb r0, [r2]
...
MovePlayerAvatarUsingKeypadInput: @ 8058C0C
	...
	lsls r2, 16
	lsrs r2, 16
	ldr r0, _08058C30 @ =gPlayerAvatar
	ldrb r1, [r0]
	movs r0, 0x6
	ands r0, r1
	cmp r0, 0
...
PlayerAllowForcedMovementIfMovingSameDirection: @ 8058C44
	push {lr}
	ldr r2, _08058C5C @ =gPlayerAvatar
	ldrb r0, [r2, 0x2]
	cmp r0, 0x2
	bne _08058C56
	ldrb r1, [r2]
...
TryDoMetatileBehaviorForcedMovement: @ 8058C60
	push {r4,lr}
	ldr r4, _08058C80 @ =gUnknown_0830FBA0
...
GetForcedMovementByMetatileBehavior: @ 8058C84
	push {r4-r6,lr}
	ldr r3, _08058CC0 @ =gPlayerAvatar
	ldrb r1, [r3]
	movs r0, 0x20
	ands r0, r1
	cmp r0, 0
	bne _08058CD6
	ldr r2, _08058CC4 @ =gMapObjects
	ldrb r1, [r3, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	...
	ldrb r5, [r0, 0x1E]
	movs r4, 0
	ldr r6, _08058CC8 @ =gUnknown_0830FB58
_08058CA4:
	lsls r0, r4, 2
	adds r0, r6
	ldr r1, [r0]
...
ForcedMovement_None: @ 8058CE0
	push {r4,lr}
	ldr r4, _08058D24 @ =gPlayerAvatar
	ldrb r1, [r4]
	movs r0, 0x40
	ands r0, r1
	cmp r0, 0
...
DoForcedMovement: @ 8058D2C
	...
	lsls r0, 24
	lsrs r5, r0, 24
	ldr r6, _08058D6C @ =gPlayerAvatar
	adds r0, r5, 0
...
DoForcedMovementInCurrentDirection: @ 8058DA4
	push {lr}
	adds r1, r0, 0
	ldr r0, _08058DD0 @ =gPlayerAvatar
	ldrb r2, [r0, 0x5]
	lsls r0, r2, 3
	adds r0, r2
	lsls r0, 2
	ldr r2, _08058DD4 @ =gMapObjects
	adds r0, r2
	ldrb r2, [r0, 0x1]
	movs r3, 0x4
	orrs r2, r3
...
sub_8058AAC: @ 8058DEC
	push {lr}
	ldr r1, _08058E00 @ =PlayerGoSpeed0
	movs r0, 0x1
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
sub_8058AC4: @ 8058E04
	push {lr}
	ldr r1, _08058E18 @ =PlayerGoSpeed0
	movs r0, 0x2
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
sub_8058ADC: @ 8058E1C
	push {lr}
	ldr r1, _08058E30 @ =PlayerGoSpeed0
	movs r0, 0x3
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
sub_8058AF4: @ 8058E34
	push {lr}
	ldr r1, _08058E48 @ =PlayerGoSpeed0
	movs r0, 0x4
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
sub_8058B0C: @ 8058E4C
	push {lr}
	ldr r1, _08058E60 @ =npc_use_some_d2s
	movs r0, 0x1
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
sub_8058B24: @ 8058E64
	push {lr}
	ldr r1, _08058E78 @ =npc_use_some_d2s
	movs r0, 0x2
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
sub_8058B3C: @ 8058E7C
	push {lr}
	ldr r1, _08058E90 @ =npc_use_some_d2s
	movs r0, 0x3
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
sub_8058B54: @ 8058E94
	push {lr}
	ldr r1, _08058EA8 @ =npc_use_some_d2s
	movs r0, 0x4
	bl DoForcedMovement
	lsls r0, 24
	lsrs r0, 24
...
ForcedMovement_Slide: @ 8058EAC
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _08058EDC @ =gPlayerAvatar
	ldrb r3, [r2, 0x5]
	lsls r2, r3, 3
	adds r2, r3
	lsls r2, 2
	ldr r3, _08058EE0 @ =gMapObjects
	adds r2, r3
	ldrb r3, [r2, 0x1]
	movs r4, 0x4
	orrs r3, r4
...
ForcedMovement_MuddySlope: @ 8058F5C
	push {r4,lr}
	ldr r0, _08058FA0 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _08058FA4 @ =gMapObjects
	adds r4, r0, r1
	ldrb r1, [r4, 0x18]
	movs r0, 0xF0
	ands r0, r1
...
MovePlayerNotOnBike: @ 8058FB4
	...
	lsls r5, 16
	lsrs r5, 16
	ldr r6, _08058FE0 @ =gUnknown_0830FBEC
	adds r0, r4, 0
...
CheckMovementInputNotOnBike: @ 8058FE4
	...
	cmp r4, 0
	bne _08058FFC
	ldr r0, _08058FF8 @ =gPlayerAvatar
	strb r4, [r0, 0x2]
	movs r0, 0
	b _0805901E
	.align 2, 0
...
_08058FFC:
	...
	cmp r4, r0
	beq _08059018
	ldr r1, _08059014 @ =gPlayerAvatar
	ldrb r0, [r1, 0x2]
	cmp r0, 0x2
	beq _08059018
	movs r0, 0x1
...
_08059018:
	ldr r1, _08059024 @ =gPlayerAvatar
	movs r0, 0x2
_0805901C:
	strb r0, [r1, 0x2]
_0805901E:
...
_08059072:
	...
	b _080590EE
_08059084:
	ldr r6, _08059098 @ =gPlayerAvatar
	ldrb r1, [r6]
	movs r0, 0x8
	ands r0, r1
	cmp r0, 0
...
CheckForPlayerAvatarCollision: @ 80590F4
	...
	lsls r6, 24
	lsrs r6, 24
	ldr r0, _08059158 @ =gPlayerAvatar
	ldrb r0, [r0, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r0, _0805915C @ =gMapObjects
	adds r4, r0
	ldrh r1, [r4, 0x10]
	add r0, sp, 0x4
	strh r1, [r0]
...
sub_8058EF0: @ 8059230
	...
	lsls r2, 24
	lsrs r6, r2, 24
	ldr r0, _0805927C @ =gPlayerAvatar
	ldrb r1, [r0]
	movs r0, 0x8
	ands r0, r1
	cmp r0, 0
...
check_acro_bike_metatile: @ 8059358
	...
	lsrs r5, r2, 24
	movs r4, 0
	ldr r7, _08059380 @ =gUnknown_0830FBF8
_08059364:
	lsls r0, r4, 2
	adds r0, r7
	ldr r1, [r0]
	...
	cmp r0, 0
	beq _08059388
	ldr r0, _08059384 @ =gUnknown_0830FC0C
	adds r0, r4, r0
	ldrb r0, [r0]
	strb r0, [r6]
	b _08059392
...
SetPlayerAvatarTransitionFlags: @ 8059398
	...
	lsls r0, 16
	lsrs r0, 16
	ldr r2, _080593B0 @ =gPlayerAvatar
	ldrb r1, [r2, 0x1]
	orrs r0, r1
	strb r0, [r2, 0x1]
	bl DoPlayerAvatarTransition
...
DoPlayerAvatarTransition: @ 80593B4
	push {r4,r5,lr}
	ldr r0, _080593FC @ =gPlayerAvatar
	ldrb r4, [r0, 0x1]
	cmp r4, 0
	beq _080593F4
	movs r5, 0
_080593C0:
	...
	cmp r0, 0
	beq _080593E2
	ldr r0, _08059400 @ =gUnknown_0830FC14
	lsls r2, r5, 2
	adds r2, r0
	ldr r0, _080593FC @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
...
_080593E2:
	...
	cmp r5, 0x7
	bls _080593C0
	ldr r1, _080593FC @ =gPlayerAvatar
	movs r0, 0
	strb r0, [r1, 0x1]
_080593F4:
	pop {r4,r5}
...
PlayerAvatarTransition_Surfing: @ 80594A4
	...
	movs r0, 0x8
	bl SetPlayerAvatarStateMask
	ldr r1, _080594F8 @ =gUnknown_0202FF84
	movs r2, 0x10
	ldrsh r0, [r4, r2]
	str r0, [r1]
	movs r2, 0x12
	ldrsh r0, [r4, r2]
	str r0, [r1, 0x4]
	ldr r0, _080594FC @ =gPlayerAvatar
	ldrb r0, [r0, 0x5]
	str r0, [r1, 0x8]
	movs r0, 0x8
	bl FieldEffectStart
...
sub_80591F4: @ 8059534
	ldr r2, _08059540 @ =gPlayerAvatar
	ldrb r1, [r2]
	movs r0, 0x20
	orrs r0, r1
	strb r0, [r2]
...
sub_8059204: @ 8059544
	push {r4,lr}
	ldr r4, _08059570 @ =gPlayerAvatar
	movs r0, 0
	strb r0, [r4, 0x3]
...
player_is_anim_in_certain_ranges: @ 8059588
	push {lr}
	ldr r2, _080595D4 @ =gMapObjects
	ldr r0, _080595D8 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
...
sub_80592A4: @ 80595E4
	...
	cmp r0, 0
	beq _08059600
	ldr r0, _080595FC @ =gPlayerAvatar
	ldrb r0, [r0, 0x2]
	cmp r0, 0x1
	beq _08059600
	movs r0, 0x1
...
PlayerIsAnimActive: @ 8059608
	push {lr}
	ldr r0, _08059624 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _08059628 @ =gMapObjects
	adds r0, r1
	bl FieldObjectIsSpecialAnimOrDirectionSequenceAnimActive
	lsls r0, 24
	lsrs r0, 24
...
PlayerCheckIfAnimFinishedOrInactive: @ 805962C
	push {lr}
	ldr r0, _08059648 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _0805964C @ =gMapObjects
	adds r0, r1
...
player_set_x22: @ 8059650
	ldr r3, _08059664 @ =gMapObjects
	ldr r1, _08059668 @ =gPlayerAvatar
	ldrb r2, [r1, 0x5]
	lsls r1, r2, 3
	adds r1, r2
	lsls r1, 2
...
player_get_x22: @ 805966C
	ldr r2, _08059680 @ =gMapObjects
	ldr r0, _08059684 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
...
sub_8059348: @ 8059688
	...
	lsls r1, 24
	lsrs r1, 24
	ldr r0, _080596A8 @ =gPlayerAvatar
	ldrb r2, [r0, 0x5]
	lsls r0, r2, 3
	adds r0, r2
	lsls r0, 2
	ldr r2, _080596AC @ =gMapObjects
	adds r0, r2
...
player_npc_set_state_and_x22_etc: @ 80596B0
	...
	adds r0, r4, 0
	bl player_set_x22
	ldr r0, _080596E4 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _080596E8 @ =gMapObjects
	adds r0, r1
	adds r1, r5, 0
...
sub_80594C0: @ 8059800
	push {r4,lr}
	ldr r4, _0805983C @ =gPlayerAvatar
	ldrb r0, [r4, 0x3]
	cmp r0, 0x2
	beq _0805980E
	cmp r0, 0
...
PlayCollisionSoundIfNotFacingWarp: @ 8059988
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r2, _080599F8 @ =gMapObjects
	ldr r0, _080599FC @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	adds r0, r2
	ldrb r0, [r0, 0x1E]
	ldr r2, _08059A00 @ =gUnknown_0830FC34
	subs r1, r4, 0x1
	lsls r1, 2
	adds r1, r2
	ldr r1, [r1]
...
GetXYCoordsOneStepInFrontOfPlayer: @ 8059A04
	...
	adds r4, r0, 0
	adds r5, r1, 0
	ldr r3, _08059A40 @ =gMapObjects
	ldr r2, _08059A44 @ =gPlayerAvatar
	ldrb r1, [r2, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
...
PlayerGetDestCoords: @ 8059A48
	push {r4,r5,lr}
	ldr r5, _08059A70 @ =gMapObjects
	ldr r4, _08059A74 @ =gPlayerAvatar
	ldrb r3, [r4, 0x5]
	lsls r2, r3, 3
	adds r2, r3
	lsls r2, 2
...
player_get_direction_lower_nybble: @ 8059A78
	ldr r2, _08059A90 @ =gMapObjects
	ldr r0, _08059A94 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
...
player_get_direction_upper_nybble: @ 8059A98
	ldr r2, _08059AAC @ =gMapObjects
	ldr r0, _08059AB0 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
...
PlayerGetZCoord: @ 8059AB4
	ldr r2, _08059AC8 @ =gMapObjects
	ldr r0, _08059ACC @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
...
unref_sub_8059790: @ 8059AD0
	...
	adds r3, r0, 0
	adds r2, r1, 0
	ldr r0, _08059AF8 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _08059AFC @ =gMapObjects
	adds r0, r1
	lsls r3, 16
	asrs r3, 16
	lsls r2, 16
...
TestPlayerAvatarFlags: @ 8059B00
	ldr r1, _08059B0C @ =gPlayerAvatar
	ldrb r1, [r1]
	ands r1, r0
	adds r0, r1, 0
	bx lr
...
sub_80597D0: @ 8059B10
	ldr r0, _08059B18 @ =gPlayerAvatar
	ldrb r0, [r0]
	bx lr
	.align 2, 0
...
GetPlayerAvatarObjectId: @ 8059B1C
	ldr r0, _08059B24 @ =gPlayerAvatar
	ldrb r0, [r0, 0x4]
	bx lr
	.align 2, 0
...
sub_80597F4: @ 8059B34
	push {r4,lr}
	ldr r0, _08059B74 @ =gPlayerAvatar
	ldrb r0, [r0, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r0, _08059B78 @ =gMapObjects
	adds r4, r0
	adds r0, r4, 0
	bl npc_clear_strange_bits
	ldrb r1, [r4, 0x18]
...
sub_805983C: @ 8059B7C
	...
	lsls r1, 24
	lsrs r1, 24
	ldr r2, _08059B90 @ =gUnknown_0830FC44
	lsrs r0, 23
	adds r1, r0
	adds r1, r2
	ldrb r0, [r1]
...
GetPlayerAvatarGraphicsIdByStateIdAndGender: @ 8059B94
	...
	lsls r1, 24
	lsrs r1, 24
	ldr r2, _08059BA8 @ =gUnknown_0830FC54
	lsrs r0, 23
	adds r1, r0
	adds r1, r2
	ldrb r0, [r1]
...
GetPlayerAvatarGraphicsIdByStateId: @ 8059BAC
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r1, _08059BC4 @ =gPlayerAvatar
	ldrb r1, [r1, 0x7]
...
IsPlayerFacingSurfableFishableWater: @ 8059C94
	push {r4,r5,lr}
	sub sp, 0x4
	ldr r0, _08059D0C @ =gPlayerAvatar
	ldrb r0, [r0, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r0, _08059D10 @ =gMapObjects
	adds r4, r0
	ldrh r1, [r4, 0x10]
	mov r0, sp
	strh r1, [r0]
...
ClearPlayerAvatarInfo: @ 8059D20
	push {lr}
	ldr r0, _08059D30 @ =gPlayerAvatar
	movs r1, 0
	movs r2, 0x24
	bl memset
	pop {r0}
...
SetPlayerAvatarStateMask: @ 8059D34
	lsls r0, 24
	lsrs r0, 24
	ldr r3, _08059D48 @ =gPlayerAvatar
	ldrb r2, [r3]
	movs r1, 0xE0
	ands r1, r2
	orrs r0, r1
...
GetPlayerAvatarStateTransitionByGraphicsId: @ 8059D4C
	...
	lsrs r1, 24
	movs r2, 0
	ldr r3, _08059D74 @ =gUnknown_0830FC64
	lsls r0, r1, 2
	adds r0, r1
	lsls r4, r0, 1
	adds r6, r3, 0x1
...
GetPlayerAvatarGraphicsIdByCurrentState: @ 8059D8C
	push {r4-r6,lr}
	ldr r0, _08059DB4 @ =gPlayerAvatar
	ldrb r5, [r0]
	movs r2, 0
	ldr r3, _08059DB8 @ =gUnknown_0830FC64
	ldrb r1, [r0, 0x7]
	lsls r0, r1, 2
	adds r0, r1
	lsls r4, r0, 1
...
SetPlayerAvatarExtraStateTransition: @ 8059DD0
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r5, _08059DFC @ =gPlayerAvatar
	ldrb r1, [r5, 0x7]
...
InitPlayerAvatar: @ 8059E00
	...
	ldr r0, _08059EC4 @ =gPlayerAvatar
	strb r6, [r0, 0x2]
	strb r6, [r0, 0x3]
	strb r5, [r0, 0x5]
	ldrb r1, [r4, 0x4]
...
sub_8059B88: @ 8059EC8
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r6, _08059F28 @ =gMapObjects
	ldr r5, _08059F2C @ =gPlayerAvatar
	ldrb r0, [r5, 0x5]
	lsls r1, r0, 3
	adds r1, r0
	lsls r1, 2
...
sub_8059BF4: @ 8059F34
	push {r4,r5,lr}
	ldr r5, _08059F70 @ =gPlayerAvatar
	ldrb r0, [r5, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r0, _08059F74 @ =gMapObjects
	adds r4, r0
	movs r0, 0x5
	bl GetPlayerAvatarGraphicsIdByStateId
	adds r1, r0, 0
...
sub_8059C3C: @ 8059F7C
	...
	lsls r5, 24
	lsrs r5, 24
	ldr r6, _08059FC8 @ =gPlayerAvatar
	ldrb r0, [r6, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r0, _08059FCC @ =gMapObjects
	adds r4, r0
	movs r0, 0x6
	bl GetPlayerAvatarGraphicsIdByStateId
	adds r1, r0, 0
...
sub_8059C94: @ 8059FD4
	...
	lsls r5, 24
	lsrs r5, 24
	ldr r6, _0805A03C @ =gPlayerAvatar
	ldrb r0, [r6, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r0, _0805A040 @ =gMapObjects
	adds r4, r0
	movs r0, 0x2
	bl GetPlayerAvatarGraphicsIdByStateId
	adds r1, r0, 0
...
sub_8059D08: @ 805A048
	...
	lsls r5, 24
	lsrs r5, 24
	ldr r6, _0805A094 @ =gPlayerAvatar
	ldrb r0, [r6, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r0, _0805A098 @ =gMapObjects
	adds r4, r0
	movs r0, 0x7
	bl GetPlayerAvatarGraphicsIdByStateId
	adds r1, r0, 0
...
sub_8059D60: @ 805A0A0
	...
	strh r1, [r0]
	movs r6, 0x1
	ldr r1, _0805A104 @ =gUnknown_0830FC78
	mov r9, r1
	mov r4, sp
	mov r7, sp
	adds r7, 0x2
...
StartStrengthAnim: @ 805A130
	...
	lsls r5, 24
	lsrs r5, 24
	ldr r6, _0805A164 @ =sub_8059E2C
	adds r0, r6, 0
	movs r1, 0xFF
	bl CreateTask
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _0805A168 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
...
sub_8059E2C: @ 805A16C
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r6, _0805A1B4 @ =gUnknown_0830FC88
	ldr r2, _0805A1B8 @ =gTasks
	ldr r5, _0805A1BC @ =gMapObjects
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r4, r1, r2
_0805A180:
	...
	lsls r3, 2
	adds r3, r6
	ldr r0, _0805A1C0 @ =gPlayerAvatar
	ldrb r0, [r0, 0x5]
	lsls r1, r0, 3
	adds r1, r0
	lsls r1, 2
...
sub_8059E84: @ 805A1C4
	...
	ldr r1, _0805A1E0 @ =gPlayerAvatar
	movs r0, 0x1
	strb r0, [r1, 0x6]
	ldrh r0, [r4, 0x8]
	adds r0, 0x1
...
sub_8059EA4: @ 805A1E4
	...
	adds r0, r4, 0
	bl FieldObjectSetSpecialAnim
	ldr r2, _0805A278 @ =gUnknown_0202FF84
	movs r1, 0x10
	ldrsh r0, [r4, r1]
	str r0, [r2]
	movs r1, 0x12
...
sub_8059F40: @ 805A280
	...
	adds r0, r5, 0
	bl FieldObjectClearAnimIfSpecialAnimFinished
	ldr r1, _0805A2CC @ =gPlayerAvatar
	movs r0, 0
	strb r0, [r1, 0x6]
	bl ScriptContext2_Disable
	ldr r0, _0805A2D0 @ =sub_8059E2C
	bl FindTaskIdByFunc
	lsls r0, 24
	lsrs r0, 24
	bl DestroyTask
...
sub_8059FB4: @ 805A2F4
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r5, _0805A330 @ =gUnknown_0830FC94
	ldr r2, _0805A334 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r4, r1, r2
_0805A306:
	...
	lsls r2, 2
	adds r2, r5
	ldr r0, _0805A338 @ =gPlayerAvatar
	ldrb r0, [r0, 0x5]
	lsls r1, r0, 3
	adds r1, r0
	lsls r1, 2
	ldr r0, _0805A33C @ =gMapObjects
	adds r1, r0
	ldr r2, [r2]
	adds r0, r4, 0
	bl _call_via_r2
...
sub_805A000: @ 805A340
	...
	adds r6, r0, 0
	adds r4, r1, 0
	ldr r5, _0805A3A4 @ =gPlayerAvatar
	movs r0, 0x1
	strb r0, [r5, 0x6]
	adds r0, r4, 0
	bl FieldObjectClearAnimIfSpecialAnimFinished
...
sub_805A08C: @ 805A3CC
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r5, _0805A408 @ =gUnknown_0830FC98
	ldr r2, _0805A40C @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r4, r1, r2
_0805A3DE:
	...
	lsls r2, 2
	adds r2, r5
	ldr r0, _0805A410 @ =gPlayerAvatar
	ldrb r0, [r0, 0x5]
	lsls r1, r0, 3
	adds r1, r0
	lsls r1, 2
	ldr r0, _0805A414 @ =gMapObjects
	adds r1, r0
	ldr r2, [r2]
	adds r0, r4, 0
	bl _call_via_r2
...
sub_805A0D8: @ 805A418
	...
	lsrs r1, 4
	strh r1, [r0, 0xA]
	ldr r1, _0805A43C @ =gPlayerAvatar
	movs r0, 0x1
	strb r0, [r1, 0x6]
	bl ScriptContext2_Enable
	movs r0, 0x2D
...
sub_805A100: @ 805A440
	...
	adds r4, r0, 0
	adds r5, r1, 0
	ldr r1, _0805A4B4 @ =gUnknown_0830FCA8
	mov r0, sp
	movs r2, 0x4
	bl memcpy
	adds r0, r5, 0
...
sub_805A178: @ 805A4B8
	...
	adds r5, r0, 0
	adds r4, r1, 0
	ldr r1, _0805A4F4 @ =gUnknown_0830FCAC
	mov r0, sp
	movs r2, 0x5
	bl memcpy
	adds r0, r4, 0
...
sub_805A1B8: @ 805A4F8
	...
	bl FieldObjectSetSpecialAnim
	bl ScriptContext2_Disable
	ldr r1, _0805A544 @ =gPlayerAvatar
	movs r0, 0
	strb r0, [r1, 0x6]
	ldr r0, _0805A548 @ =sub_805A08C
	bl FindTaskIdByFunc
	lsls r0, 24
	lsrs r0, 24
	bl DestroyTask
...
sub_805A20C: @ 805A54C
	...
	bl sub_8053F84
	ldr r2, _0805A598 @ =gPlayerAvatar
	ldrb r1, [r2]
	movs r0, 0xF7
	ands r0, r1
	movs r1, 0x1
	...
	movs r0, 0x1
	strb r0, [r2, 0x6]
	ldr r5, _0805A59C @ =taskFF_0805D1D4
	adds r0, r5, 0
	movs r1, 0xFF
	bl CreateTask
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _0805A5A0 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
...
taskFF_0805D1D4: @ 805A5A4
	...
	lsls r0, 24
	lsrs r6, r0, 24
	ldr r0, _0805A600 @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _0805A604 @ =gMapObjects
	adds r5, r0, r1
	adds r0, r5, 0
	bl FieldObjectIsSpecialAnimOrDirectionSequenceAnimActive
	lsls r0, 24
...
sub_805A2D0: @ 805A610
	...
	lsls r0, 24
	lsrs r5, r0, 24
	ldr r6, _0805A67C @ =gPlayerAvatar
	ldrb r1, [r6, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _0805A680 @ =gMapObjects
	adds r4, r0, r1
	adds r0, r4, 0
	bl FieldObjectClearAnimIfSpecialAnimFinished
	lsls r0, 24
...
StartFishing: @ 805A688
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r5, _0805A6B4 @ =Task_Fishing
	adds r0, r5, 0
	movs r1, 0xFF
	bl CreateTask
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _0805A6B8 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
...
Task_Fishing: @ 805A6BC
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r5, _0805A6EC @ =gUnknown_0830FCB4
	ldr r2, _0805A6F0 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r4, r1, r2
...
Fishing1: @ 805A6F4
	...
	adds r4, r0, 0
	bl ScriptContext2_Enable
	ldr r1, _0805A710 @ =gPlayerAvatar
	movs r0, 0x1
	strb r0, [r1, 0x6]
	ldrh r0, [r4, 0x8]
	adds r0, 0x1
...
Fishing2: @ 805A714
	...
	sub sp, 0x10
	adds r5, r0, 0
	ldr r1, _0805A79C @ =gUnknown_0830FCF4
	mov r0, sp
	movs r2, 0x6
	bl memcpy
	add r4, sp, 0x8
	ldr r1, _0805A7A0 @ =gUnknown_0830FCFA
	adds r0, r4, 0
	movs r2, 0x6
	bl memcpy
	movs r0, 0
	...
	adds r1, r0
	strh r1, [r5, 0x22]
	ldr r3, _0805A7A4 @ =gMapObjects
	ldr r2, _0805A7A8 @ =gPlayerAvatar
	ldrb r1, [r2, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
...
Fishing5: @ 805A818
	...
	sub sp, 0x4
	adds r4, r0, 0
	ldr r1, _0805A854 @ =gUnknown_0830FD00
	mov r0, sp
	movs r2, 0x2
	bl memcpy
	bl sub_805A954
...
_0805A8D0:
	...
	b _0805A8FC
_0805A8D6:
	ldr r0, _0805A904 @ =gPlayerAvatar
	ldrb r0, [r0, 0x4]
	lsls r4, r0, 4
	adds r4, r0
	lsls r4, 2
	ldr r0, _0805A908 @ =gSprites
	adds r4, r0
	bl player_get_direction_lower_nybble
	lsls r0, 24
	lsrs r0, 24
...
Fishing7: @ 805A90C
	...
	adds r4, r0, 0
	bl sub_805A954
	ldr r0, _0805A930 @ =gOtherText_OhABite
	movs r1, 0x4
	movs r2, 0x11
	bl MenuPrint
	ldrh r0, [r4, 0x8]
...
Fishing8: @ 805A934
	...
	sub sp, 0x8
	adds r4, r0, 0
	ldr r1, _0805A968 @ =gUnknown_0830FD02
	mov r0, sp
	movs r2, 0x6
	bl memcpy
	bl sub_805A954
...
Fishing9: @ 805A98C
	...
	sub sp, 0xC
	adds r4, r0, 0
	ldr r1, _0805A9F0 @ =gUnknown_0830FD08
	mov r0, sp
	movs r2, 0xC
	bl memcpy
	bl sub_805A954
...
Fishing10: @ 805A9F4
	...
	adds r4, r0, 0
	bl sub_805A954
	ldr r0, _0805AA18 @ =gOtherText_PokeOnHook
	bl sub_8072044
	bl MenuDisplayMessageBox
	ldrh r0, [r4, 0x8]
	adds r0, 0x1
...
Fishing11: @ 805AA1C
	...
	cmp r0, 0
	beq _0805AAB8
	ldr r7, _0805AAAC @ =gPlayerAvatar
	ldrb r0, [r7, 0x5]
	lsls r4, r0, 3
	adds r4, r0
	lsls r4, 2
	ldr r1, _0805AAB0 @ =gMapObjects
	mov r8, r1
	add r4, r8
	ldrh r1, [r5, 0x24]
	lsls r1, 24
...
_0805AAB8:
	...
	beq _0805AAE8
_0805AAC0:
	ldr r1, _0805AAF4 @ =gPlayerAvatar
	movs r0, 0
	strb r0, [r1, 0x6]
	bl ScriptContext2_Disable
	ldrh r0, [r5, 0x26]
...
Fishing12: @ 805AAFC
	...
	adds r5, r0, 0
	bl sub_805A954
	ldr r0, _0805AB3C @ =gPlayerAvatar
	ldrb r0, [r0, 0x4]
	lsls r4, r0, 4
	adds r4, r0
	lsls r4, 2
	ldr r0, _0805AB40 @ =gSprites
	adds r4, r0
	bl player_get_direction_lower_nybble
	lsls r0, 24
	lsrs r0, 24
	...
	adds r0, r4, 0
	bl StartSpriteAnim
	ldr r0, _0805AB44 @ =gOtherText_NotEvenANibble
	bl sub_8072044
	movs r0, 0xD
	strh r0, [r5, 0x8]
	movs r0, 0x1
...
Fishing13: @ 805AB48
	...
	adds r5, r0, 0
	bl sub_805A954
	ldr r0, _0805AB8C @ =gPlayerAvatar
	ldrb r0, [r0, 0x4]
	lsls r4, r0, 4
	adds r4, r0
	lsls r4, 2
	ldr r0, _0805AB90 @ =gSprites
	adds r4, r0
	bl player_get_direction_lower_nybble
	lsls r0, 24
	lsrs r0, 24
	...
	adds r0, r4, 0
	bl StartSpriteAnim
	ldr r0, _0805AB94 @ =gOtherText_ItGotAway
	bl sub_8072044
	ldrh r0, [r5, 0x8]
	adds r0, 0x1
	strh r0, [r5, 0x8]
...
Fishing15: @ 805ABB4
	...
	adds r6, r0, 0
	bl sub_805A954
	ldr r7, _0805AC48 @ =gSprites
	ldr r5, _0805AC4C @ =gPlayerAvatar
	ldrb r0, [r5, 0x4]
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
...
Fishing16: @ 805AC54
	...
	cmp r0, 0
	beq _0805AC86
	ldr r1, _0805AC8C @ =gPlayerAvatar
	movs r0, 0
	strb r0, [r1, 0x6]
	bl ScriptContext2_Disable
	bl sub_806451C
...
sub_805A954: @ 805AC94
	push {r4-r7,lr}
	ldr r0, _0805AD80 @ =gPlayerAvatar
	ldrb r1, [r0, 0x4]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	ldr r1, _0805AD84 @ =gSprites
	adds r4, r0, r1
	adds r0, r4, 0
	bl AnimateSprite
	movs r0, 0
...
_0805AD46:
	...
	strh r0, [r4, 0x26]
_0805AD56:
	ldr r3, _0805AD80 @ =gPlayerAvatar
	ldrb r1, [r3]
	movs r0, 0x8
	ands r0, r1
	cmp r0, 0
	beq _0805AD7A
	ldr r2, _0805AD8C @ =gMapObjects
	ldrb r1, [r3, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
