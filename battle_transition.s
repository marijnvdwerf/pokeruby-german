...
sub_811C43C: @ 811C43C
	...
	adds r2, r5, 0
	bl memset
	ldr r1, _0811C4E4 @ =0x04000040
	movs r0, 0xF0
	strh r0, [r1]
	ldr r0, _0811C4E8 @ =0x04000054
	mov r1, r8
	strh r1, [r0]
	ldrh r0, [r6, 0x8]
	adds r0, 0x1
...
sub_811C700: @ 811C700
	...
	ldr r0, [r1, 0x8]
_0811C736:
	ldr r1, _0811C76C @ =0x04000050
	ldrh r0, [r2, 0xE]
	strh r0, [r1]
	ldr r0, _0811C770 @ =gUnknown_03005560
	str r0, [r4]
	ldr r0, _0811C774 @ =0x04000054
	str r0, [r4, 0x4]
...
sub_811C77C: @ 811C77C
	push {lr}
	ldr r0, _0811C790 @ =0x04000006
	ldrh r0, [r0]
	cmp r0, 0x4F
	bhi _0811C79C
	ldr r0, _0811C794 @ =0x04000010
...
sub_811CFAC: @ 811CFAC
	ldr r2, _0811CFC4 @ =0x04000054
	ldr r1, _0811CFC8 @ =gUnknown_03004DE0
	ldr r0, _0811CFCC @ =0x04000006
	ldrh r0, [r0]
	lsls r0, 1
	movs r3, 0xF0
	lsls r3, 3
