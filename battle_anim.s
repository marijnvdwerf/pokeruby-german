...
sub_8076A3C: @ 8076A3C
	...
	adds r0, 0x1
	str r0, [r2]
	ldr r2, _08076A70 @ =0x04000050
	movs r4, 0xFD
	lsls r4, 6
	adds r0, r4, 0
	strh r0, [r2]
	ldr r0, _08076A74 @ =0x04000052
	orrs r3, r1
	strh r3, [r0]
	pop {r4}
	pop {r0}
