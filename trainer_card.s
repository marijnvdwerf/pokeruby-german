...
sub_8093324: @ 8093324
	...
	cmp r0, 0
	beq _0809337C
	ldr r2, _08093378 @ =gTrainerCards
	movs r1, 0xA
	ldrsh r0, [r4, r1]
	lsls r1, r0, 3
	subs r1, r0
...
sub_80934C4: @ 80934C4
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _080934D8 @ =gTrainerCards
	lsls r1, r0, 3
	subs r1, r0
	lsls r1, 3
	adds r1, r2
...
sub_8093610: @ 8093760
	push {r4,r5,lr}
	ldr r5, _080937B4 @ =REG_BG0CNT
	movs r1, 0
	strh r1, [r5]
	ldr r2, _080937B8 @ =REG_BG1CNT
	strh r1, [r2]
	ldr r3, _080937BC @ =REG_BG2CNT
	strh r1, [r3]
	ldr r4, _080937C0 @ =REG_BG3CNT
	strh r1, [r4]
	ldr r0, _080937C4 @ =REG_BG0HOFS
	strh r1, [r0]
	adds r0, 0x2
	strh r1, [r0]
	adds r0, 0x2
	...
	bx r0
	.align 2, 0
_080937B4: .4byte REG_BG0CNT
_080937B8: .4byte REG_BG1CNT
_080937BC: .4byte REG_BG2CNT
_080937C0: .4byte REG_BG3CNT
_080937C4: .4byte REG_BG0HOFS
