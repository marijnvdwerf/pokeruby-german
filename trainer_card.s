...
sub_8093110: @ 8093260
	push {lr}
	bl sub_80932AC
	ldr r0, _08093278 @ =sub_8093174
	bl SetMainCallback2
	ldr r0, _0809327C @ =0x02000000
	adds r0, 0x9C
	movs r1, 0x5
	strb r1, [r0]
	pop {r0}
...
sub_8093130: @ 8093280
	...
	adds r0, r4, 0
	bl sub_80932E4
	ldr r0, _080932B4 @ =sub_8093174
	bl SetMainCallback2
	ldr r2, _080932B8 @ =0x02000000
	ldr r3, _080932BC @ =gLinkPlayers
	ldr r0, _080932C0 @ =gLinkPlayerMapObjects
	lsls r4, 2
	adds r4, r0
	ldrb r1, [r4, 0x1]
	lsls r0, r1, 3
...
sub_8093174: @ 80932C4
	push {lr}
	ldr r0, _080932DC @ =gMain
	ldr r1, _080932E0 @ =0x0000043c
	adds r0, r1
	ldrb r0, [r0]
	cmp r0, 0x8
	bhi _08093382
	lsls r0, 2
	ldr r1, _080932E4 @ =_080932E8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
...
_0809332C:
	bl sub_80937BC
	ldr r1, _08093348 @ =gMain
	ldr r0, _0809334C @ =0x0000043c
	adds r1, r0
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
...
_08093356:
	bl sub_80937D8
_0809335A:
	ldr r1, _08093368 @ =gMain
	ldr r0, _0809336C @ =0x0000043c
	adds r1, r0
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
...
_080933CE:
	...
	cmp r0, 0
	beq _080933E8
	ldr r1, _080933F0 @ =0x040000d4
	ldr r0, _080933F4 @ =gUnknown_03004DE0
	str r0, [r1]
	movs r2, 0xF0
	lsls r2, 3
	adds r0, r2
	str r0, [r1, 0x4]
	ldr r0, _080933F8 @ =0x800000a0
	str r0, [r1, 0x8]
	ldr r0, [r1, 0x8]
_080933E8:
	pop {r0}
...
sub_8093324: @ 8093474
	...
	adds r1, r0
	lsls r1, 3
	ldr r0, _080934C0 @ =gTasks
	adds r4, r1, r0
	ldr r5, _080934C4 @ =0x02000000
	ldrh r0, [r4, 0x8]
	strb r0, [r5, 0x1]
	adds r0, r4, 0
	adds r0, 0xC
	...
	cmp r0, 0
	beq _080934CC
	ldr r2, _080934C8 @ =gTrainerCards
	movs r1, 0xA
	ldrsh r0, [r4, r1]
	lsls r1, r0, 3
	subs r1, r0
...
_08093506:
	...
	bl sav12_xor_get_clamped_above
	strh r0, [r5, 0x16]
	ldr r1, _08093600 @ =0x000003e7
	movs r0, 0x23
	bl sav12_xor_get_clamped_above
	strh r0, [r5, 0x1C]
	ldr r4, _08093604 @ =0x0000ffff
	movs r0, 0x22
	adds r1, r4, 0
	bl sav12_xor_get_clamped_above
	strh r0, [r5, 0x1E]
...
sub_80934C4: @ 8093614
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _08093628 @ =gTrainerCards
	lsls r1, r0, 3
	subs r1, r0
	lsls r1, 3
	adds r1, r2
...
sub_8093550: @ 80936A0
	push {r4,lr}
	ldr r0, _080936D8 @ =sub_8093254
	bl SetVBlankCallback
	ldr r3, _080936DC @ =0x04000208
	ldrh r2, [r3]
	movs r0, 0
	strh r0, [r3]
	ldr r4, _080936E0 @ =0x04000200
	ldrh r0, [r4]
	movs r1, 0x3
	orrs r0, r1
	strh r0, [r4]
	strh r2, [r3]
	ldr r2, _080936E4 @ =0x04000004
	ldrh r0, [r2]
	movs r1, 0x18
	orrs r0, r1
	strh r0, [r2]
...
sub_8093598: @ 80936E8
	...
	mov r4, sp
	movs r6, 0
	ldr r1, _08093734 @ =0x040000d4
	movs r5, 0x80
	lsls r5, 5
	ldr r7, _08093738 @ =0x81000800
	movs r0, 0x81
	lsls r0, 24
	mov r12, r0
_08093706:
...
sub_80935EC: @ 809373C
	...
	movs r0, 0
	strh r0, [r1]
	ldr r0, _08093758 @ =0x040000d4
	str r1, [r0]
	str r2, [r0, 0x4]
	ldr r1, _0809375C @ =0x81000200
	str r1, [r0, 0x8]
	ldr r0, [r0, 0x8]
	add sp, 0x4
	bx lr
...
sub_8093610: @ 8093760
	push {r4,r5,lr}
	ldr r5, _080937B4 @ =0x04000008
	movs r1, 0
	strh r1, [r5]
	ldr r2, _080937B8 @ =0x0400000a
	strh r1, [r2]
	ldr r3, _080937BC @ =0x0400000c
	strh r1, [r3]
	ldr r4, _080937C0 @ =0x0400000e
	strh r1, [r4]
	ldr r0, _080937C4 @ =0x04000010
	strh r1, [r0]
	adds r0, 0x2
	strh r1, [r0]
	adds r0, 0x2
	...
	adds r0, 0x2
	strh r1, [r0]
	ldr r1, _080937C8 @ =0x00001e08
	adds r0, r1, 0
	strh r0, [r5]
	ldr r1, _080937CC @ =0x00000801
	adds r0, r1, 0
	strh r0, [r2]
	ldr r1, _080937D0 @ =0x00000902
	adds r0, r1, 0
	strh r0, [r3]
	ldr r1, _080937D4 @ =0x00000a03
	adds r0, r1, 0
	strh r0, [r4]
	pop {r4,r5}
	pop {r0}
...
sub_80937BC: @ 809390C
	push {r4,lr}
	ldr r4, _08093924 @ =WindowConfig_TrainerCard_Back_Values
	adds r0, r4, 0
...
sub_809382C: @ 809397C
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r7, _080939A8 @ =gUnknown_083B5EBC
	lsls r1, r0, 2
	adds r1, r0
	lsls r4, r1, 3
	ldr r6, _080939AC @ =0x02000000
	ldr r5, _080939B0 @ =gTasks
_0809398E:
	ldrb r0, [r6]
	lsls r0, 2
	adds r0, r7
...
sub_8093864: @ 80939B4
	push {r4,r5,lr}
	sub sp, 0x4
	ldr r4, _080939F0 @ =0x02000000
	ldr r2, _080939F4 @ =gSaveBlock2
	ldrb r1, [r2, 0x11]
	movs r0, 0x1
	ands r0, r1
	movs r5, 0
...
sub_80938A8: @ 80939F8
	push {lr}
	ldr r0, _08093A14 @ =gPaletteFade
	ldrb r1, [r0, 0x7]
	movs r0, 0x80
	ands r0, r1
	cmp r0, 0
	bne _08093A0E
	ldr r1, _08093A18 @ =0x02000000
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
_08093A0E:
...
sub_80938CC: @ 8093A1C
	push {lr}
	ldr r0, _08093A34 @ =gMain
	ldrh r1, [r0, 0x2E]
	movs r0, 0x2
	ands r0, r1
	cmp r0, 0
	beq _08093A3C
	ldr r1, _08093A38 @ =0x02000000
	movs r0, 0x5
	strb r0, [r1]
	movs r0, 0x1
	b _08093A64
...
sub_8093980: @ 8093AD0
	push {lr}
	ldr r0, _08093AEC @ =gPaletteFade
	ldrb r1, [r0, 0x7]
	movs r0, 0x80
	ands r0, r1
	cmp r0, 0
	bne _08093AE6
	ldr r0, _08093AF0 @ =0x02000000
	ldr r0, [r0, 0x60]
	bl SetMainCallback2
_08093AE6:
	movs r0, 0
...
sub_80939A4: @ 8093AF4
	push {lr}
	ldr r0, _08093B08 @ =sub_80939DC
	movs r1, 0
	bl CreateTask
	ldr r0, _08093B0C @ =WindowConfig_TrainerCard_Back_Values
...
sub_80939DC: @ 8093B2C
	...
	adds r1, r0
	lsls r1, 3
	ldr r0, _08093B70 @ =gTasks
	adds r2, r1, r0
	ldr r0, _08093B74 @ =0x02000000
	ldrb r1, [r0, 0x5]
	movs r3, 0xA
	ldrsh r0, [r2, r3]
	cmp r1, r0
...
sub_8093A68: @ 8093BB8
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r5, _08093BE8 @ =gUnknown_083B5ED8
	ldr r2, _08093BEC @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r4, r1, r2
...
sub_8093AA0: @ 8093BF0
	push {r4,lr}
	adds r4, r0, 0
	ldr r0, _08093C30 @ =0x02000000
	movs r1, 0
	strb r1, [r0, 0x4]
	bl dp12_8087EA4
	movs r1, 0
	ldr r0, _08093C34 @ =gUnknown_03004DE0
	ldr r2, _08093C38 @ =0x0000fffc
	movs r3, 0xF0
	lsls r3, 3
	adds r0, r3
_08093C0A:
	...
	cmp r1, 0x9F
	bls _08093C0A
	ldr r0, _08093C3C @ =sub_8093D7C
	bl SetHBlankCallback
	ldr r1, _08093C30 @ =0x02000000
	movs r0, 0x1
	strb r0, [r1, 0x4]
	ldrh r0, [r4, 0x8]
	adds r0, 0x1
...
_08093C68:
	...
	cmp r3, r7
	bcs _08093CC4
	ldr r2, _08093D54 @ =gUnknown_03004DE0
	mov r12, r2
	ldr r0, _08093D58 @ =0x0000fffc
	adds r4, r0, 0
_08093CAC:
	lsls r0, r3, 16
	asrs r0, 16
...
_08093CC4:
	...
	cmp r2, r0
	bge _08093CFE
	ldr r0, _08093D54 @ =gUnknown_03004DE0
	mov r9, r0
	ldr r4, _08093D58 @ =0x0000fffc
	mov r12, r4
	adds r4, r1, 0
_08093CDE:
	lsrs r1, r6, 16
...
_08093CFE:
	...
	cmp r0, 0x9F
	bgt _08093D24
	ldr r4, _08093D54 @ =gUnknown_03004DE0
	ldr r0, _08093D58 @ =0x0000fffc
	adds r2, r1, r0
_08093D0E:
	lsls r1, r3, 16
...
_08093DAC:
	...
	cmp r3, r7
	bcs _08093E08
	ldr r2, _08093E98 @ =gUnknown_03004DE0
	mov r12, r2
	ldr r0, _08093E9C @ =0x0000fffc
	adds r4, r0, 0
_08093DF0:
	lsls r0, r3, 16
	asrs r0, 16
...
_08093E08:
	...
	cmp r2, r0
	bge _08093E42
	ldr r0, _08093E98 @ =gUnknown_03004DE0
	mov r9, r0
	ldr r3, _08093E9C @ =0x0000fffc
	mov r12, r3
	adds r4, r1, 0
_08093E22:
	lsrs r1, r6, 16
...
_08093E42:
	...
	cmp r0, 0x9F
	bgt _08093E68
	ldr r4, _08093E98 @ =gUnknown_03004DE0
	ldr r0, _08093E9C @ =0x0000fffc
	adds r2, r1, r0
_08093E52:
	lsls r1, r3, 16
...
sub_8093D50: @ 8093EA0
	push {lr}
	ldr r1, _08093EC4 @ =0x02000000
	movs r0, 0
	strb r0, [r1, 0x4]
	bl SetHBlankCallback
	bl sub_8093E04
	ldr r0, _08093EC8 @ =sub_8093A68
	bl FindTaskIdByFunc
	lsls r0, 24
	lsrs r0, 24
	bl DestroyTask
...
sub_8093D7C: @ 8093ECC
	ldr r1, _08093EF0 @ =gUnknown_03004DE0
	ldr r0, _08093EF4 @ =0x04000006
	ldrh r2, [r0]
	movs r0, 0xFF
	ands r0, r2
	lsls r0, 1
...
sub_8093E04: @ 8093F54
	ldr r0, _08093F70 @ =0x04000012
	ldr r2, _08093F74 @ =0x0000fffc
	adds r1, r2, 0
	strh r1, [r0]
	adds r0, 0x2
	movs r2, 0
...
sub_8093E28: @ 8093F78
	push {r4-r7,lr}
	bl sub_8093EA0
	ldr r0, _08093FD4 @ =gUnknown_083B5F6C
	movs r1, 0xE0
	movs r2, 0x20
	bl LoadPalette
	ldr r3, _08093FD8 @ =gMenuTrainerCard_Gfx
	movs r4, 0xC0
	lsls r4, 19
	movs r5, 0xA4
	lsls r5, 5
	ldr r1, _08093FDC @ =0x040000d4
	ldr r6, _08093FE0 @ =0x80000800
	movs r2, 0x80
	lsls r2, 5
	movs r7, 0x80
	lsls r7, 24
_08093F9E:
	...
	str r0, [r1, 0x8]
	ldr r0, [r1, 0x8]
	ldr r1, _08093FE4 @ =gBadgesTiles
	ldr r2, _08093FE8 @ =0x06001480
	ldr r0, _08093FDC @ =0x040000d4
	str r1, [r0]
	str r2, [r0, 0x4]
	ldr r1, _08093FEC @ =0x80000200
	str r1, [r0, 0x8]
	ldr r0, [r0, 0x8]
	pop {r4-r7}
	pop {r0}
...
sub_8093EA0: @ 8093FF0
	push {r4,lr}
	ldr r1, _08094034 @ =gUnknown_083B5EF8
	ldr r4, _08094038 @ =0x02000000
	ldrb r0, [r4, 0x2]
	lsls r0, 2
	adds r0, r1
	ldr r0, [r0]
	...
	movs r2, 0x60
	bl LoadPalette
	ldr r0, _0809403C @ =gBadgesPalette
	movs r1, 0x30
	movs r2, 0x20
	bl LoadPalette
	ldr r0, _08094040 @ =gUnknown_083B5F4C
	movs r1, 0x40
	movs r2, 0x20
	bl LoadPalette
	adds r4, 0x64
	...
	cmp r0, 0
	beq _0809402C
	ldr r0, _08094044 @ =gUnknown_083B5F0C
	movs r1, 0x10
	movs r2, 0x20
	bl LoadPalette
_0809402C:
...
sub_8093EF8: @ 8094048
	push {lr}
	ldr r0, _0809405C @ =0x02000000
	adds r0, 0x64
	ldrb r0, [r0]
	ldr r2, _08094060 @ =0x06001880
	movs r1, 0x50
...
sub_8093F14: @ 8094064
	push {lr}
	sub sp, 0x8
	ldr r0, _0809408C @ =gUnknown_083B5EEC
	ldr r1, [r0, 0x4]
	ldr r0, [r0]
	str r0, [sp]
	str r1, [sp, 0x4]
	ldr r0, _08094090 @ =0x02000000
	ldrb r0, [r0, 0x1]
	lsls r0, 2
	add r0, sp
	ldr r0, [r0]
	ldr r1, _08094094 @ =0x06004800
	movs r2, 0xA0
	lsls r2, 1
	bl CpuFastSet
	add sp, 0x8
...
sub_8093F48: @ 8094098
	push {lr}
	ldr r0, _080940AC @ =gUnknown_08E8CFC0
	ldr r1, _080940B0 @ =0x06004800
	movs r2, 0xA0
	lsls r2, 1
	bl CpuFastSet
	pop {r0}
...
sub_8093F64: @ 80940B4
	push {lr}
	ldr r0, _080940C8 @ =gUnknown_08E8D9C0
	ldr r1, _080940CC @ =0x06005000
	movs r2, 0xA0
	lsls r2, 1
	bl CpuFastSet
	pop {r0}
...
sub_8093FD0: @ 8094120
	push {r4-r6,lr}
	ldr r4, _0809417C @ =0x06004000
	movs r2, 0xF
	ldr r0, _08094180 @ =0x02000000
	ldrb r0, [r0, 0x2]
	adds r0, 0xF
	cmp r2, r0
	bge _08094152
...
sub_8094038: @ 8094188
	...
	mov r6, r8
	push {r6,r7}
	ldr r1, _08094220 @ =0x02000000
	ldrb r0, [r1, 0x1]
	cmp r0, 0
	bne _08094212
	ldr r0, _08094224 @ =0x06004000
	mov r9, r0
	movs r0, 0
	movs r2, 0x4
	adds r1, 0xE
	mov r8, r1
	ldr r7, _08094228 @ =gUnknown_083B5F8C
	movs r1, 0xC0
	lsls r1, 6
	adds r6, r1, 0
	adds r1, r7, 0x6
...
sub_80940E4: @ 8094234
	push {r4,lr}
	movs r2, 0
	ldr r1, _08094258 @ =0x06004000
	movs r4, 0
	ldr r3, _0809425C @ =0x000003ff
_0809423E:
	strh r4, [r1]
	lsls r0, r2, 16
	movs r2, 0x80
...
sub_8094140: @ 8094290
	push {r4,r5,lr}
	ldr r0, _080942CC @ =WindowConfig_TrainerCard_Back_Values
	bl BasicInitMenuWindow
	ldr r4, _080942D0 @ =gStringVar1
	ldr r5, _080942D4 @ =0x02000094
	adds r0, r4, 0
	adds r1, r5, 0
	bl StringCopy
	ldrb r1, [r5, 0x8]
...
sub_8094188: @ 80942D8
	push {lr}
	ldr r0, _08094320 @ =WindowConfig_TrainerCard_Back_Values
	bl BasicInitMenuWindow
	...
	ldr r0, _08094324 @ =WindowConfig_TrainerCard_Back_Labels
	bl BasicInitMenuWindow
...
TrainerCard_Front_PrintPlayTime: @ 80943A0
	...
	lsls r1, 16
	lsrs r3, r1, 16
	ldr r0, _080943E4 @ =gSaveBlock2
	ldrh r4, [r0, 0xE]
	ldrb r2, [r0, 0x10]
	ldr r1, _080943E8 @ =0x02000000
	ldrb r0, [r1, 0x1]
	cmp r0, 0
	beq _080943C2
	adds r0, r1, 0
...
sub_809429C: @ 80943EC
	push {r4-r6,lr}
	ldr r6, _08094440 @ =0x02000000
	ldrb r0, [r6, 0x1]
	cmp r0, 0
	beq _0809443A
	ldr r0, _08094444 @ =gStringVar1
	adds r1, r6, 0
	adds r1, 0x20
	bl StringCopy
	movs r5, 0
...
TrainerCard_Back_PrintName: @ 8094448
	push {r4,r5,lr}
	ldr r4, _08094478 @ =gStringVar1
	ldr r5, _0809447C @ =0x02000094
	adds r0, r4, 0
	adds r1, r5, 0
	bl StringCopy
	ldrb r1, [r5, 0x8]
	adds r0, r4, 0
	bl ConvertInternationalString
	ldr r1, _08094480 @ =gOtherText_TrainersTrainerCard
	adds r0, r4, 0
	bl de_sub_8073174
	adds r0, r4, 0
	movs r1, 0x1C
...
TrainerCard_Back_PrintHallOfFameTime_Label: @ 8094484
	push {lr}
	ldr r0, _0809449C @ =0x02000000
	ldrb r0, [r0, 0x8]
	cmp r0, 0
	beq _08094498
	ldr r0, _080944A0 @ =gOtherText_FirstHOF
	movs r1, 0x3
	movs r2, 0x5
	bl MenuPrint
_08094498:
...
TrainerCard_Back_PrintHallOfFameTime: @ 80944A4
	push {r4,r5,lr}
	ldr r5, _08094508 @ =0x02000000
	ldrb r0, [r5, 0x8]
	cmp r0, 0
	beq _08094500
	ldr r2, _0809450C @ =gStringVar1
	adds r0, r5, 0
	adds r0, 0x6A
	ldrh r1, [r0]
	adds r0, r2, 0
	...
	bl ConvertIntToDecimalStringN
	adds r2, r0, 0
	ldr r4, _08094510 @ =gUnknown_083B5EF4
	adds r1, r4, 0
	bl StringCopy
	adds r2, r0, 0
	adds r0, r5, 0
...
TrainerCard_Back_PrintLinkBattlesLabel: @ 8094514
	push {lr}
	ldr r0, _0809452C @ =0x02000000
	ldrb r0, [r0, 0x9]
	cmp r0, 0
	beq _08094528
	ldr r0, _08094530 @ =gOtherText_LinkCableBattles
	movs r1, 0x3
	movs r2, 0x7
	bl MenuPrint
_08094528:
...
TrainerCard_Back_PrintBattleTower_Label: @ 8094578
	push {lr}
	ldr r0, _08094590 @ =0x02000000
	ldrb r0, [r0, 0xA]
	cmp r0, 0
	beq _0809458C
	ldr r0, _08094594 @ =gOtherText_BattleTowerWinRecord
	movs r1, 0x3
	movs r2, 0xF
	bl MenuPrint
_0809458C:
...
TrainerCard_Back_PrintLinkContests_Label: @ 80945E8
	push {lr}
	ldr r0, _08094600 @ =0x02000000
	ldrb r0, [r0, 0xB]
	cmp r0, 0
	beq _080945FC
	ldr r0, _08094604 @ =gOtherText_ContestRecord
	movs r1, 0x3
	movs r2, 0xD
	bl MenuPrint
_080945FC:
...
TrainerCard_Back_PrintLinkPokeblocks_Label: @ 8094638
	push {lr}
	ldr r0, _08094650 @ =0x02000000
	ldrb r0, [r0, 0xC]
	cmp r0, 0
	beq _0809464C
	ldr r0, _08094654 @ =gOtherText_MixingRecord
	movs r1, 0x3
	movs r2, 0xB
	bl MenuPrint
_0809464C:
...
TrainerCard_Back_PrintPokemonTrades_Label: @ 8094688
	push {lr}
	ldr r0, _080946A0 @ =0x02000000
	ldrb r0, [r0, 0xD]
	cmp r0, 0
	beq _0809469C
	ldr r0, _080946A4 @ =gOtherText_TradeRecord
	movs r1, 0x3
	movs r2, 0x9
	bl MenuPrint
_0809469C:
...
unref_sub_8094588: @ 80946D8
	...
	lsls r1, 16
	lsrs r2, r1, 16
	ldr r4, _08094704 @ =gOtherText_Boy
	ldr r0, _08094708 @ =gSaveBlock2
	ldrb r0, [r0, 0x8]
	cmp r0, 0x1
	bne _080946EE
	ldr r4, _0809470C @ =gOtherText_Girl
_080946EE:
	lsls r1, r3, 24
	lsrs r1, 24
	lsls r2, 24
