...
_0804E2FC:
	lsls r0, 2
	ldr r1, _0804E30C @ =_0804E67C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804E308: .4byte gUnknown_03004854
_0804E30C: .4byte _0804E67C
	.align 2, 0
_0804E310:
	.4byte _0804E338
	.4byte _0804E34C
...
_0804E57C:
	lsls r0, 2
	ldr r1, _0804E58C @ =_0804E8FC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804E588: .4byte gUnknown_03004854
_0804E58C: .4byte _0804E8FC
	.align 2, 0
_0804E590:
	.4byte _0804E5AC
	.4byte _0804E614
...
_0804EA0E:
	lsls r0, 2
	ldr r1, _0804EA1C @ =_0804ED8C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804EA18: .4byte gUnknown_03004854
_0804EA1C: .4byte _0804ED8C
	.align 2, 0
_0804EA20:
	.4byte _0804EBBC
	.4byte _0804EC74
...
_0804F38E:
	lsls r0, 2
	ldr r1, _0804F39C @ =_0804F70C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804F398: .4byte gUnknown_03004854
_0804F39C: .4byte _0804F70C
	.align 2, 0
_0804F3A0:
	.4byte _0804F3F8
	.4byte _0804F474
...
_0805096E:
	lsls r0, 2
	ldr r1, _0805097C @ =_08050CEC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08050978: .4byte gUnknown_03004854
_0805097C: .4byte _08050CEC
	.align 2, 0
_08050980:
	.4byte _080509B4
	.4byte _080509F8
...
_08050CFE:
	lsls r0, 2
	ldr r1, _08050D0C @ =_0805107C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08050D08: .4byte gUnknown_03004854
_08050D0C: .4byte _0805107C
	.align 2, 0
_08050D10:
	.4byte _08050D2C
	.4byte _08050D44
...
_08050E44:
	lsls r0, 2
	ldr r1, _08050E54 @ =_080511C4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08050E50: .4byte gUnknown_03004854
_08050E54: .4byte _080511C4
	.align 2, 0
_08050E58:
	.4byte _08050E8C
	.4byte _08050ED8
...
_080510FA:
	lsls r0, 2
	ldr r1, _08051108 @ =_08051460
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08051104: .4byte gUnknown_03004854
_08051108: .4byte _08051460
	.align 2, 0
_0805110C:
	.4byte _08051138
	.4byte _0805116E
...
_08051C72:
	lsls r0, 2
	ldr r1, _08051C80 @ =_08051FD8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08051C7C: .4byte gUnknown_03004854
_08051C80: .4byte _08051FD8
	.align 2, 0
_08051C84:
	.4byte _08051CA0
	.4byte _08051CB6
...
_0805223C:
	lsls r0, 2
	ldr r1, _0805224C @ =_080525A0
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08052248: .4byte gUnknown_03004854
_0805224C: .4byte _080525A0
	.align 2, 0
_08052250:
	.4byte _0805226C
	.4byte _08052282
