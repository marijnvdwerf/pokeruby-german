...
Cb2_StartWallClock: @ 810A8F4
	...
	ldr r0, _0810A9F0 @ =gUnknown_08E954B0
	ldr r1, _0810A9F4 @ =0x06003800
	bl LZ77UnCompVram
	ldr r0, _0810A9F8 @ =Task_SetClock1
	movs r1, 0
	bl CreateTask
	adds r6, r0, 0
	lsls r6, 24
	lsrs r6, 24
	ldr r1, _0810A9FC @ =gTasks
	lsls r0, r6, 2
	adds r0, r6
	lsls r0, 3
	adds r0, r1
	...
	lsls r1, 1
	strh r1, [r0, 0xA]
	ldr r0, _0810AA00 @ =gSpriteTemplate_83F7AD8
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0x1
	bl CreateSprite
	...
	ands r0, r2
	strb r0, [r1, 0x3]
	ldr r0, _0810AA08 @ =gSpriteTemplate_83F7AF0
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0
	bl CreateSprite
	...
	orrs r4, r0
	strb r4, [r1, 0x3]
	ldr r0, _0810AA0C @ =gSpriteTemplate_83F7B28
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0x2
	bl CreateSprite
	...
	movs r0, 0x2D
	strh r0, [r1, 0x30]
	ldr r0, _0810AA10 @ =gSpriteTemplate_83F7B40
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0x2
	bl CreateSprite
...
_0810A9F8: .4byte Task_SetClock1
...
Cb2_ViewWallClock: @ 810AA14
	...
	push {r5-r7}
	bl LoadWallClockGraphics
	ldr r0, _0810AA58 @ =gUnknown_08E95774
	ldr r1, _0810AA5C @ =0x06003800
	bl LZ77UnCompVram
	ldr r0, _0810AA60 @ =Task_ViewClock1
	movs r1, 0
	bl CreateTask
	lsls r0, 24
	lsrs r7, r0, 24
...
_0810AA60: .4byte Task_ViewClock1
...
_0810AA68:
	...
	mov r10, r2
_0810AA70:
	ldr r0, _0810AB28 @ =gSpriteTemplate_83F7AD8
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0x1
	bl CreateSprite
	...
	ands r0, r2
	strb r0, [r1, 0x3]
	ldr r0, _0810AB30 @ =gSpriteTemplate_83F7AF0
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0
	bl CreateSprite
	...
	orrs r4, r0
	strb r4, [r1, 0x3]
	ldr r0, _0810AB34 @ =gSpriteTemplate_83F7B28
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0x2
	bl CreateSprite
	...
	mov r2, r9
	strh r2, [r1, 0x30]
	ldr r0, _0810AB38 @ =gSpriteTemplate_83F7B40
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0x2
	bl CreateSprite
...
_0810B098:
	...
	movs r0, 0
	bl SetOamMatrix
	ldr r1, _0810B0F0 @ =gClockHandCoords
	lsls r2, r7, 1
	adds r0, r2, r1
	ldrb r0, [r0]
	lsls r0, 24
...
_0810B130:
	...
	movs r0, 0x1
	bl SetOamMatrix
	ldr r1, _0810B188 @ =gClockHandCoords
	lsls r2, r7, 1
	adds r0, r2, r1
	ldrb r0, [r0]
	lsls r0, 24
