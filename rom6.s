...
sub_810CE78: @ 810CE78
	...
	movs r2, 0x10
	bl LoadPalette
	ldr r1, _0810CF00 @ =0x04000050
	ldr r2, _0810CF04 @ =0x00003e41
	adds r0, r2, 0
	strh r0, [r1]
	ldr r0, _0810CF08 @ =0x04000052
	strh r5, [r0]
	adds r0, 0x2
	strh r5, [r0]
	subs r1, 0x48
...
sub_810D028: @ 810D028
	...
	bl LZ77UnCompVram
	ldr r0, _0810D0A8 @ =0x04000050
	strh r4, [r0]
	adds r0, 0x2
	strh r4, [r0]
	adds r0, 0x2
	strh r4, [r0]
	ldr r1, _0810D0AC @ =0x04000008
