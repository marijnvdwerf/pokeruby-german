...
_080EBDEE:
	lsls r0, 2
	ldr r1, _080EBDFC @ =_080EC1B4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EBDF8: .4byte 0x02000000
_080EBDFC: .4byte _080EC1B4
	.align 2, 0
_080EBE00:
	.4byte _080EBE48
	.4byte _080EBE80
...
_080EC022:
	lsls r0, 2
	ldr r1, _080EC030 @ =_080EC3E8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EC02C: .4byte 0x02000000
_080EC030: .4byte _080EC3E8
	.align 2, 0
_080EC034:
	.4byte _080EC06C
	.4byte _080EC0C0
...
_080EC4B6:
	lsls r0, 2
	ldr r1, _080EC4C4 @ =_080EC87C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EC4C0: .4byte 0x02000000
_080EC4C4: .4byte _080EC87C
	.align 2, 0
_080EC4C8:
	.4byte _080EC504
	.4byte _080EC510
...
_080EC692:
	lsls r0, 2
	ldr r1, _080EC6A0 @ =_080ECA58
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EC69C: .4byte 0x02000000
_080EC6A0: .4byte _080ECA58
	.align 2, 0
_080EC6A4:
	.4byte _080EC6BC
	.4byte _080EC718
...
_080ECA26:
	lsls r0, 2
	ldr r1, _080ECA34 @ =_080ECDEC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080ECA30: .4byte 0x02000000
_080ECA34: .4byte _080ECDEC
	.align 2, 0
_080ECA38:
	.4byte _080ECA70
	.4byte _080ECAC4
...
_080ECD96:
	lsls r0, 2
	ldr r1, _080ECDA4 @ =_080ED15C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080ECDA0: .4byte 0x02000000
_080ECDA4: .4byte _080ED15C
	.align 2, 0
_080ECDA8:
	.4byte _080ECDFC
	.4byte _080ECE1A
...
_080ED032:
	lsls r0, 2
	ldr r1, _080ED040 @ =_080ED3F8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080ED03C: .4byte 0x02000000
_080ED040: .4byte _080ED3F8
	.align 2, 0
_080ED044:
	.4byte _080ED094
	.4byte _080ED0B4
...
sub_80ED3D0: @ 80ED3D0
	...
	bhi _080ED4C6
	lsls r0, 2
	ldr r1, _080ED3F0 @ =_080ED7A8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080ED3EC: .4byte 0x02000000
_080ED3F0: .4byte _080ED7A8
	.align 2, 0
_080ED3F4:
	.4byte _080ED418
	.4byte _080ED420
...
_080ED4EE:
	lsls r0, 2
	ldr r1, _080ED4FC @ =_080ED8B4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080ED4F8: .4byte 0x02000000
_080ED4FC: .4byte _080ED8B4
	.align 2, 0
_080ED500:
	.4byte _080ED524
	.4byte _080ED542
...
_080ED636:
	lsls r0, 2
	ldr r1, _080ED644 @ =_080ED9FC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080ED640: .4byte 0x02000000
_080ED644: .4byte _080ED9FC
	.align 2, 0
_080ED648:
	.4byte _080ED68C
	.4byte _080ED6A4
...
_080ED86E:
	lsls r0, 2
	ldr r1, _080ED87C @ =_080EDC34
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080ED878: .4byte 0x02000000
_080ED87C: .4byte _080EDC34
	.align 2, 0
_080ED880:
	.4byte _080ED8B0
	.4byte _080ED8CC
...
_080EDB9E:
	lsls r0, 2
	ldr r1, _080EDBAC @ =_080EDF64
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EDBA8: .4byte 0x02000000
_080EDBAC: .4byte _080EDF64
	.align 2, 0
_080EDBB0:
	.4byte _080EDBF8
	.4byte _080EDC04
...
_080EDEFA:
	lsls r0, 2
	ldr r1, _080EDF08 @ =_080EE2C0
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EDF04: .4byte 0x02000000
_080EDF08: .4byte _080EE2C0
	.align 2, 0
_080EDF0C:
	.4byte _080EDF38
	.4byte _080EDF50
...
_080EE080:
	lsls r0, 2
	ldr r1, _080EE090 @ =_080EE448
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EE08C: .4byte 0x02000000
_080EE090: .4byte _080EE448
	.align 2, 0
_080EE094:
	.4byte _080EE0B8
	.4byte _080EE0CC
...
_080EE2AA:
	lsls r0, 2
	ldr r1, _080EE2B8 @ =_080EE670
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EE2B4: .4byte 0x02000000
_080EE2B8: .4byte _080EE670
	.align 2, 0
_080EE2BC:
	.4byte _080EE2E0
	.4byte _080EE2FE
...
_080EE3EC:
	lsls r0, 2
	ldr r1, _080EE3FC @ =_080EE7B4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EE3F8: .4byte 0x02000000
_080EE3FC: .4byte _080EE7B4
	.align 2, 0
_080EE400:
	.4byte _080EE438
	.4byte _080EE444
...
_080EE66C:
	lsls r0, 2
	ldr r1, _080EE67C @ =_080EEA34
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EE678: .4byte 0x02000000
_080EE67C: .4byte _080EEA34
	.align 2, 0
_080EE680:
	.4byte _080EE6C8
	.4byte _080EE6DA
...
sub_80EED2C: @ 80EED2C
	...
	bhi _080EED98
	lsls r0, 2
	ldr r1, _080EED40 @ =_080EF0F8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080EED40: .4byte _080EF0F8
	.align 2, 0
_080EED44:
	.4byte _080EED5C
	.4byte _080EED66
...
_080EEEDC:
	...
	movs r1, 0
	strh r1, [r0]
	ldr r0, _080EEF08 @ =0x04000014
	strh r1, [r0]
	adds r0, 0x2
	strh r1, [r0]
	ldr r1, _080EEF0C @ =0x0400000a
...
_080EF9A0:
	...
	lsls r0, 1
	strh r0, [r1]
	ldr r0, _080EF9CC @ =0x04000012
	strh r2, [r0]
_080EF9B0:
	ldr r2, _080EF9D0 @ =0x04000008
	ldrh r0, [r2]
	strh r0, [r2]
	ldrh r0, [r2]
	movs r1, 0x1
...
sub_80F01A4: @ 80F01A4
	ldr r1, _080F01CC @ =0x04000040
	movs r0, 0xF0
	strh r0, [r1]
	adds r1, 0x2
	movs r0, 0x9B
	strh r0, [r1]
	ldr r0, _080F01D0 @ =0x04000044
	ldr r2, _080F01D4 @ =0x00003879
	adds r1, r2, 0
	strh r1, [r0]
	adds r0, 0x2
	strh r1, [r0]
	ldr r1, _080F01D8 @ =0x04000048
...
sub_80F081C: @ 80F081C
	...
	bhi _080F08C6
	lsls r0, r5, 2
	ldr r1, _080F083C @ =_080F0BF4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080F0838: .4byte gWindowConfig_81E710C
_080F083C: .4byte _080F0BF4
	.align 2, 0
_080F0840:
	.4byte _080F0854
	.4byte _080F0854
...
sub_80F2098: @ 80F2098
	ldr r1, _080F20DC @ =0x04000040
	ldr r2, _080F20E0 @ =0x000077f0
	adds r0, r2, 0
	strh r0, [r1]
	ldr r2, _080F20E4 @ =0x04000044
...
sub_80F2108: @ 80F2108
	...
	adds r0, r3, r1
	strh r2, [r0]
	ldr r1, _080F2140 @ =0x04000050
	movs r0, 0x90
	strh r0, [r1]
	ldr r0, _080F2144 @ =0x04000054
	strh r2, [r0]
	bl sub_80F2098
_080F2130:
	pop {r0}
...
_080F27EA:
	lsls r0, 2
	ldr r1, _080F27F4 @ =_080F2BAC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080F27F4: .4byte _080F2BAC
	.align 2, 0
_080F27F8:
	.4byte _080F2828
	.4byte _080F2858
...
_080F29D2:
	lsls r0, r7, 2
	ldr r1, _080F29DC @ =_080F2D94
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080F29DC: .4byte _080F2D94
	.align 2, 0
_080F29E0:
	.4byte _080F2A10
	.4byte _080F2A10
...
sub_80F6F10: @ 80F6F10
	...
	adds r0, r1
	strb r2, [r0]
	ldr r1, _080F6F54 @ =0x04000050
	movs r0, 0xC8
	strh r0, [r1]
	ldr r0, _080F6F58 @ =0x04000054
	strh r2, [r0]
	subs r1, 0x8
