...
_08120C48:
	...
	cmp r0, 0
	bne _08120C84
	ldr r0, _08120C70 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x1
	ands r0, r1
	cmp r0, 0
...
_08120C6C:
	...
	b _08120FA2
	.align 2, 0
_08120C70: .4byte gUnknown_020239F8
...
_08120C84:
	ldr r0, _08120C9C @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x1
	ands r0, r1
	cmp r0, 0
	...
	b _08120FA2
	.align 2, 0
_08120C9C: .4byte gUnknown_020239F8
...
_08120D0C:
	cmp r2, 0x1
	beq _08120D1C
	ldr r0, _08120D20 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x1
	ands r0, r1
	cmp r0, 0
...
_08120D1C:
	...
	b _08120FA2
	.align 2, 0
_08120D20: .4byte gUnknown_020239F8
...
_08120D3C:
	...
	cmp r1, r0
	bne _08120D6C
	ldr r0, _08120D60 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x40
	ands r0, r1
...
_08120D60: .4byte gUnknown_020239F8
...
_08120D7C:
	...
	cmp r3, 0
	beq _08120DA2
	ldr r0, _08120DB0 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x1
	ands r0, r1
	cmp r0, 0
...
_08120DB0: .4byte gUnknown_020239F8
...
_08120DD8:
	ldr r0, _08120DF4 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x2
	ands r0, r1
	cmp r0, 0
...
_08120DF0:
	...
	b _08120FA2
	.align 2, 0
_08120DF4: .4byte gUnknown_020239F8
...
_08120EC0:
	ldr r0, _08120ED4 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x40
	ands r0, r1
	...
	b _08120FA2
	.align 2, 0
_08120ED4: .4byte gUnknown_020239F8
...
_08120EE0:
	...
	strb r0, [r5]
_08120EFA:
	ldr r0, _08120F18 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x40
	ands r0, r1
	cmp r0, 0
	...
	b _08120FA2
	.align 2, 0
_08120F18: .4byte gUnknown_020239F8
...
_081215B8:
	ldr r0, _08121604 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x2
	ands r0, r1
	cmp r0, 0
	...
	b _0812191E
	.align 2, 0
_08121604: .4byte gUnknown_020239F8
...
_081216BC:
	ldr r0, _081216D4 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r2, 0x80
	lsls r2, 1
	adds r0, r2, 0
	...
	b _081216EE
	.align 2, 0
_081216D4: .4byte gUnknown_020239F8
_081216D8:
	movs r2, 0x80
	lsls r2, 4
	adds r0, r2, 0
...
_08121724:
	ldr r0, _0812173C @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x80
	lsls r0, 1
	ands r0, r1
	...
	b _0812191E
	.align 2, 0
_0812173C: .4byte gUnknown_020239F8
_08121740:
	movs r0, 0x80
	lsls r0, 4
	ands r0, r1
...
_08121846:
	...
	bne _0812183C
_0812184E:
	ldr r0, _08121860 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x8
	ands r0, r1
	...
	b _0812191E
	.align 2, 0
_08121860: .4byte gUnknown_020239F8
...
_08121BA4:
	...
	mov r1, sp
	bl StringAppend
	ldr r0, _08121BD8 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x8
	ands r0, r1
	cmp r0, 0
...
_08121BD8: .4byte gUnknown_020239F8
...
_08121C8C:
	...
	lsls r0, 8
	orrs r2, r0
	ldr r0, _08121CDC @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x2
	ands r0, r1
	cmp r0, 0
	...
	b _08121D1A
	.align 2, 0
_08121CDC: .4byte gUnknown_020239F8
