...
FieldObjectInteractionGetBerryTreeData: @ 80B4E50
	...
	ldr r0, _080B4E90 @ =gScriptLastTalked
	ldrb r0, [r0]
	...
	cmp r0, 0
	beq _080B4E9C
	ldr r1, _080B4E98 @ =gSpecialVar_0x8004
	movs r0, 0xFF
	strh r0, [r1]
	b _080B4EAA
	.align 2, 0
_080B4E8C: .4byte gSelectedMapObject
_080B4E90: .4byte gScriptLastTalked
_080B4E94: .4byte gSaveBlock1
_080B4E98: .4byte gSpecialVar_0x8004
_080B4E9C:
	ldr r4, _080B4ED4 @ =gSpecialVar_0x8004
	adds r0, r5, 0
	bl GetStageByBerryTreeId
	lsls r0, 24
	lsrs r0, 24
	strh r0, [r4]
_080B4EAA:
	ldr r4, _080B4ED8 @ =gSpecialVar_0x8005
	adds r0, r5, 0
	bl GetNumStagesWateredByBerryTreeId
	lsls r0, 24
	lsrs r0, 24
	strh r0, [r4]
	ldr r4, _080B4EDC @ =gSpecialVar_0x8006
	adds r0, r5, 0
	...
	bx r0
	.align 2, 0
_080B4ED4: .4byte gSpecialVar_0x8004
_080B4ED8: .4byte gSpecialVar_0x8005
_080B4EDC: .4byte gSpecialVar_0x8006
...
FieldObjectInteractionPlantBerryTree: @ 80B4EF4
	push {r4,lr}
	ldr r0, _080B4F24 @ =gScriptItemId
	ldrh r0, [r0]
...
FieldObjectInteractionPickBerryTree: @ 80B4F2C
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r6, _080B4F74 @ =gSpecialVar_0x8004
...
_080B4F74: .4byte gSpecialVar_0x8004
...
FieldObjectInteractionRemoveBerryTree: @ 80B4F78
	...
	lsrs r0, 24
	bl RemoveBerryTree
	ldr r0, _080B4FA0 @ =gScriptLastTalked
	ldrb r0, [r0]
...
_080B4FA0: .4byte gScriptLastTalked
