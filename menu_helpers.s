...
sub_80F9090: @ 80F9440
	...
	cmp r0, 0x1
	bne _080F945C
	ldr r0, _080F9464 @ =gUnknown_0300074C
	ldr r1, [r0]
	adds r0, r4, 0
	bl _call_via_r1
_080F945C:
...
DisplayItemMessageOnField: @ 80F9468
	...
	ldr r0, _080F9498 @ =gUnknown_0300074C
	str r5, [r0]
	ldr r1, _080F949C @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080F94A0 @ =sub_80F9090
	str r1, [r0]
	pop {r4,r5}
	pop {r0}
	bx r0
...
_080F94CA:
	movs r0, 0x5
	bl PlaySE
	ldr r0, _080F94DC @ =gUnknown_020388C4
	ldr r1, [r0]
	adds r0, r4, 0
	bl _call_via_r1
	b _080F94F0
...
_080F94E0:
	movs r0, 0x5
	bl PlaySE
	ldr r0, _080F94F8 @ =gUnknown_020388C4
	ldr r1, [r0, 0x4]
	adds r0, r4, 0
	bl _call_via_r1
_080F94F0:
...
sub_80F914C: @ 80F94FC
	lsls r0, 24
	lsrs r0, 24
	ldr r3, _080F951C @ =gUnknown_020388C4
	ldr r2, [r1, 0x4]
	ldr r1, [r1]
	str r1, [r3]
	str r2, [r3, 0x4]
	ldr r2, _080F9520 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
	ldr r0, _080F9524 @ =Task_CallYesOrNoCallback
	str r0, [r1]
	bx lr
	.align 2, 0
...
brm_trade_1: @ 80F9528
	...
	lsls r3, 24
	lsrs r6, r3, 24
	ldr r1, _080F9570 @ =gUnknown_083E5A18
	mov r0, sp
	movs r2, 0x4
	bl memcpy
	cmp r4, 0xFF
	...
	bl StringAppend
	mov r1, sp
	ldr r0, _080F9578 @ =gMenuWindowPtr
	ldr r0, [r0]
	ldrb r0, [r0, 0x6]
	strb r0, [r1, 0x2]
	adds r0, r4, 0
...
unref_sub_80F924C: @ 80F95FC
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r1, _080F9630 @ =gUnknown_083E5A1C
	mov r0, sp
	movs r2, 0x2
	bl memcpy
	mov r0, sp
...
sub_80F9284: @ 80F9634
	push {lr}
	ldr r0, _080F9650 @ =gSaveBlock2
	ldrb r0, [r0, 0x13]
	cmp r0, 0x1
	bne _080F9666
	ldr r0, _080F9654 @ =gMain
	ldrh r1, [r0, 0x2E]
	movs r0, 0x80
	lsls r0, 2
	ands r0, r1
...
sub_80F92BC: @ 80F966C
	push {lr}
	ldr r0, _080F9688 @ =gSaveBlock2
	ldrb r0, [r0, 0x13]
	cmp r0, 0x1
	bne _080F969E
	ldr r0, _080F968C @ =gMain
	ldrh r1, [r0, 0x30]
	movs r0, 0x80
	lsls r0, 2
	ands r0, r1
...
sub_80F92F4: @ 80F96A4
	...
	cmp r0, 0xAF
	bne _080F96C4
	ldr r0, _080F96BC @ =gSaveBlock1
	ldrh r1, [r0, 0x4]
	ldr r0, _080F96C0 @ =0x00001919
	cmp r1, r0
	bne _080F96C4
	movs r0, 0
	b _080F96C6
...
sub_80F9344: @ 80F96F4
	...
	cmp r0, 0x1
	beq _080F9706
	ldr r0, _080F970C @ =gReceivedRemoteLinkPlayers
	ldrb r0, [r0]
	cmp r0, 0x1
	bne _080F9710
_080F9706:
...
sub_80F9368: @ 80F9718
	...
	mov r2, sp
	movs r6, 0
	ldr r1, _080F97E0 @ =0x040000d4
	movs r5, 0x80
	lsls r5, 5
	ldr r7, _080F97E4 @ =0x81000800
	movs r0, 0x81
	lsls r0, 24
	mov r12, r0
_080F9776:
...
sub_80F944C: @ 80F97FC
	push {r4,lr}
	movs r2, 0
	ldr r4, _080F9828 @ =gUnknown_020388C0
	movs r3, 0xFF
_080F9804:
	adds r0, r2, r4
	ldrb r1, [r0]
	...
	ldr r0, _080F982C @ =gUnknown_083E5968
...
sub_80F94A4: @ 80F9854
	...
	cmp r0, 0xFF
	bne _080F9880
	ldr r0, _080F98A0 @ =gSpriteTemplate_83E5A00
	lsls r1, 16
	asrs r1, 16
	lsls r2, 16
	asrs r2, 16
...
_080F9900:
	...
	cmp r4, 0
	beq _080F9928
	ldr r5, _080F9910 @ =gUnknown_020388C0
	b _080F9B2A
	.align 2, 0
...
_080F991A:
	...
	b _080F9AA8
_080F9920:
	ldr r5, _080F9924 @ =gUnknown_020388C0
	b _080F9B2A
	.align 2, 0
_080F9924: .4byte gUnknown_020388C0
_080F9928:
	ldr r0, _080F9988 @ =gUnknown_020388C0
	ldrb r1, [r0]
	adds r5, r0, 0
	cmp r1, 0xFF
	beq _080F9934
	b _080F9B2A
_080F9934:
	ldr r0, _080F998C @ =gSpriteTemplate_83E59D0
	lsls r1, r3, 16
	asrs r1, 16
	lsls r2, 16
	asrs r2, 16
	...
	bl CreateSprite
	strb r0, [r5]
	ldr r3, _080F9990 @ =gSprites
	ldrb r1, [r5]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	adds r0, r3
	ldr r1, _080F9994 @ =0x0000ffff
	strh r1, [r0, 0x32]
	ldrb r0, [r5, 0x1]
	cmp r0, 0xFF
	beq _080F9998
...
_080F9998:
	...
	b _080F9B2A
_080F99A6:
	ldr r0, _080F9A10 @ =gUnknown_020388C0
	ldrb r1, [r0, 0x1]
	adds r5, r0, 0
	cmp r1, 0xFF
	beq _080F99B2
	b _080F9B2A
_080F99B2:
	ldr r0, _080F9A14 @ =gSpriteTemplate_83E59D0
	lsls r1, r3, 16
	asrs r1, 16
	lsls r2, 16
	asrs r2, 16
...
_080F9A1C:
	...
	b _080F9B2A
_080F9A2C:
	ldr r0, _080F9A94 @ =gUnknown_020388C0
	ldrb r1, [r0, 0x2]
	adds r5, r0, 0
	cmp r1, 0xFF
	bne _080F9B2A
	ldr r0, _080F9A98 @ =gSpriteTemplate_83E59E8
	lsls r1, r3, 16
	asrs r1, 16
	lsls r2, 16
	asrs r2, 16
	...
	bl CreateSprite
	strb r0, [r5, 0x2]
	ldr r3, _080F9A9C @ =gSprites
	ldrb r1, [r5, 0x2]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	adds r0, r3
	ldr r1, _080F9AA0 @ =0x0000ffff
	strh r1, [r0, 0x2E]
	ldrb r0, [r5, 0x3]
	cmp r0, 0xFF
	beq _080F9AA4
...
_080F9AA4:
	...
	b _080F9B1E
_080F9AA8:
	ldr r0, _080F9B10 @ =gUnknown_020388C0
	ldrb r1, [r0, 0x3]
	adds r5, r0, 0
	cmp r1, 0xFF
	bne _080F9B2A
	ldr r0, _080F9B14 @ =gSpriteTemplate_83E59E8
	lsls r1, r3, 16
	asrs r1, 16
	lsls r2, 16
	asrs r2, 16
...
sub_80F979C: @ 80F9B4C
	...
	cmp r2, 0x3
	bhi _080F9B84
	ldr r0, _080F9B88 @ =gUnknown_020388C0
	adds r1, r2, r0
	ldrb r0, [r1]
	cmp r0, 0xFF
	beq _080F9B84
	ldr r2, _080F9B8C @ =gSprites
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	adds r1, r2
...
DestroyVerticalScrollIndicator: @ 80F9B90
	...
	cmp r1, 0x3
	bhi _080F9BB8
	ldr r0, _080F9BC0 @ =gUnknown_020388C0
	adds r4, r1, r0
	ldrb r0, [r4]
	cmp r0, 0xFF
	beq _080F9BB8
...
LoadScrollIndicatorPalette: @ 80F9BC8
	push {lr}
	ldr r0, _080F9BD4 @ =gUnknown_083E5968
	bl LoadSpritePalette
	pop {r0}
	bx r0
	.align 2, 0
...
sub_80F98A4: @ 80F9C54
	...
	lsls r0, 24
	lsrs r1, r0, 24
	ldr r0, _080F9C80 @ =gUnknown_020388C0
	adds r3, r1, r0
	ldrb r0, [r3]
	cmp r0, 0xFF
	beq _080F9C7A
	...
	adds r2, 0x1C
	adds r0, r2
	ldr r1, _080F9C88 @ =SpriteCallbackDummy
	str r1, [r0]
_080F9C7A:
	pop {r0}
	bx r0
...
sub_80F98DC: @ 80F9C8C
	...
	lsls r0, 24
	lsrs r1, r0, 24
	ldr r0, _080F9CB8 @ =gUnknown_020388C0
	adds r3, r1, r0
	ldrb r0, [r3]
	cmp r0, 0xFF
	beq _080F9CB2
...
sub_80F9914: @ 80F9CC4
	...
	lsls r0, 24
	lsrs r1, r0, 24
	ldr r0, _080F9D14 @ =gUnknown_020388C0
	adds r4, r1, r0
	ldrb r0, [r4]
	cmp r0, 0xFF
	beq _080F9D0C
...
sub_80F9988: @ 80F9D38
	...
	lsls r1, 24
	lsrs r3, r1, 24
	ldr r0, _080F9D74 @ =gUnknown_020388C0
	adds r1, r2, r0
	ldrb r0, [r1]
	cmp r0, 0xFF
	beq _080F9D6E
