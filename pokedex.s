...
_08090BA0:
	...
	b _08090E2A
_08090BAE:
	ldr r1, _08090BD8 @ =gUnknown_03005CEC
	ldr r0, _08090BDC @ =gMain
	ldr r0, [r0, 0xC]
	str r0, [r1]
	movs r0, 0
...
_08090BE4:
	ldr r0, _08090C44 @ =gPokedexMenu_Gfx
	ldr r1, _08090C48 @ =0x06004000
	bl LZ77UnCompVram
	ldr r0, _08090C4C @ =gUnknown_08E96BD4
	ldr r4, _08090C50 @ =0x06007800
	adds r1, r4, 0
	bl LZ77UnCompVram
	movs r2, 0
	lsls r5, r7, 2
...
_08090C60:
	ldr r4, _08090C90 @ =gWindowConfig_81E7064
	adds r0, r4, 0
	bl SetUpWindowConfig
	adds r0, r4, 0
	bl InitMenuWindow
	ldr r2, _08090C94 @ =0x0600c000
	add r1, sp, 0x4
	movs r0, 0
	strh r0, [r1]
	ldr r0, _08090C98 @ =0x040000d4
	str r1, [r0]
	str r2, [r0, 0x4]
	ldr r1, _08090C9C @ =0x81000100
	str r1, [r0, 0x8]
	ldr r0, [r0, 0x8]
	ldr r1, _08090CA0 @ =gTasks
	lsls r0, r7, 2
	adds r0, r7
	lsls r0, 3
	adds r0, r1
...
_08090CA4:
	ldr r0, _08090CCC @ =gDexText_RegisterComplete
	movs r1, 0x2
	movs r2, 0
	movs r3, 0xD0
	bl sub_8072BD8
...
_08090CDA:
	...
	movs r2, 0x3
	bl sub_80911C8
	ldr r0, _08090D50 @ =gDexText_UnknownPoke
	movs r1, 0x10
	movs r2, 0x5
	bl MenuPrint
	ldr r0, _08090D54 @ =gDexText_UnknownHeight
	movs r1, 0x10
	movs r2, 0x7
	bl MenuPrint
	ldr r0, _08090D58 @ =gDexText_UnknownWeight
	movs r1, 0x10
	movs r2, 0x9
	bl MenuPrint
	lsls r4, r6, 3
	adds r4, r6
	lsls r4, 2
	ldr r6, _08090D5C @ =gPokedexEntries
	adds r5, r4, r6
	adds r0, r5, 0
	movs r1, 0x10
	movs r2, 0x5
...
_08090D64:
	...
	ldr r0, _08090DB4 @ =gUnknown_03005CEC
	ldr r0, [r0]
	bl SetVBlankCallback
	ldr r1, _08090DB8 @ =gTasks
	lsls r0, r7, 2
	adds r0, r7
	lsls r0, 3
	adds r0, r1
...
_08090DBC:
	...
	adds r0, 0x2
	strh r1, [r0]
	ldr r1, _08090DF0 @ =0x0400000e
	ldr r2, _08090DF4 @ =0x00000f07
	adds r0, r2, 0
	strh r0, [r1]
	subs r1, 0xE
	movs r5, 0xE2
...
sub_8090A3C: @ 8090E40
	...
	cmp r2, 0
	beq _08090EA8
	ldr r0, _08090E94 @ =0x0000fffc
	movs r1, 0
	str r1, [sp]
	movs r2, 0
	movs r3, 0x10
	bl BeginNormalPaletteFade
	ldr r3, _08090E98 @ =gSprites
	ldr r0, _08090E9C @ =gTasks
	lsls r1, r6, 2
	adds r1, r6
	lsls r1, 3
	adds r1, r0
	...
	adds r3, 0x1C
	adds r0, r3
	ldr r2, _08090EA0 @ =sub_8090C28
	str r2, [r0]
	ldr r0, _08090EA4 @ =sub_8090B8C
	str r0, [r1]
	b _08090F7E
	.align 2, 0
...
_08090EA8:
	...
	ldr r1, _08090F08 @ =gPokedexEntries
	lsls r0, r4, 3
	adds r0, r4
	lsls r0, 2
	adds r1, 0x14
...
_08090F10:
	ldr r0, _08090F38 @ =0x0000fffc
	str r2, [sp]
	movs r1, 0
	movs r2, 0
	movs r3, 0x10
	bl BeginNormalPaletteFade
	ldr r2, _08090F3C @ =gSprites
	movs r0, 0xE
	ldrsh r1, [r5, r0]
	lsls r0, r1, 4
	adds r0, r1
	...
	adds r2, 0x1C
	adds r0, r2
	ldr r1, _08090F40 @ =sub_8090C28
	str r1, [r0]
	ldr r0, _08090F44 @ =sub_8090B8C
	str r0, [r5]
	b _08090F7E
	.align 2, 0
...
sub_8090B8C: @ 8090F90
	...
	adds r0, r2, 0
	strh r0, [r1]
	ldr r0, _0809101C @ =gUnknown_08D00524
	ldr r1, _08091020 @ =0x0600c000
	movs r2, 0x80
	lsls r2, 4
	bl CpuSet
	bl sub_800D74C
	ldr r0, _08091024 @ =gTasks
	lsls r4, r6, 2
	adds r4, r6
	lsls r4, 3
	adds r4, r0
...
sub_8090C68: @ 809106C
	push {r4,r5,lr}
	ldr r4, _080910D4 @ =gUnknown_0202FFBC
	ldr r0, [r4]
	ldrb r1, [r0, 0x2]
	movs r0, 0x2
	ands r0, r1
	cmp r0, 0
	beq _0809112E
	ldr r5, _080910D8 @ =gPokedexView
	ldr r0, [r5]
	ldr r1, _080910DC @ =0x0000064e
	adds r0, r1
	ldrb r0, [r0]
	cmp r0, 0
	bne _080910E8
	...
	movs r3, 0x13
	bl MenuZeroFillWindowRect
	ldr r2, _080910E0 @ =gPokedexEntries
	ldr r0, [r4]
	ldrh r1, [r0]
	lsls r0, r1, 3
	adds r0, r1
...
_080910E8:
	...
	movs r3, 0x13
	bl MenuZeroFillWindowRect
	ldr r2, _08091134 @ =gPokedexEntries
	ldr r0, [r4]
	ldrh r1, [r0]
	lsls r0, r1, 3
	adds r0, r1
	...
	bl MenuPrint
	ldr r0, [r5]
	ldr r1, _08091138 @ =0x0000064e
	adds r0, r1
	movs r1, 0
	strb r1, [r0]
	ldr r1, _0809113C @ =0x06007aca
	ldrh r0, [r1]
	subs r0, 0x1
	strh r0, [r1]
	adds r1, 0x40
...
GetPokemonCategory: @ 8091140
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _08091154 @ =gPokedexEntries
	adds r0, r1
	bx lr
	.align 2, 0
...
sub_8090D54: @ 8091158
	...
	b _0809118C
_0809116E:
	ldr r0, _0809117C @ =gPokedexEntries
	lsls r1, r2, 3
	adds r1, r2
	lsls r1, 2
	adds r1, r0
...
_08091180:
	ldr r0, _08091190 @ =gPokedexEntries
	lsls r1, r2, 3
	adds r1, r2
	lsls r1, 2
	adds r1, r0
...
_080911D8:
	...
	b _0809130E
_080911EC:
	ldr r0, _0809121C @ =gSaveBlock1
	ldr r3, _08091220 @ =0x00000938
	adds r1, r0, r3
	adds r1, r4, r1
	ldrb r1, [r1]
	ands r1, r5
...
_08091228:
	...
	ldrb r0, [r0]
	ands r0, r5
	ldr r6, _08091270 @ =gSaveBlock1
	cmp r2, r0
	bne _0809127C
	ldr r3, _08091274 @ =0x00000938
	adds r0, r6, r3
	adds r0, r4, r0
	ldrb r0, [r0]
	ands r0, r5
...
_080912C0:
	...
	orrs r0, r2
	strb r0, [r1]
	ldr r1, _080912F4 @ =gSaveBlock1
	ldr r3, _080912F8 @ =0x00000938
	adds r2, r1, r3
	adds r2, r4, r2
	ldrb r3, [r2]
	adds r0, r5, 0
...
sub_8091060: @ 8091464
	...
	lsls r2, 19
	ldrh r1, [r2]
	ldr r0, _08091530 @ =0x0000feff
	ands r0, r1
	strh r0, [r2]
	ldr r0, _08091534 @ =0x04000008
	strh r3, [r0]
	adds r0, 0x8
	strh r3, [r0]
	adds r0, 0x2
...
_08091492:
	...
	lsls r2, 19
	ldrh r1, [r2]
	ldr r0, _08091538 @ =0x0000fdff
	ands r0, r1
	strh r0, [r2]
	ldr r0, _0809153C @ =0x0400000a
	strh r3, [r0]
	adds r0, 0xA
	strh r3, [r0]
	adds r0, 0x2
...
_080914B8:
	...
	lsls r2, 19
	ldrh r1, [r2]
	ldr r0, _08091540 @ =0x0000fbff
	ands r0, r1
	strh r0, [r2]
	ldr r0, _08091544 @ =0x0400000c
	strh r3, [r0]
	adds r0, 0xC
	strh r3, [r0]
	adds r0, 0x2
...
_080914DE:
	...
	lsls r2, 19
	ldrh r1, [r2]
	ldr r0, _08091548 @ =0x0000f7ff
	ands r0, r1
	strh r0, [r2]
	ldr r0, _0809154C @ =0x0400000e
	strh r3, [r0]
	adds r0, 0xE
	strh r3, [r0]
	adds r0, 0x2
...
_08091504:
	...
	lsls r2, 19
	ldrh r1, [r2]
	ldr r0, _08091550 @ =0x0000efff
	ands r0, r1
	strh r0, [r2]
	bl ResetSpriteData
	bl FreeAllSpritePalettes
	ldr r1, _08091554 @ =gReservedSpritePaletteCount
	movs r0, 0x8
	strb r0, [r1]
_08091528:
	pop {r4,r5}
...
_080915E0:
	...
	beq _0809163C
	movs r4, 0
	ldr r2, _08091638 @ =gSpeciesNames
	movs r0, 0xB
	adds r1, r3, 0
	muls r1, r0
	adds r0, r1, r2
...
sub_8091260: @ 8091664
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r1, _080916D0 @ =gUnknown_083B5558
	mov r0, sp
	bl StringCopy
	adds r6, r0, 0
	mov r0, sp
	...
	beq _080916D8
	movs r4, 0
	ldr r2, _080916D4 @ =gSpeciesNames
	movs r0, 0xB
	adds r1, r5, 0
	muls r1, r0
	adds r0, r1, r2
...
sub_8091304: @ 8091708
	...
	movs r2, 0
	ldrb r0, [r3]
	ldr r6, _08091758 @ =gDexText_UnknownPoke
	cmp r0, 0xFF
	beq _0809173C
_08091720:
	mov r0, sp
...
sub_8091738: @ 8091888
	...
	lsls r5, 16
	lsrs r5, 16
	ldr r6, _08091918 @ =gMonFootprintTable
	bl NationalPokedexNumToSpecies
	lsls r0, 16
	lsrs r0, 14
	adds r0, r6
...
sub_80917CC: @ 809191C
	...
	lsrs r1, 16
	lsrs r0, 5
	ldr r2, _08091958 @ =0x06000232
	adds r3, r0, r2
	movs r4, 0xF0
	lsls r4, 8
	adds r2, r1, r4
	strh r2, [r3]
	ldr r2, _0809195C @ =0x06000234
	adds r3, r0, r2
	adds r4, 0x1
	adds r2, r1, r4
	strh r2, [r3]
	ldr r2, _08091960 @ =0x06000272
	adds r3, r0, r2
	adds r4, 0x1
	adds r2, r1, r4
	strh r2, [r3]
	ldr r2, _08091964 @ =0x06000274
	adds r0, r2
	adds r4, 0x1
	adds r1, r4
	strh r1, [r0]
...
sub_8091878: @ 80919C8
	push {r4-r7,lr}
	lsls r1, 24
	ldr r4, _080919F0 @ =gUnknown_02024E8C
	adds r3, r4, 0
	ldr r2, _080919F4 @ =gUnknown_083B57A4
	ldm r2!, {r5-r7}
	stm r3!, {r5-r7}
	ldm r2!, {r5-r7}
	stm r3!, {r5-r7}
	strh r0, [r4, 0x2]
	ldr r0, _080919F8 @ =gUnknown_083B5794
	lsrs r1, 22
	adds r1, r0
	ldr r0, [r1]
	str r0, [r4, 0xC]
	ldr r0, _080919FC @ =gSpriteAnimTable_81E7C64
	str r0, [r4, 0x8]
	pop {r4-r7}
	pop {r0}
	bx r0
...
sub_80918B0: @ 8091A00
	push {r4-r7,lr}
	lsls r1, 24
	ldr r4, _08091A2C @ =gUnknown_02024E8C
	adds r3, r4, 0
	ldr r2, _08091A30 @ =gUnknown_083B57A4
	ldm r2!, {r5-r7}
	stm r3!, {r5-r7}
	ldm r2!, {r5-r7}
	stm r3!, {r5-r7}
	strh r0, [r4, 0x2]
	ldr r0, _08091A34 @ =gUnknown_083B5794
	lsrs r1, 22
	adds r1, r0
	ldr r0, [r1]
	str r0, [r4, 0xC]
	ldr r0, _08091A38 @ =gUnknown_081EC2A4
	ldr r0, [r0]
	str r0, [r4, 0x8]
	pop {r4-r7}
	pop {r0}
...
sub_80918EC: @ 8091A3C
	...
	beq _08091AA8
	lsls r6, r7, 3
	ldr r0, _08091A9C @ =gMonFrontPicTable
	adds r0, r6, r0
	ldr r1, _08091AA0 @ =gMonFrontPicCoords
	lsls r2, r7, 2
	adds r2, r1
	ldrb r1, [r2]
	ldrb r2, [r2, 0x1]
	movs r3, 0x80
	lsls r3, 18
	ldr r4, _08091AA4 @ =gUnknown_083B5584
	mov r12, r4
	mov r5, r8
	lsls r4, r5, 2
	add r4, r12
...
_08091AA8:
	lsls r6, r7, 3
	ldr r0, _08091ADC @ =gMonFrontPicTable
	adds r0, r6
	ldr r2, _08091AE0 @ =gMonFrontPicCoords
	lsls r1, r7, 2
	adds r2, r1
	ldrb r1, [r2]
	ldrb r2, [r2, 0x1]
	movs r3, 0x80
	lsls r3, 18
	ldr r4, _08091AE4 @ =gUnknown_083B5584
	mov r12, r4
	mov r5, r8
	lsls r4, r5, 2
	add r4, r12
...
_08091AEC:
	lsls r6, r7, 3
	ldr r0, _08091B80 @ =gMonFrontPicTable
	adds r0, r6
	ldr r2, _08091B84 @ =gMonFrontPicCoords
	lsls r1, r7, 2
	adds r2, r1
	ldrb r1, [r2]
	ldrb r2, [r2, 0x1]
	movs r3, 0x80
	lsls r3, 18
	ldr r4, _08091B88 @ =gUnknown_083B5584
	mov r12, r4
	mov r5, r8
	lsls r4, r5, 2
	add r4, r12
	...
	bl sub_800D378
_08091B1E:
	ldr r0, _08091B90 @ =gMonPaletteTable
	adds r0, r6, r0
	ldr r0, [r0]
	mov r1, r8
	lsls r4, r1, 4
	...
	mov r0, r8
	bl sub_8091878
	ldr r0, _08091B94 @ =gUnknown_02024E8C
	mov r5, r9
	lsls r1, r5, 16
	asrs r1, 16
	mov r3, r10
...
sub_8091A4C: @ 8091B9C
	...
	mov r9, r1
	lsls r0, r5, 3
	ldr r1, _08091C34 @ =gTrainerFrontPicTable
	adds r0, r1
	ldr r1, _08091C38 @ =gTrainerFrontPicCoords
	lsls r2, r5, 2
	adds r2, r1
	ldrb r1, [r2]
	ldrb r2, [r2, 0x1]
	movs r3, 0x80
	lsls r3, 18
	ldr r4, _08091C3C @ =gUnknown_083B5584
	ldr r4, [r4]
	str r4, [sp]
	str r5, [sp, 0x4]
	bl DecompressPicFromTable_2
	...
	movs r1, 0
	bl sub_80918B0
	ldr r0, _08091C40 @ =gUnknown_02024E8C
	lsls r6, 16
	asrs r6, 16
	mov r3, r8
	lsls r3, 16
...
sub_8091AF8: @ 8091C48
	...
	movs r5, 0
	movs r6, 0
	ldr r4, _08091E58 @ =0x00000181
	ldr r3, _08091E5C @ =gPokedexView
_08091C82:
	ldr r2, [r3]
	lsls r0, r5, 2
	adds r1, r2, r0
...
_08091C9E:
	...
	cmp r5, r4
	bls _08091C82
	ldr r1, _08091E5C @ =gPokedexView
	ldr r0, [r1]
	ldr r2, _08091E60 @ =0x0000060c
	adds r0, r2
	adds r1, r6, 0
	strh r6, [r0]
	cmp r7, 0xFF
	...
	beq _08091D4A
	lsls r7, 2
	ldr r0, _08091E64 @ =gUnknown_083B57BC
	adds r0, 0x3
	adds r0, r7, r0
	str r0, [sp, 0xC]
	ldr r0, _08091E64 @ =gUnknown_083B57BC
...
_08091CD2:
	...
	lsls r0, 16
	lsrs r2, r0, 16
	ldr r1, _08091E68 @ =gSpeciesNames
	movs r0, 0xB
	muls r0, r2
	adds r0, r1
	ldrb r2, [r0]
	...
	mov r1, r9
	ldrb r0, [r1]
	ldr r1, _08091E64 @ =gUnknown_083B57BC
	adds r1, 0x1
	adds r1, r7, r1
	ldrb r1, [r1]
	adds r0, r1
...
_08091E70:
	movs r5, 0
	movs r6, 0
	ldr r1, _08091F5C @ =gPokedexView
	ldr r0, [r1]
	ldr r2, _08091F60 @ =0x0000060c
	adds r0, r2
	ldrh r0, [r0]
	cmp r6, r0
	bcs _08091EEC
...
_08091EF6:
	...
	beq _08091F4A
	adds r5, r0, 0
	ldr r0, _08091F68 @ =0x00000181
	cmp r5, r0
	bhi _08091F4A
	ldr r4, _08091F5C @ =gPokedexView
	movs r1, 0x2
	negs r1, r1
	mov r10, r1
	movs r2, 0x3
...
sub_8091E54: @ 8091FA4
	...
	lsls r0, 24
	lsrs r5, r0, 24
	ldr r1, _08091FC8 @ =gMain
	ldr r2, _08091FCC @ =0x0000043c
	adds r0, r1, r2
	ldrb r0, [r0]
	adds r3, r1, 0
	cmp r0, 0x4
...
_08091FE8:
	...
	b _08092180
_08091FF6:
	ldr r0, _08092070 @ =gPokedexView
	ldr r0, [r0]
	ldr r1, _08092074 @ =0x0000064a
	adds r0, r1
	movs r1, 0x2
	strb r1, [r0]
	movs r0, 0
	bl sub_8091060
	ldr r0, _08092078 @ =gPokedexMenuSearch_Gfx
	movs r1, 0xC0
	lsls r1, 19
	bl LZ77UnCompVram
	ldr r0, _0809207C @ =gUnknown_08E96D2C
	ldr r1, _08092080 @ =0x06007800
	bl LZ77UnCompVram
	ldr r0, _08092084 @ =0x08e88186
	movs r1, 0x1
	movs r2, 0x7E
	bl LoadPalette
	bl IsNationalPokedex
	...
	bne _08092060
	movs r4, 0
	ldr r2, _08092088 @ =0x06007a80
	mov r8, r2
	ldr r0, _0809208C @ =0x06007b00
	mov r12, r0
	movs r5, 0x1
	ldr r7, _08092090 @ =0x06007ac0
	ldr r6, _08092094 @ =0x06007b40
_0809203C:
	lsls r1, r4, 1
	mov r0, r8
	adds r2, r1, r0
	...
	bls _0809203C
_08092060:
	ldr r0, _08092098 @ =gMain
	ldr r1, _0809209C @ =0x0000043c
	adds r0, r1
	movs r1, 0x1
	strb r1, [r0]
	b _08092180
...
_080920A0:
	ldr r4, _080920F8 @ =gWindowConfig_81E7064
	adds r0, r4, 0
	bl SetUpWindowConfig
	adds r0, r4, 0
	bl InitMenuWindow
	ldr r0, _080920FC @ =gUnknown_083A05CC
	bl LoadCompressedObjectPic
	ldr r0, _08092100 @ =gUnknown_083A05DC
...
_080920CC:
	...
	adds r0, r5, 0
	bl sub_8092B68
	ldr r1, _08092108 @ =gMain
	ldr r2, _0809210C @ =0x0000043c
	adds r1, r2
	b _08092146
	.align 2, 0
...
_08092110:
	...
	movs r3, 0
	bl BeginNormalPaletteFade
	ldr r1, _08092128 @ =gMain
	ldr r0, _0809212C @ =0x0000043c
	adds r1, r0
	b _08092146
	.align 2, 0
...
_08092130:
	ldr r1, _08092150 @ =0x0400000e
	ldr r2, _08092154 @ =0x00000f03
	adds r0, r2, 0
	strh r0, [r1]
	subs r1, 0xE
	movs r2, 0xE2
...
_0809215C:
	...
	cmp r2, 0
	bne _08092180
	ldr r1, _08092190 @ =gTasks
	lsls r0, r5, 2
	adds r0, r5
	lsls r0, 3
	adds r0, r1
	ldr r1, _08092194 @ =sub_809204C
	str r1, [r0]
	ldr r1, _08092198 @ =0x0000043c
	adds r0, r3, r1
	strb r2, [r0]
_08092180:
	add sp, 0x4
...
sub_809207C: @ 80921CC
	...
	movs r0, 0x3
	bl PlaySE
	ldr r0, _080921F8 @ =gTasks
	lsls r1, r5, 2
	adds r1, r5
	lsls r1, 3
	adds r1, r0
	ldr r0, _080921FC @ =sub_80927B8
	str r0, [r1]
	b _080922BC
	.align 2, 0
...
sub_80921B0: @ 8092300
	...
	beq _08092334
	bl IsNationalPokedex
	ldr r6, _0809232C @ =gUnknown_083B586C
	cmp r0, 0
	bne _08092340
	ldr r6, _08092330 @ =gUnknown_083B58A4
	b _08092340
	.align 2, 0
...
_08092334:
	bl IsNationalPokedex
	ldr r6, _0809236C @ =gUnknown_083B5850
	cmp r0, 0
	bne _08092340
	ldr r6, _08092370 @ =gUnknown_083B5888
_08092340:
	ldr r0, _08092374 @ =gMain
	ldrh r1, [r0, 0x2E]
	movs r0, 0x2
	ands r0, r1
	lsls r0, 16
	...
	adds r0, r5, 0
	bl sub_8092EB0
	ldr r0, _08092378 @ =gTasks
	lsls r1, r5, 2
	adds r1, r5
	lsls r1, 3
	adds r1, r0
	ldr r0, _0809237C @ =sub_809204C
	str r0, [r1]
	b _0809253C
	.align 2, 0
...
_08092380:
	...
	cmp r0, 0
	beq _08092424
	ldr r1, _08092408 @ =gUnknown_0202FFBA
	movs r0, 0x40
	strb r0, [r1]
	ldr r7, _0809240C @ =gPokedexView
	ldr r1, [r7]
	ldr r0, _08092410 @ =0x0000062a
	adds r2, r1, r0
	movs r0, 0x40
	strh r0, [r2]
	ldr r0, _08092414 @ =gUnknown_0202FFB8
	strh r3, [r0]
	movs r2, 0xC2
	lsls r2, 3
	adds r1, r2
...
_08092424:
	ldr r0, _08092438 @ =gDexText_Searching
	bl sub_8091E20
	ldr r0, _0809243C @ =sub_80923FC
	str r0, [r6]
	movs r0, 0x70
	bl PlaySE
	b _0809253C
...
sub_80923FC: @ 809254C
	...
	adds r3, r6, 0
	bl sub_8091AF8
	ldr r1, _080925EC @ =gTasks
	lsls r0, r5, 2
	adds r0, r5
	lsls r0, 3
	adds r0, r1
	ldr r1, _080925F0 @ =sub_80924A4
	str r1, [r0]
	add sp, 0x8
	pop {r3-r5}
	mov r8, r3
...
sub_80924A4: @ 80925F4
	...
	cmp r0, 0
	bne _08092646
	ldr r0, _08092620 @ =gPokedexView
	ldr r0, [r0]
	ldr r1, _08092624 @ =0x0000060c
	adds r0, r1
	ldrh r0, [r0]
	cmp r0, 0
	beq _0809262C
	movs r0, 0x1F
	bl PlaySE
	ldr r0, _08092628 @ =gDexText_SearchComplete
	bl sub_8091E20
	b _08092638
	.align 2, 0
...
_0809262C:
	movs r0, 0x20
	bl PlaySE
	ldr r0, _0809264C @ =gDexText_NoMatching
	bl sub_8091E20
_08092638:
	ldr r0, _08092650 @ =gTasks
	lsls r1, r4, 2
	adds r1, r4
	lsls r1, 3
	adds r1, r0
	ldr r0, _08092654 @ =sub_8092508
	str r0, [r1]
_08092646:
	pop {r4}
	pop {r0}
...
sub_8092508: @ 8092658
	...
	lsrs r4, r0, 24
	adds r2, r4, 0
	ldr r0, _080926C0 @ =gMain
	ldrh r1, [r0, 0x2E]
	movs r0, 0x1
	ands r0, r1
	cmp r0, 0
	beq _080926F4
	ldr r5, _080926C4 @ =gPokedexView
	ldr r1, [r5]
	ldr r3, _080926C8 @ =0x0000060c
	adds r0, r1, r3
	ldrh r0, [r0]
	cmp r0, 0
	beq _080926E0
	ldr r0, _080926CC @ =0x0000064f
	adds r1, r0
	movs r0, 0x1
	strb r0, [r1]
	adds r0, r4, 0
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r3, _080926D4 @ =0x00000616
	adds r1, r3
	strh r0, [r1]
	ldr r1, _080926D8 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080926DC @ =sub_80927B8
	str r1, [r0]
	movs r0, 0x3
	bl PlaySE
	b _080926F4
...
_080926E0:
	ldr r0, _080926FC @ =gTasks
	lsls r1, r2, 2
	adds r1, r2
	lsls r1, 3
	adds r1, r0
	ldr r0, _08092700 @ =sub_809217C
	str r0, [r1]
	movs r0, 0x17
	bl PlaySE
_080926F4:
...
sub_80925CC: @ 809271C
	...
	adds r2, 0x8
	adds r1, r2
	ldr r2, _08092784 @ =gUnknown_083B5A7C
	lsls r0, 3
	adds r0, r2
	ldrb r5, [r0, 0x4]
	lsls r5, 1
	...
	adds r0, r4, 0
	bl sub_8092D78
	ldr r1, _08092788 @ =0x0000ffff
	ldr r3, _0809278C @ =0x00002d9f
	movs r0, 0xB
	str r0, [sp]
	movs r0, 0x10
	movs r2, 0xC
...
sub_8092644: @ 8092794
	...
	lsls r0, 24
	lsrs r7, r0, 24
	ldr r3, _080927F8 @ =gTasks
	lsls r2, r7, 2
	adds r2, r7
	lsls r2, 3
	adds r6, r2, r3
	ldrb r1, [r6, 0xA]
	ldr r0, _080927FC @ =gUnknown_083B5A7C
	lsls r1, 3
	adds r1, r0
	ldr r0, [r1]
	mov r8, r0
...
sub_80927B8: @ 8092908
	...
	movs r3, 0x10
	bl BeginNormalPaletteFade
	ldr r1, _08092938 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _0809293C @ =sub_80927F0
	str r1, [r0]
	add sp, 0x4
	pop {r4}
	pop {r0}
...
_08092980:
	...
	lsls r1, 1
	adds r1, r7, r1
	ldr r0, _080929B4 @ =0x06007800
	adds r2, r1, r0
	ldrh r0, [r2]
	ands r0, r6
	orrs r0, r4
	strh r0, [r2]
	ldr r0, _080929B8 @ =0x06007840
	adds r1, r0
	ldrh r0, [r1]
	ands r0, r6
	orrs r0, r4
...
_080929E8:
	...
	.4byte _08092A54
_08092A14:
	ldr r1, _08092A20 @ =gUnknown_083B57E4
	lsls r0, r4, 3
	adds r0, r1
	ldrb r1, [r0, 0x4]
	ldrb r2, [r0, 0x5]
...
_08092A24:
	ldr r2, _08092A50 @ =gUnknown_083B57FC
	subs r1, r4, 0x3
	lsls r0, r1, 1
	adds r0, r1
	lsls r0, 2
...
_08092A54:
	ldr r0, _08092A60 @ =gUnknown_083B57FC
	ldrb r1, [r0, 0x1C]
	ldrb r2, [r0, 0x1D]
	ldrb r3, [r0, 0x1E]
	b _08092A84
...
_08092A64:
	...
	cmp r0, 0
	bne _08092A90
	ldr r2, _08092A8C @ =gUnknown_083B57FC
	subs r1, r4, 0x3
	lsls r0, r1, 1
	adds r0, r1
	lsls r0, 2
...
_08092A90:
	ldr r2, _08092AB0 @ =gUnknown_083B57FC
	subs r1, r4, 0x3
	lsls r0, r1, 1
	adds r0, r1
	lsls r0, 2
...
sub_8092AB0: @ 8092C00
	...
	adds r0, r4, 0
	bl sub_8092964
	ldr r0, _08092C20 @ =gUnknown_083B57E4
	lsls r4, 3
	adds r4, r0
	ldr r0, [r4]
	bl sub_8091E20
...
_08092C94:
	...
	bl sub_809286C
_08092C9E:
	ldr r0, _08092CB4 @ =gUnknown_083B57FC
	lsls r1, r4, 1
	adds r1, r4
	lsls r1, 2
	adds r1, r0
...
sub_8092B68: @ 8092CB8
	...
	adds r0, r1
	lsls r0, 16
	ldr r7, _08092DBC @ =gStringVar1
	ldr r1, _08092DC0 @ =gUnknown_083B5910
	lsrs r0, 13
	adds r1, 0x4
	adds r0, r1
	ldr r1, [r0]
	adds r0, r7, 0
	bl StringCopy
	ldr r0, _08092DC4 @ =gUnknown_083B5AB2
	mov r8, r0
	movs r1, 0x2D
	movs r2, 0x10
	movs r3, 0x1
	...
	adds r0, r1
	lsls r0, 16
	ldr r1, _08092DC8 @ =gUnknown_083B5968
	lsrs r0, 13
	adds r1, 0x4
	adds r0, r1
	ldr r1, [r0]
	...
	adds r0, r1
	lsls r0, 16
	ldr r4, _08092DCC @ =gUnknown_083B59C8
	lsrs r0, 13
	adds r4, 0x4
	adds r0, r4
	ldr r1, [r0]
	adds r0, r7, 0
	bl StringCopy
	ldr r5, _08092DD0 @ =gUnknown_083B5AAC
	adds r0, r5, 0
	movs r1, 0x2D
	movs r2, 0x30
	movs r3, 0x1
	...
	adds r0, r1
	lsls r0, 16
	ldr r1, _08092DD4 @ =gUnknown_083B58D8
	lsrs r0, 13
	adds r1, 0x4
	adds r0, r1
	ldr r1, [r0]
	...
	adds r0, r6
	lsls r0, 16
	ldr r1, _08092DD8 @ =gUnknown_083B58C0
	lsrs r0, 13
	adds r1, 0x4
	adds r0, r1
	ldr r1, [r0]
...
sub_8092C8C: @ 8092DDC
	...
	cmp r0, 0
	bne _08092E98
	ldr r1, _08092E6C @ =0x06007822
	ldr r2, _08092E70 @ =0x00000c0b
	adds r0, r2, 0
	strh r0, [r1]
	movs r1, 0x12
	ldr r3, _08092E74 @ =0x06007800
	ldr r4, _08092E78 @ =0x0000080d
	adds r2, r4, 0
_08092DF4:
	lsls r0, r1, 1
	adds r0, r3
	...
	cmp r1, 0x1C
	bls _08092DF4
	ldr r1, _08092E7C @ =0x0600783a
	ldr r2, _08092E80 @ =0x0000080b
	adds r0, r2, 0
	strh r0, [r1]
	movs r3, 0x1
	ldr r6, _08092E74 @ =0x06007800
	movs r5, 0x2
_08092E12:
	lsls r2, r3, 6
	ldr r4, _08092E6C @ =0x06007822
	adds r1, r2, r4
	ldr r4, _08092E84 @ =0x0000040a
	adds r0, r4, 0
	strh r0, [r1]
	movs r1, 0x12
	adds r4, r3, 0x1
...
_08092E24:
	...
	cmp r3, 0xC
	bls _08092E12
	ldr r1, _08092E88 @ =0x06007b62
	ldr r2, _08092E8C @ =0x0000040b
	adds r0, r2, 0
	strh r0, [r1]
	movs r1, 0x12
	ldr r3, _08092E90 @ =0x06007b40
	movs r2, 0xD
_08092E54:
	lsls r0, r1, 1
	adds r0, r3
...
sub_8092D78: @ 8092EC8
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r4, _08092F0C @ =gUnknown_083B5A7C
	ldr r3, _08092F10 @ =gTasks
	lsls r2, r0, 2
	adds r2, r0
	lsls r2, 3
	adds r0, r2, r3
...
sub_8092E10: @ 8092F60
	...
	adds r1, r0
	lsls r1, 3
	ldr r0, _08092FA0 @ =0x03004b38
	adds r1, r0
	ldr r2, _08092FA4 @ =gUnknown_083B5A7C
	lsls r0, r3, 3
	adds r0, r2
	ldrb r2, [r0, 0x4]
	lsls r2, 1
...
_08092FC4:
	...
	b _08092FF8
_08092FC8:
	ldr r0, _08092FCC @ =gUnknown_083B5A60
	b _08092FF4
	.align 2, 0
_08092FCC: .4byte gUnknown_083B5A60
_08092FD0:
	ldr r0, _08092FD4 @ =gUnknown_083B5A62
	b _08092FF4
	.align 2, 0
...
_08092FEA:
	...
	b _08092FF8
_08092FF2:
	ldr r0, _08092FFC @ =gUnknown_083B5A68
_08092FF4:
	adds r0, r2, r0
	ldrb r0, [r0]
_08092FF8:
...
sub_8092EB0: @ 8093000
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r1, _08093020 @ =gPokedexView
	ldr r0, [r1]
	ldr r2, _08093024 @ =0x00000614
	adds r0, r2
	ldrh r0, [r0]
	adds r5, r1, 0
	cmp r0, 0
...
sub_8092F44: @ 8093094
	...
	adds r3, 0x8
	adds r1, r3
	ldr r0, _080930D0 @ =gUnknown_083B5A7C
	lsls r2, 3
	adds r2, r0
	ldrb r0, [r2, 0x5]
	lsls r0, 1
...
sub_8092F8C: @ 80930DC
	...
	adds r3, 0x8
	adds r1, r3
	ldr r0, _0809311C @ =gUnknown_083B5A7C
	lsls r2, 3
	adds r2, r0
	ldrb r0, [r2, 0x5]
	lsls r0, 1
...
sub_809308C: @ 80931DC
	...
	lsls r5, 24
	lsrs r5, 24
	ldr r6, _08093254 @ =gSpriteTemplate_83A053C
	adds r0, r6, 0
	movs r1, 0xB8
	movs r2, 0x4
	movs r3, 0
