...
sub_80FE1DC: @ 80FE58C
	...
	ldr r3, _080FE5C8 @ =gUnknown_083EC604
	movs r0, 0x1
	movs r1, 0x1
	movs r2, 0x4
	bl PrintMenuItems
	ldr r0, _080FE5CC @ =gUnknown_020388D4
	ldrb r0, [r0]
	str r0, [sp]
	movs r0, 0x9
	str r0, [sp, 0x4]
...
sub_80FE220: @ 80FE5D0
	push {lr}
	ldr r1, _080FE5E8 @ =gUnknown_020388D4
	movs r0, 0
	strb r0, [r1]
...
DecorationPC: @ 80FE5EC
	...
	lsrs r4, 24
	bl sub_80FE220
	ldr r1, _080FE60C @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080FE610 @ =Task_DecorationPCProcessMenuInput
	str r1, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
Task_SecretBasePC_Decoration: @ 80FE614
	...
	lsrs r0, 24
	bl DecorationPC
	ldr r1, _080FE634 @ =0x0201f000
	ldr r0, _080FE638 @ =0x0202714e
	str r0, [r1]
	adds r0, 0x10
	str r0, [r1, 0x4]
	movs r2, 0
...
DoPlayerPCDecoration: @ 80FE63C
	...
	lsrs r0, 24
	bl DecorationPC
	ldr r1, _080FE65C @ =0x0201f000
	ldr r0, _080FE660 @ =0x02027dbc
	str r0, [r1]
	adds r0, 0xC
	str r0, [r1, 0x4]
	movs r0, 0xC
...
sub_80FE2B4: @ 80FE664
	push {lr}
	sub sp, 0x8
	ldr r1, _080FE698 @ =gUnknown_083EC654
	mov r0, sp
	movs r2, 0x6
	bl memcpy
	add r0, sp, 0x4
...
Task_DecorationPCProcessMenuInput: @ 80FE69C
	...
	negs r0, r0
	bl MoveMenuCursor
	ldr r1, _080FE720 @ =gUnknown_020388D4
	strb r0, [r1]
	bl sub_80FE394
_080FE6D4:
	ldrh r1, [r4, 0x2E]
...
_080FE6F2:
	...
	movs r0, 0x5
	bl PlaySE
	ldr r1, _080FE724 @ =gUnknown_083EC604
	ldr r0, _080FE720 @ =gUnknown_020388D4
	ldrb r0, [r0]
	lsls r0, 3
	adds r1, 0x4
	adds r0, r1
...
sub_80FE394: @ 80FE744
	...
	ldr r1, _080FE76C @ =gUnknown_083EC624
	ldr r0, _080FE770 @ =gUnknown_020388D4
	ldrb r0, [r0]
	lsls r0, 2
	adds r0, r1
	ldr r0, [r0]
...
gpu_pal_decompress_alloc_tag_and_upload: @ 80FE774
	...
	ldr r0, _080FE7B4 @ =0x0201f000
	ldrb r0, [r0, 0x9]
	cmp r0, 0
	bne _080FE7BC
	ldr r0, _080FE7B8 @ =gUnknown_0815F399
...
sub_80FE428: @ 80FE7D8
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r0, _080FE814 @ =gUnknown_020388D4
	ldrb r0, [r0]
	str r0, [sp]
	movs r0, 0x9
	str r0, [sp, 0x4]
	...
	bl InitMenu
	bl sub_80FE394
	ldr r1, _080FE818 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080FE81C @ =Task_DecorationPCProcessMenuInput
	str r1, [r0]
	add sp, 0x8
	pop {r4}
	pop {r0}
...
sub_80FE470: @ 80FE820
	...
	strb r5, [r7, 0x2]
	adds r7, 0x3
	ldr r1, _080FE8D0 @ =gUnknown_083EC5E4
	lsls r0, r4, 2
	adds r0, r1
	ldr r1, [r0]
	adds r0, r7, 0
	...
	strb r0, [r7]
	adds r7, 0x1
	ldr r0, _080FE8D4 @ =gDecorationInventories
	lsls r4, 3
	adds r4, r0
	ldrb r1, [r4, 0x4]
	adds r0, r7, 0
...
sub_80FE528: @ 80FE8D8
	...
	bl MenuDrawTextWindow
	movs r5, 0
	ldr r1, _080FE924 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r4, r0, r1
_080FE8F8:
	ldr r0, _080FE928 @ =0x0201f000
	ldrb r0, [r0, 0x9]
	cmp r0, 0x1
	bne _080FE92C
	movs r1, 0x1E
...
_080FE93E:
	...
	cmp r5, 0x7
	bls _080FE8F8
	ldr r0, _080FE958 @ =gUnknownText_Exit
	movs r1, 0x1
	movs r2, 0x11
	bl MenuPrint
	pop {r4,r5}
...
sub_80FE5AC: @ 80FE95C
	...
	adds r0, r4, 0
	bl sub_80FE528
	ldr r0, _080FE9A8 @ =gUnknown_020388F6
	ldrb r0, [r0]
	str r0, [sp]
	movs r0, 0xD
	str r0, [sp, 0x4]
	...
	movs r3, 0x9
	bl InitMenu
	ldr r1, _080FE9AC @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080FE9B0 @ =sub_80FE604
	str r1, [r0]
	add sp, 0x8
	pop {r4}
	pop {r0}
...
_080FEA06:
	...
	bl PlaySE
	bl GetMenuCursorPos
	ldr r4, _080FEA70 @ =gUnknown_020388F6
	strb r0, [r4]
	lsls r0, 24
	lsrs r0, 24
	cmp r0, 0x8
	...
	ldrb r0, [r4]
	bl sub_8134194
	ldr r1, _080FEA74 @ =gUnknown_020388D5
	strb r0, [r1]
	lsls r0, 24
	cmp r0, 0
	beq _080FEA8C
	ldrb r0, [r4]
	bl sub_8134104
	ldr r2, _080FEA78 @ =gUnknown_020388D0
	ldr r1, _080FEA7C @ =gDecorationInventories
	ldrb r0, [r4]
	lsls r0, 3
	adds r0, r1
	ldr r0, [r0]
	...
	bl sub_80FEF50
	bl sub_80F944C
	ldr r0, _080FEA80 @ =gUnknown_020388F7
	movs r1, 0x8
	bl sub_80F9480
	bl LoadScrollIndicatorPalette
	ldr r1, _080FEA84 @ =gTasks
	lsls r0, r5, 2
	adds r0, r5
	lsls r0, 3
	adds r0, r1
	ldr r1, _080FEA88 @ =sub_80FE868
	str r1, [r0]
	b _080FEAD0
	.align 2, 0
...
_080FEA8C:
	...
	movs r3, 0x13
	bl MenuZeroFillWindowRect
	ldr r1, _080FEAAC @ =gSecretBaseText_NoDecors
	ldr r2, _080FEAB0 @ =sub_80FE418
	adds r0, r5, 0
	movs r3, 0
...
sub_80FE758: @ 80FEB08
	...
	bl sub_80FE394
	ldr r0, _080FEB48 @ =Task_DecorationPCProcessMenuInput
	str r0, [r5]
	b _080FEB52
	.align 2, 0
...
sub_80FE7A8: @ 80FEB58
	...
	movs r2, 0x3
	strh r2, [r1, 0x1E]
	ldr r1, _080FEB80 @ =gUnknown_020388F6
	strb r3, [r1]
	bl sub_80FE5AC
	pop {r0}
	bx r0
...
sub_80FE7D4: @ 80FEB84
	push {lr}
	lsls r1, 24
	ldr r2, _080FEB98 @ =gUnknown_083EC5E4
	lsrs r1, 22
	adds r1, r2
	ldr r1, [r1]
	bl StringCopy
...
sub_80FE7EC: @ 80FEB9C
	...
	adds r0, r4, 0
	bl sub_80FEC94
	ldr r0, _080FEC14 @ =gUnknown_020388F6
	ldrb r0, [r0]
	bl sub_80FECB8
	ldr r4, _080FEC18 @ =gUnknown_020388F2
	ldrb r1, [r4]
	ldr r5, _080FEC1C @ =gUnknown_020388F4
	ldrb r0, [r5]
	adds r1, r0
	ldr r0, _080FEC20 @ =gUnknown_020388D5
	ldrb r0, [r0]
	cmp r1, r0
	beq _080FEBE2
	movs r0, 0xF
...
_080FEBE2:
	...
	lsrs r0, 24
	bl sub_80FECE0
	ldr r0, _080FEC24 @ =gUnknown_020388F3
	ldrb r3, [r0]
	adds r3, 0x1
	lsls r3, 24
	lsrs r3, 24
...
sub_80FE868: @ 80FEC28
	...
	adds r0, r4, 0
	bl sub_80FE7EC
	ldr r1, _080FEC4C @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080FEC50 @ =sub_80FE948
	str r1, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
sub_80FE894: @ 80FEC54
	...
	movs r0, 0
	mov r10, r0
	ldr r6, _080FECE0 @ =gUnknown_020388F2
	ldrb r1, [r6]
	ldr r4, _080FECE4 @ =gUnknown_020388F4
	ldrb r0, [r4]
	adds r1, r0
	ldr r2, _080FECE8 @ =gUnknown_020388D5
	mov r9, r2
	ldrb r0, [r2]
	cmp r1, r0
	bne _080FEC88
...
sub_80FE948: @ 80FED08
	...
	b _080FEE6C
_080FED1C:
	ldr r0, _080FED44 @ =gMain
	ldrh r1, [r0, 0x30]
	movs r0, 0xF0
	ands r0, r1
	cmp r0, 0x40
	bne _080FED60
	ldr r0, _080FED48 @ =gUnknown_020388F2
	ldrb r0, [r0]
	cmp r0, 0
	beq _080FED4C
	movs r1, 0x1
...
_080FED4C:
	ldr r0, _080FED84 @ =gUnknown_020388F4
	ldrb r0, [r0]
	cmp r0, 0
	beq _080FED60
	movs r2, 0x1
	...
	bl sub_80FE894
_080FED60:
	ldr r0, _080FED88 @ =gMain
	ldrh r1, [r0, 0x30]
	movs r0, 0xF0
	ands r0, r1
	cmp r0, 0x80
	bne _080FEDAE
	ldr r2, _080FED8C @ =gUnknown_020388F2
	ldr r1, _080FED90 @ =gUnknown_020388F3
	ldrb r0, [r2]
	ldrb r1, [r1]
	cmp r0, r1
	beq _080FED94
...
_080FED94:
	ldr r0, _080FEDF8 @ =gUnknown_020388F4
	ldrb r0, [r0]
	ldrb r1, [r2]
	adds r0, r1
	ldr r1, _080FEDFC @ =gUnknown_020388D5
	ldrb r1, [r1]
	cmp r0, r1
	beq _080FEDAE
	adds r0, r4, 0
...
_080FEDAE:
	...
	movs r0, 0x5
	bl PlaySE
	ldr r2, _080FEE04 @ =gUnknown_020388F5
	ldr r1, _080FEE08 @ =gUnknown_020388F2
	ldr r0, _080FEDF8 @ =gUnknown_020388F4
	ldrb r0, [r0]
	ldrb r1, [r1]
	adds r0, r1
	...
	cmp r0, r1
	bne _080FEE14
	ldr r1, _080FEE0C @ =gUnknown_083EC634
	ldr r2, _080FEE10 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r2
...
_080FEE14:
	ldr r2, _080FEE34 @ =gUnknown_083EC634
	ldr r1, _080FEE38 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
...
_080FEE3C:
	...
	movs r0, 0x5
	bl PlaySE
	ldr r1, _080FEE74 @ =gUnknown_083EC634
	ldr r2, _080FEE78 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r2
...
sub_80FEABC: @ 80FEE7C
	...
	lsrs r0, 24
	mov r8, r0
	ldr r4, _080FEF18 @ =gUnknown_020388F4
	ldrb r0, [r4]
	cmp r0, 0
	bne _080FEE9E
	movs r0, 0
...
_080FEEA8:
	ldr r5, _080FEF18 @ =gUnknown_020388F4
	ldrb r0, [r5]
	adds r0, 0x7
	ldr r4, _080FEF1C @ =gUnknown_020388D5
	ldrb r1, [r4]
	cmp r0, r1
	bne _080FEEBC
	movs r0, 0x1
...
_080FEEDE:
	...
	adds r0, r2
	lsrs r6, r0, 24
	ldr r0, _080FEF20 @ =gUnknown_020388F7
	adds r1, r0
	ldrb r0, [r1]
	cmp r0, 0
	beq _080FEEFC
	...
	bl sub_80F94F8
_080FEEFC:
	ldr r0, _080FEF1C @ =gUnknown_020388D5
	ldrb r0, [r0]
	cmp r4, r0
	bne _080FEF28
	lsls r2, r6, 3
	movs r0, 0x1
	str r0, [sp]
	ldr r0, _080FEF24 @ =gUnknownText_Exit
	movs r1, 0x8
	movs r3, 0x68
	bl sub_8072A18
	b _080FF03E
...
_080FEF28:
	ldr r0, _080FEF80 @ =gUnknown_020388D0
	ldr r1, [r0]
	adds r2, r1, r4
	ldrb r1, [r2]
	mov r12, r0
	...
	b _080FF030
_080FEF3A:
	ldr r0, _080FEF84 @ =0x0201f000
	ldrb r5, [r0, 0x9]
	cmp r5, 0x1
	bne _080FEF9C
	ldr r0, _080FEF88 @ =gUnknown_020388F6
	ldrb r0, [r0]
	cmp r0, 0x6
	beq _080FEF9C
	cmp r0, 0x7
	beq _080FEF9C
	ldr r0, _080FEF8C @ =gTasks
	mov r3, r8
	lsls r1, r3, 2
	add r1, r8
	lsls r1, 3
	...
	ldrb r1, [r2]
	lsls r1, 5
	ldr r0, _080FEF90 @ =0x083f7bf1
	adds r1, r0
	ldr r0, _080FEF94 @ =gStringVar1
	bl StringCopy
	lsls r2, r6, 3
	str r5, [sp]
	ldr r0, _080FEF98 @ =gUnknown_083EC65A
	movs r1, 0x8
	movs r3, 0x68
	bl sub_8072A18
	b _080FEFB8
...
_080FEFCA:
	cmp r1, 0xF
	bhi _080FEFF4
	ldr r0, _080FEFF8 @ =gUnknown_020388D6
	adds r0, r1, r0
	ldrb r0, [r0]
	subs r0, 0x1
	cmp r0, r4
	...
	ldrb r3, [r7]
	subs r3, r4, r3
	ldr r1, _080FEFFC @ =gUnknown_020388F7
	adds r1, r3, r1
	lsls r3, 20
	movs r2, 0xC0
	lsls r2, 13
...
_080FF006:
	cmp r1, 0xB
	bhi _080FF030
	ldr r0, _080FF04C @ =gUnknown_020388E6
	adds r0, r1, r0
	ldrb r0, [r0]
	subs r0, 0x1
	cmp r0, r4
	...
	ldrb r3, [r7]
	subs r3, r4, r3
	ldr r1, _080FF050 @ =gUnknown_020388F7
	adds r1, r3, r1
	lsls r3, 20
	movs r0, 0xC0
	lsls r0, 13
...
sub_80FECE0: @ 80FF0A0
	...
	lsls r0, 24
	lsrs r2, r0, 24
	ldr r0, _080FF0D8 @ =gUnknown_020388D5
	ldrb r0, [r0]
	cmp r2, r0
	beq _080FF0E4
	ldr r1, _080FF0DC @ =gDecorations
	ldr r0, _080FF0E0 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r2
	ldrb r0, [r0]
	lsls r0, 5
...
sub_80FED3C: @ 80FF10C
	...
	lsrs r4, 24
	bl LoadScrollIndicatorPalette
	ldr r1, _080FF12C @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080FF130 @ =sub_80FE868
	str r1, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
sub_80FED64: @ 80FF134
	...
	lsrs r2, r0, 24
	movs r1, 0
	ldr r3, _080FF14C @ =gUnknown_020388D6
_080FF13E:
	adds r0, r1, r3
	ldrb r0, [r0]
	cmp r0, r2
...
sub_80FED90: @ 80FF160
	...
	movs r6, 0
	movs r3, 0
	ldr r4, _080FF200 @ =gUnknown_020388D6
	movs r1, 0
	ldr r2, _080FF204 @ =gUnknown_020388E6
_080FF174:
	adds r0, r3, r4
	strb r1, [r0]
	cmp r3, 0xB
...
_080FF180:
	...
	bls _080FF174
	movs r3, 0
	ldr r0, _080FF208 @ =0x0202714e
	mov r10, r0
	ldr r1, _080FF20C @ =gDecorationInventories
	mov r9, r1
	ldr r2, _080FF210 @ =gUnknown_020388F6
	mov r8, r2
_080FF198:
	mov r1, r10
	adds r0, r3, r1
	...
	adds r0, r3
	mov r12, r0
	ldr r7, _080FF200 @ =gUnknown_020388D6
_080FF1BA:
	ldr r0, _080FF214 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r1
	ldrb r0, [r0]
	adds r4, r1, 0x1
	...
	cmp r0, r4
	beq _080FF1EE
	ldr r5, _080FF200 @ =gUnknown_020388D6
	adds r2, r4, 0
_080FF1DC:
	adds r0, r1, 0x1
	lsls r0, 16
...
_080FF22A:
	...
	movs r6, 0
	movs r3, 0
	ldr r0, _080FF2B4 @ =gDecorationInventories
	mov r8, r0
_080FF23C:
	ldr r0, _080FF2B8 @ =gSaveBlock1
	ldr r1, _080FF2BC @ =0x00002688
	adds r0, r1
	adds r2, r3, r0
	ldrb r0, [r2]
	adds r7, r3, 0x1
	...
	beq _080FF2DE
	movs r1, 0
	ldr r0, _080FF2C0 @ =gUnknown_020388F6
	ldrb r0, [r0]
	lsls r0, 3
	add r0, r8
	ldrb r0, [r0, 0x4]
	...
	adds r5, r2, 0
_080FF25E:
	ldr r0, _080FF2C4 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r1
	ldrb r0, [r0]
	adds r4, r1, 0x1
	...
	cmp r1, r6
	bcs _080FF2A0
	ldr r2, _080FF2C8 @ =gUnknown_020388E6
	ldrb r0, [r2]
	cmp r0, r4
	beq _080FF2A0
	adds r3, r2, 0
...
_080FF2A0:
	cmp r1, r6
	bne _080FF2CC
	ldr r0, _080FF2C8 @ =gUnknown_020388E6
	adds r0, r6, r0
	strb r4, [r0]
	adds r0, r6, 0x1
	lsls r0, 16
...
_080FF2CC:
	lsls r0, r4, 16
	lsrs r1, r0, 16
	ldr r0, _080FF2F4 @ =gUnknown_020388F6
	ldrb r0, [r0]
	lsls r0, 3
	add r0, r8
	ldrb r0, [r0, 0x4]
...
sub_80FEF28: @ 80FF2F8
	push {lr}
	ldr r0, _080FF308 @ =gUnknown_020388D5
	ldrb r1, [r0]
	cmp r1, 0x7
	bhi _080FF310
	ldr r0, _080FF30C @ =gUnknown_020388F3
	strb r1, [r0]
	b _080FF316
	.align 2, 0
...
_080FF310:
	ldr r1, _080FF31C @ =gUnknown_020388F3
	movs r0, 0x7
	strb r0, [r1]
_080FF316:
	pop {r0}
...
sub_80FEF50: @ 80FF320
	...
	bl sub_80FED90
	bl sub_80FEF28
	ldr r0, _080FF33C @ =gUnknown_020388F2
	movs r1, 0
	strb r1, [r0]
	ldr r0, _080FF340 @ =gUnknown_020388F4
	strb r1, [r0]
	pop {r0}
	bx r0
	.align 2, 0
...
sub_80FEF74: @ 80FF344
	push {lr}
	ldr r0, _080FF370 @ =gUnknown_020388F7
	movs r1, 0x8
	bl sub_80F9520
	movs r0, 0
	bl DestroyVerticalScrollIndicator
...
sub_80FEFA4: @ 80FF374
	push {r4,lr}
	movs r2, 0
	ldr r0, _080FF3A0 @ =gUnknown_020388F4
	ldrb r0, [r0]
	ldr r1, _080FF3A4 @ =gUnknown_020388F2
	ldrb r1, [r1]
	adds r0, r1
	adds r1, r0, 0x1
	ldr r4, _080FF3A8 @ =gUnknown_020388D6
	ldr r3, _080FF3AC @ =gUnknown_020388E6
_080FF388:
	adds r0, r2, r4
	ldrb r0, [r0]
	cmp r0, r1
...
_080FF3DE:
	bl LoadScrollIndicatorPalette
	ldr r0, _080FF3FC @ =gTasks
	lsls r1, r4, 2
	adds r1, r4
	lsls r1, 3
	adds r1, r0
	ldr r0, _080FF400 @ =sub_80FE868
	str r0, [r1]
_080FF3F0:
	pop {r4}
	pop {r0}
...
sub_80FF058: @ 80FF428
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r0, _080FF45C @ =gUnknown_020388F7
	movs r1, 0x8
	bl sub_80F9520
	movs r0, 0
	bl DestroyVerticalScrollIndicator
	...
	ldr r1, _080FF460 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080FF464 @ =sub_80FF034
	str r1, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
sub_80FF098: @ 80FF468
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r1, _080FF4A4 @ =gUnknown_020388D5
	ldrb r0, [r1]
	subs r0, 0x1
	strb r0, [r1]
	ldr r3, _080FF4A8 @ =gUnknown_020388F4
	ldrb r2, [r3]
	adds r0, r2, 0x7
	ldrb r1, [r1]
	cmp r0, r1
	...
	strb r0, [r3]
_080FF48A:
	ldr r0, _080FF4AC @ =gUnknown_020388F6
	ldrb r0, [r0]
	bl sub_8134104
	adds r0, r4, 0
	bl sub_80FED90
...
sub_80FF0E0: @ 80FF4B0
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r3, _080FF4DC @ =gTasks
	lsls r2, r0, 2
	adds r2, r0
	lsls r2, 3
	adds r4, r2, r3
	ldr r1, _080FF4E0 @ =gSaveBlock1
	ldrh r0, [r1]
	strh r0, [r4, 0xE]
	ldrh r0, [r1, 0x2]
	strh r0, [r4, 0x10]
...
sub_80FF160: @ 80FF530
	...
	cmp r0, 0
	bne _080FF558
	ldr r1, _080FF550 @ =gSecretBaseText_NoDecors
	ldr r2, _080FF554 @ =sub_80FE428
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	b _080FF572
...
_080FF558:
	...
	movs r1, 0
	strh r1, [r0, 0x1E]
	ldr r0, _080FF57C @ =gUnknown_020388F6
	strb r2, [r0]
	adds r0, r4, 0
	bl sub_80FE5AC
_080FF572:
...
sub_80FF1B0: @ 80FF580
	...
	lsls r1, 24
	lsrs r1, 24
	ldr r0, _080FF5A0 @ =0x0000ffff
	cmp r2, 0x22
	beq _080FF5A8
	cmp r2, 0x26
	bne _080FF5B2
	ldr r0, _080FF5A4 @ =gUnknown_083EC97C
	adds r0, r1, r0
	ldrb r0, [r0]
	lsls r0, 28
	lsrs r0, 16
...
_080FF5A8:
	ldr r0, _080FF5B8 @ =gUnknown_083EC984
	adds r0, r1, r0
	ldrb r0, [r0]
	lsls r0, 28
	lsrs r0, 16
...
_080FF61C:
	...
	lsls r4, 5
	str r4, [sp, 0x18]
	ldr r0, _080FF684 @ =0x083f7c0c
	adds r0, r4, r0
	str r0, [sp, 0x1C]
	ldr r0, _080FF688 @ =gDecorations
	adds r0, r4, r0
	str r0, [sp, 0x24]
	ldr r3, [sp, 0x8]
	adds r1, r2, 0
...
sub_80FF474: @ 80FF844
	...
	sub sp, 0x4
	movs r6, 0
	ldr r0, _080FF91C @ =gMapHeader
	mov r8, r0
	ldr r1, _080FF920 @ =gSpecialVar_0x8005
	mov r9, r1
	ldr r2, _080FF924 @ =gSpecialVar_0x8006
	mov r10, r2
	ldr r7, _080FF928 @ =gSaveBlock1
_080FF860:
	adds r5, r6, 0
	adds r5, 0xAE
	adds r4, r5, 0
...
_080FF8B0:
	...
	lsls r4, 3
	adds r1, r4, r1
	ldr r2, _080FF92C @ =0x00003f20
	adds r0, r2, 0
	ldrb r1, [r1, 0x1]
	adds r0, r1
	ldr r1, _080FF930 @ =gUnknown_02038900
	ldr r1, [r1]
	ldr r1, [r1, 0x1C]
	ldrh r1, [r1]
	bl VarSet
	...
	mov r6, r9
	strh r0, [r6]
	ldr r1, _080FF934 @ =gUnknown_020391A4
	ldrh r1, [r1]
	mov r2, r10
	strh r1, [r2]
	ldr r1, _080FF938 @ =gUnknown_020391A6
	ldrh r1, [r1]
	ldr r4, _080FF93C @ =gSpecialVar_0x8007
	strh r1, [r4]
	ldrb r1, [r7, 0x5]
	ldrb r2, [r7, 0x4]
	bl show_sprite
...
sub_80FF5BC: @ 80FF98C
	...
	lsls r0, 24
	lsrs r5, r0, 24
	ldr r0, _080FF9B4 @ =0x0201f000
	ldrb r0, [r0, 0x9]
	cmp r0, 0x1
	bne _080FF9C0
	ldr r0, _080FF9B8 @ =gUnknown_020388F6
	ldrb r0, [r0]
	cmp r0, 0x6
	beq _080FF9C0
	cmp r0, 0x7
	...
	bl sub_80FEF74
	bl sub_80FED1C
	ldr r1, _080FF9BC @ =gSecretBaseText_DecorCantPlace
	b _080FFA3E
	.align 2, 0
...
_080FF9FC:
	bl sub_80FEF74
	bl sub_80FED1C
	ldr r0, _080FFA24 @ =gStringVar1
	ldr r4, _080FFA28 @ =0x0201f000
	ldrb r1, [r4, 0x8]
	movs r2, 0x1
	movs r3, 0x2
	...
	cmp r0, 0
	bne _080FFA34
	ldr r0, _080FFA2C @ =gStringVar4
	ldr r1, _080FFA30 @ =gSecretBaseText_NoMoreDecor
...
_080FFA34:
	ldr r0, _080FFA4C @ =gStringVar4
	ldr r1, _080FFA50 @ =gSecretBaseText_NoMoreDecor2
	bl StringExpandPlaceholders
_080FFA3C:
	ldr r1, _080FFA4C @ =gStringVar4
_080FFA3E:
	ldr r2, _080FFA54 @ =sub_80FEFF4
	adds r0, r5, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	b _080FFA6C
...
_080FFA58:
	bl sub_80FEF74
	bl sub_80FED1C
	ldr r1, _080FFA74 @ =gSecretBaseText_InUseAlready
	ldr r2, _080FFA78 @ =sub_80FEFF4
	adds r0, r5, 0
	movs r3, 0
	bl DisplayItemMessageOnField
_080FFA6C:
...
_080FFAAA:
	...
	movs r0, 0x1
	bl DestroyVerticalScrollIndicator
	ldr r0, _080FFAE0 @ =gUnknown_020388F7
	movs r1, 0x8
	bl sub_80F9520
	bl BuyMenuFreeMemory
	movs r0, 0x1
...
_080FFAE4:
	ldr r4, _080FFB24 @ =gPaletteFade
	ldrb r0, [r4, 0x8]
	movs r1, 0x80
	orrs r0, r1
	strb r0, [r4, 0x8]
	ldr r5, _080FFB28 @ =gUnknown_02038900
	ldr r0, _080FFB2C @ =gUnknown_020388F5
	ldrb r1, [r0]
	ldr r0, _080FFB30 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r1
	ldrb r1, [r0]
	adds r0, r5, 0
...
AddDecorationIconObjectFromFieldObject: @ 80FFB50
	...
	adds r0, r5, 0
	bl sub_8100874
	ldr r1, _080FFBE4 @ =0x00000884
	adds r0, r5, r1
	ldr r1, _080FFBE8 @ =gMapHeader
	ldr r1, [r1]
	ldr r2, [r1, 0x14]
	ldr r1, [r5]
	ldr r1, [r1, 0x1C]
	...
	lsrs r1, 12
	bl sub_810070C
	ldr r0, _080FFBEC @ =gUnknown_083EC954
	bl LoadSpritePalette
	ldr r3, _080FFBF0 @ =gUnknown_020391A8
	ldr r2, _080FFBF4 @ =gSprites
	ldr r4, _080FFBF8 @ =gUnknown_03004880
	ldr r1, [r4, 0x4]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	ldrh r0, [r0, 0x2E]
	strb r0, [r3]
	ldr r0, _080FFBFC @ =gSpriteTemplate_83EC93C
	ldr r3, _080FFC00 @ =gUnknown_083EC900
	ldr r1, [r5]
	ldrb r2, [r1, 0x12]
	lsls r2, 2
	adds r2, r3
...
_080FFC04:
	ldr r2, _080FFC58 @ =gUnknown_020391A8
	ldr r6, _080FFC5C @ =gSprites
	ldr r5, _080FFC60 @ =gUnknown_03004880
	ldr r1, [r5, 0x4]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	ldr r0, [r4, 0x1C]
	ldrh r0, [r0]
	ldr r1, _080FFC64 @ =sub_81009A8
	ldr r2, _080FFC68 @ =gUnknown_083EC900
	ldrb r3, [r4, 0x12]
	lsls r3, 2
	adds r3, r2
	ldrb r2, [r3, 0x2]
...
SetUpPlacingDecorationPlayerAvatar: @ 80FFC6C
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r3, _080FFCC0 @ =gTasks
	lsls r2, r0, 2
	adds r2, r0
	lsls r2, 3
	adds r2, r3
	ldrb r2, [r2, 0x12]
	ldr r3, _080FFCC4 @ =gUnknown_083EC900
	ldr r0, [r1]
	ldrb r4, [r0, 0x12]
	lsls r1, r4, 2
	adds r1, r3
...
_080FFCA6:
	...
	lsrs r2, r0, 24
_080FFCAE:
	ldr r0, _080FFCC8 @ =gSaveBlock2
	ldrb r0, [r0, 0x8]
	cmp r0, 0
	bne _080FFCD0
	ldr r1, _080FFCCC @ =SpriteCallbackDummy
	str r0, [sp]
	movs r0, 0xC1
	b _080FFCD8
	.align 2, 0
...
_080FFCD0:
	ldr r1, _080FFD1C @ =SpriteCallbackDummy
	movs r0, 0
	str r0, [sp]
	movs r0, 0xC2
_080FFCD8:
	movs r3, 0x48
	bl AddPseudoFieldObject
	ldr r1, _080FFD20 @ =gUnknown_020391A9
	strb r0, [r1]
	ldr r3, _080FFD24 @ =gSprites
	ldr r0, _080FFD20 @ =gUnknown_020391A9
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	orrs r1, r2
	strb r1, [r0, 0x5]
	ldr r4, _080FFD28 @ =gUnknown_020391A8
	ldrb r1, [r4]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	adds r0, r3
	bl DestroySprite
	ldr r0, _080FFD2C @ =gUnknown_03004880
	ldr r0, [r0, 0x4]
	strb r0, [r4]
	add sp, 0x4
	pop {r4}
...
sub_80FF960: @ 80FFD30
	...
	lsls r0, 24
	lsrs r3, r0, 24
	ldr r2, _080FFD5C @ =gDecorations
	ldr r0, _080FFD60 @ =gUnknown_020388F5
	ldrb r1, [r0]
	ldr r0, _080FFD64 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r1
	ldrb r0, [r0]
	lsls r0, 5
...
sub_80FFAB0: @ 80FFE80
	...
	movs r1, 0
	strh r1, [r0, 0x1C]
	ldr r3, _080FFECC @ =gSprites
	ldr r0, _080FFED0 @ =gUnknown_020391A8
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	movs r2, 0x1
	strh r2, [r0, 0x3C]
	ldr r0, _080FFED4 @ =gUnknown_020391A9
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
...
sub_80FFB08: @ 80FFED8
	...
	movs r1, 0
	strh r1, [r0, 0x1C]
	ldr r3, _080FFF28 @ =gSprites
	ldr r0, _080FFF2C @ =gUnknown_020391A8
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	movs r2, 0x1
	strh r2, [r0, 0x3C]
	ldr r0, _080FFF30 @ =gUnknown_020391A9
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	strh r2, [r0, 0x3C]
	bl sub_810045C
	ldr r1, _080FFF34 @ =gSecretBaseText_CancelDecorating
	ldr r2, _080FFF38 @ =sub_8100248
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	pop {r4}
...
sub_8100038: @ 8100408
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r0, _0810043C @ =gUnknown_020388F5
	ldrb r1, [r0]
	ldr r0, _08100440 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r1
	ldrb r1, [r0]
	lsls r1, 5
	ldr r0, _08100444 @ =gDecorations
	adds r1, r0
	adds r0, r4, 0
	bl sub_80FFC24
	lsls r0, 24
	...
	cmp r0, 0x1
	bne _08100450
	ldr r1, _08100448 @ =gSecretBaseText_PlaceItHere
	ldr r2, _0810044C @ =sub_81000A0
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	b _08100462
...
_08100450:
	movs r0, 0x20
	bl PlaySE
	ldr r1, _08100468 @ =gSecretBaseText_CantBePlacedHere
	ldr r2, _0810046C @ =sub_81006A8
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
_08100462:
...
sub_81000A0: @ 8100470
	...
	movs r2, 0x1
	bl DisplayYesNoMenu
	ldr r1, _08100490 @ =gUnknown_083EC95C
	adds r0, r4, 0
	bl sub_80F914C
	pop {r4}
	pop {r0}
...
sub_81000C4: @ 8100494
	...
	adds r0, r4, 0
	bl sub_8100174
	ldr r2, _081004DC @ =gDecorations
	ldr r0, _081004E0 @ =gUnknown_020388F5
	ldrb r1, [r0]
	ldr r0, _081004E4 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r1
	ldrb r3, [r0]
	lsls r0, r3, 5
...
_081004EC:
	ldr r2, _0810052C @ =gUnknown_020391A4
	ldr r0, _08100530 @ =gTasks
	lsls r1, r4, 2
	adds r1, r4
	lsls r1, 3
	adds r1, r0
	...
	subs r0, 0x7
	strh r0, [r2]
	ldr r2, _08100534 @ =gUnknown_020391A6
	ldrh r0, [r1, 0xA]
	subs r0, 0x7
	strh r0, [r2]
	ldr r0, _08100538 @ =gUnknown_081A2F7B
	bl ScriptContext1_SetupScript
_0810050C:
	ldr r2, _0810053C @ =gSprites
	ldr r0, _08100540 @ =gUnknown_020391A8
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
...
_0810056A:
	...
	bne _081005D4
	movs r3, 0
	ldr r0, _08100584 @ =gUnknown_020388D6
	ldrb r1, [r0]
	adds r2, r0, 0
	cmp r1, 0
	bne _081005C0
...
_08100588:
	ldr r0, _081005B4 @ =gUnknown_020388F5
	ldrb r1, [r0]
	ldr r0, _081005B8 @ =gUnknown_020388D0
	ldr r0, [r0]
	adds r0, r1
	ldrb r0, [r0]
	strb r0, [r2]
...
_081005D4:
	movs r3, 0
	ldr r0, _081005EC @ =gUnknown_020388E6
	ldrb r1, [r0]
	adds r2, r0, 0
	cmp r1, 0
	bne _081005F4
_081005E0:
	ldr r0, _081005F0 @ =gUnknown_020388F5
	ldrb r0, [r0]
	adds r0, 0x1
	strb r0, [r2]
	b _0810060E
...
_081005F4:
	...
	bne _081005F4
_08100606:
	ldr r0, _08100614 @ =gUnknown_020388F5
	ldrb r0, [r0]
	adds r0, 0x1
	strb r0, [r1]
_0810060E:
...
sub_8100248: @ 8100618
	...
	movs r2, 0x1
	bl DisplayYesNoMenu
	ldr r1, _08100638 @ =gUnknown_083EC964
	adds r0, r4, 0
	bl sub_80F914C
	pop {r4}
	pop {r0}
...
sub_810028C: @ 810065C
	...
	movs r1, 0
	strh r1, [r0, 0xC]
	ldr r1, _08100688 @ =c1_overworld_prev_quest
	str r1, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
_081006D0:
	bl sub_81016F4
	ldr r0, _081006F4 @ =0x00000bb8
	bl FreeSpritePaletteByTag
	ldr r1, _081006F8 @ =gUnknown_0300485C
	ldr r0, _081006FC @ =sub_8100364
	str r0, [r1]
	ldr r0, _08100700 @ =c2_exit_to_overworld_2_switch
	bl SetMainCallback2
	adds r0, r4, 0
	bl DestroyTask
_081006EC:
...
sub_8100334: @ 8100704
	...
	cmp r0, 0x1
	bne _08100724
	ldr r0, _0810072C @ =gTasks
	lsls r1, r4, 2
	adds r1, r4
	lsls r1, 3
	adds r1, r0
	ldr r0, _08100730 @ =sub_80FE948
	str r0, [r1]
_08100724:
	pop {r4}
	pop {r0}
...
sub_810038C: @ 810075C
	...
	adds r1, r0
	lsls r1, 3
	ldr r0, _0810078C @ =0x03004b38
	adds r2, r1, r0
	ldr r0, _08100790 @ =gUnknown_020391AA
	ldrb r1, [r0]
	adds r3, r0, 0
	cmp r1, 0x1
	bne _08100794
...
sub_810045C: @ 810082C
	push {r4,lr}
	ldr r1, _08100858 @ =gUnknown_020391AA
	movs r0, 0
	strb r0, [r1]
	ldr r4, _0810085C @ =gSprites
	ldr r3, _08100860 @ =gUnknown_020391A8
	ldrb r1, [r3]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
...
sub_8100494: @ 8100864
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r5, _081008A0 @ =gSprites
	ldr r3, _081008A4 @ =gUnknown_020391A8
	ldrb r1, [r3]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
...
_08100882:
	...
	cmp r0, 0x1
	bne _081008B0
	ldr r0, _081008AC @ =gUnknown_083EC96C
	movs r3, 0x20
	ldrsh r1, [r2, r3]
	lsls r1, 3
	b _081008BE
...
_081008B0:
	cmp r0, 0x2
	bne _081008D0
	ldr r0, _081008CC @ =gUnknown_083EC96C
	movs r3, 0x20
	ldrsh r1, [r2, r3]
	lsls r1, 3
	adds r0, 0x4
...
_081008D0:
	...
	cmp r0, 0x40
	bne _08100904
	ldr r1, _08100A18 @ =gUnknown_020391AA
	movs r0, 0x1
	strb r0, [r1]
	ldrb r1, [r3]
	lsls r0, r1, 4
...
_081009AA:
	bl sub_810045C
_081009AE:
	ldr r0, _08100A18 @ =gUnknown_020391AA
	ldrb r0, [r0]
	cmp r0, 0
	beq _081009DC
	ldr r3, _08100A20 @ =gSprites
	ldr r2, _08100A24 @ =gUnknown_020391A8
	ldrb r1, [r2]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
...
sub_810065C: @ 8100A2C
	...
	movs r3, 0x13
	bl MenuZeroFillWindowRect
	ldr r2, _08100A68 @ =gSprites
	ldr r0, _08100A6C @ =gUnknown_020391A8
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	movs r2, 0
	strh r2, [r0, 0x3C]
	ldr r1, _08100A70 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	strh r2, [r0, 0x1C]
	ldr r1, _08100A74 @ =sub_8100494
	str r1, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
sub_8100740: @ 8100B10
	...
	cmp r2, 0
	beq _08100B24
	ldr r0, _08100B54 @ =0x000003ff
	ands r2, r0
_08100B24:
	movs r5, 0
	ldr r0, _08100B58 @ =gMapHeader
	ldr r6, [r0]
	lsls r4, r2, 5
_08100B2C:
	mov r0, sp
...
sub_81008BC: @ 8100C8C
	...
	ldrb r0, [r0, 0x12]
	movs r6, 0
	ldr r1, _08100CFC @ =gUnknown_083EC860
	lsls r5, r0, 4
	adds r0, r5, r1
	ldrb r0, [r0, 0xC]
	cmp r6, r0
...
sub_8100930: @ 8100D00
	push {r4,r5,lr}
	lsls r0, 24
	ldr r3, _08100D68 @ =gUnknown_020391AC
	movs r1, 0
	strb r1, [r3]
	ldrb r2, [r3, 0x1]
	subs r1, 0x4
	...
	ands r1, r2
	strb r1, [r3, 0x1]
	ldr r1, _08100D6C @ =gUnknown_083EC900
	lsrs r0, 22
	adds r0, r1
	ldrb r1, [r0]
	movs r5, 0x3F
...
_08100E14:
	ldr r1, _08100E28 @ =gSecretBaseText_NoDecorInUse
	ldr r2, _08100E2C @ =sub_80FE428
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
_08100E20:
...
sub_8100A7C: @ 8100E4C
	push {r4-r6,lr}
	ldr r6, _08100E6C @ =gSpecialVar_0x8005
	movs r0, 0
	strh r0, [r6]
	ldr r2, _08100E70 @ =gScriptResult
	strh r0, [r2]
	ldr r4, _08100E74 @ =gSpecialVar_0x8004
	ldr r1, _08100E78 @ =gUnknown_02039234
	ldrh r0, [r4]
	ldrb r1, [r1]
	cmp r0, r1
	bne _08100E88
...
_08100E7C:
	ldr r1, _08100E84 @ =gSpecialVar_0x8006
	ldrb r0, [r2]
	strh r0, [r1]
	b _08100EDA
	.align 2, 0
...
_08100E88:
	ldr r3, _08100EE0 @ =gDecorations
	ldr r2, _08100EE4 @ =0x0201f000
	ldr r1, _08100EE8 @ =gUnknown_020391B4
	ldrh r0, [r4]
	lsls r0, 3
	adds r4, r0, r1
	ldrb r1, [r4]
...
sub_8100B20: @ 8100EF0
	...
	adds r3, r0, 0
	ldr r5, [r3, 0x4]
	ldr r0, _08100F20 @ =gSpecialVar_0x8004
	ldrh r4, [r0]
	ldr r6, _08100F24 @ =gSpecialVar_0x8005
_08100F08:
	lsls r0, r2, 1
	adds r0, r2
	lsls r0, 3
...
_08100F4C:
	lsls r3, r7, 3
	ldr r0, _08100FB0 @ =gUnknown_020391B4
	adds r4, r3, r0
	ldrb r1, [r4]
	ldr r2, _08100FB4 @ =0x0201f000
	ldr r0, [r2]
	adds r0, r1
	ldrb r6, [r0]
	lsls r0, r6, 5
	ldr r5, _08100FB8 @ =gDecorations
	adds r0, r5
	ldrb r2, [r0, 0x11]
	ldr r5, _08100FB4 @ =0x0201f000
	ldr r0, [r5, 0x4]
	adds r0, r1
	ldrb r0, [r0]
	lsrs r1, r0, 4
...
_08100FA0:
	movs r6, 0
	ldr r1, _08100FB0 @ =gUnknown_020391B4
	adds r2, r5, 0
	adds r0, r5, r1
	adds r3, r7, 0x1
	str r3, [sp]
...
_08100FBC:
	...
	cmp r4, r0
	bcs _08101012
	ldr r0, _0810104C @ =gUnknown_020391B4
	adds r0, r5
	mov r8, r0
	subs r1, r6, 0x7
	str r1, [sp, 0x8]
...
_08101012:
	...
	lsls r0, r1, 24
	lsrs r6, r0, 24
	ldr r1, _0810104C @ =gUnknown_020391B4
	adds r2, r5, 0
	adds r0, r5, r1
_0810101E:
	ldrb r0, [r0, 0x2]
	cmp r6, r0
	bcc _08100FBC
	ldr r2, _0810104C @ =gUnknown_020391B4
	adds r0, r5, r2
	ldrb r0, [r0]
	bl sub_8100A60
_0810102E:
	...
	lsrs r7, r0, 24
_08101034:
	ldr r0, _08101054 @ =gUnknown_02039234
	ldrb r0, [r0]
	cmp r7, r0
	bcc _08100F4C
	add sp, 0xC
...
_08101094:
	...
	bne _081010F4
	bl DrawWholeMapView
	ldr r0, _081010C0 @ =gUnknown_081A2F8A
	bl ScriptContext1_SetupScript
	movs r0, 0
	movs r1, 0
	movs r2, 0x1D
...
_081010D8:
	...
	cmp r0, 0x1
	bne _081010F4
	ldr r0, _081010FC @ =0x0000ffff
	strh r0, [r5, 0x22]
	ldr r1, _08101100 @ =gSecretBaseText_DecorReturned
	ldr r2, _08101104 @ =sub_81010F0
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
_081010F4:
...
sub_8100D38: @ 8101108
	...
	lsrs r3, r0, 24
	movs r2, 0
	ldr r0, _08101138 @ =0x0201f000
	adds r4, r0, 0
	ldrb r0, [r4, 0x8]
	cmp r2, r0
	bcs _0810114C
	adds r5, r4, 0
	ldr r1, _0810113C @ =gTasks
	lsls r0, r3, 2
	adds r0, r3
	lsls r0, 3
	adds r1, r0, r1
...
SetUpPuttingAwayDecorationPlayerAvatar: @ 8101154
	...
	movs r3, 0x13
	bl MenuZeroFillWindowRect
	ldr r3, _081011A8 @ =gUnknown_020391A8
	ldr r2, _081011AC @ =gSprites
	ldr r4, _081011B0 @ =gUnknown_03004880
	ldr r1, [r4, 0x4]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	strb r0, [r3]
	bl sub_81016C8
	ldr r0, _081011B4 @ =gSpriteTemplate_83ECA88
	movs r1, 0x78
	movs r2, 0x50
	movs r3, 0
	bl CreateSprite
	...
	lsrs r0, 24
	str r0, [r4, 0x4]
	ldr r0, _081011B8 @ =gSaveBlock2
	ldrb r0, [r0, 0x8]
	cmp r0, 0
	bne _081011C0
	ldr r1, _081011BC @ =SpriteCallbackDummy
	str r0, [sp]
	movs r0, 0xC1
	b _081011C8
	.align 2, 0
...
_081011C0:
	ldr r1, _0810122C @ =SpriteCallbackDummy
	movs r0, 0
	str r0, [sp]
	movs r0, 0xC2
_081011C8:
	...
	movs r3, 0x48
	bl AddPseudoFieldObject
	ldr r1, _08101230 @ =gUnknown_020391A9
	strb r0, [r1]
	ldr r6, _08101234 @ =gSprites
	ldr r0, _08101230 @ =gUnknown_020391A9
	ldrb r0, [r0]
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	...
	orrs r0, r2
	strb r0, [r1, 0x5]
	ldr r5, _08101238 @ =gUnknown_020391A8
	ldrb r1, [r5]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	adds r0, r6
	bl DestroySprite
	ldr r0, _0810123C @ =gUnknown_03004880
	ldr r0, [r0, 0x4]
	strb r0, [r5]
	ldrb r1, [r5]
	lsls r0, r1, 4
...
sub_8100EEC: @ 81012BC
	...
	movs r3, 0x13
	bl MenuZeroFillWindowRect
	ldr r4, _08101340 @ =gSprites
	ldr r3, _08101344 @ =gUnknown_020391A8
	ldrb r1, [r3]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	adds r1, 0x1C
	adds r0, r1
	ldr r1, _08101348 @ =sub_8101698
	str r1, [r0]
	ldr r2, _0810134C @ =gUnknown_020391A9
	ldrb r1, [r2]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	movs r1, 0x48
	strh r1, [r0, 0x22]
	ldr r1, _08101350 @ =gTasks
	lsls r0, r5, 2
	adds r0, r5
	lsls r0, 3
	adds r0, r1
	strh r6, [r0, 0x1C]
	ldr r1, _08101354 @ =sub_8100494
	str r1, [r0]
	pop {r4-r6}
	pop {r0}
	bx r0
...
sub_8100FB4: @ 8101384
	...
	strh r1, [r0, 0x1C]
	bl sub_810045C
	ldr r3, _081013E0 @ =gSprites
	ldr r5, _081013E4 @ =gUnknown_020391A8
	ldrb r1, [r5]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	adds r3, 0x1C
	adds r0, r3
	ldr r1, _081013E8 @ =SpriteCallbackDummy
	str r1, [r0]
	ldr r1, _081013EC @ =gSecretBaseText_StopPuttingAwayDecor
	ldr r2, _081013F0 @ =sub_810156C
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	pop {r4,r5}
...
sub_8101024: @ 81013F4
	...
	adds r0, r5, 0
	bl sub_8101460
	ldr r0, _08101410 @ =gUnknown_02039234
	ldrb r0, [r0]
	cmp r0, 0
	beq _0810141C
	ldr r1, _08101414 @ =gSecretBaseText_ReturnDecor
	ldr r2, _08101418 @ =sub_8101518
	b _08101480
	.align 2, 0
...
_0810141C:
	...
	bne _081014A4
_08101452:
	ldr r3, _08101490 @ =gSprites
	ldr r4, _08101494 @ =gUnknown_020391A8
	ldrb r1, [r4]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	adds r3, 0x1C
	adds r0, r3
	ldr r1, _08101498 @ =SpriteCallbackDummy
	str r1, [r0]
	ldr r1, _0810149C @ =gSecretBaseText_StopPuttingAwayDecor
	ldr r2, _081014A0 @ =sub_810156C
_08101480:
	adds r0, r5, 0
	movs r3, 0
	bl DisplayItemMessageOnField
...
_081014A4:
	ldr r1, _081014B8 @ =gSecretBaseText_NoDecor
	ldr r2, _081014BC @ =sub_81010F0
	adds r0, r5, 0
	movs r3, 0
	bl DisplayItemMessageOnField
_081014B0:
...
sub_8101198: @ 8101568
	...
	lsls r0, 24
	lsls r1, 24
	ldr r5, _081015C0 @ =gSprites
	ldr r6, _081015C4 @ =gUnknown_020391A8
	ldrb r3, [r6]
	lsls r2, r3, 4
	adds r2, r3
	lsls r2, 2
	...
	adds r3, 0x1C
	adds r2, r3
	ldr r3, _081015C8 @ =SpriteCallbackDummy
	str r3, [r2]
	ldr r4, _081015CC @ =gUnknown_020391A9
	ldrb r3, [r4]
	lsls r2, r3, 4
	adds r2, r3
	lsls r2, 2
...
sub_81012A0: @ 8101670
	...
	mov r6, r8
	push {r6,r7}
	ldr r2, _081016DC @ =0x0201f000
	ldr r3, _081016E0 @ =gUnknown_020391B4
	ldr r0, _081016E4 @ =gUnknown_02039234
	ldrb r0, [r0]
	lsls r0, 3
	adds r0, r3
	ldrb r1, [r0]
...
_0810169A:
	...
	mov r2, r8
	adds r1, r0, r2
	ldr r2, _081016EC @ =0x00000c24
	adds r0, r1, r2
	movs r2, 0
	ldrsh r0, [r0, r2]
	cmp r0, r7
	bne _081016F8
	ldr r2, _081016F0 @ =0x00000c26
	adds r0, r1, r2
	movs r2, 0
	ldrsh r0, [r0, r2]
	cmp r0, r6
	bne _081016F8
	ldr r0, _081016F4 @ =0x00000c34
	adds r4, r1, r0
	ldrh r0, [r4]
	bl FlagGet
	lsls r0, 24
...
_0810171A:
	...
	cmp r0, 0x4
	bne _0810176C
	ldr r5, _08101764 @ =gUnknown_020391B4
	adds r0, r2, 0
	adds r1, r5, 0
	bl sub_8101118
	lsls r1, r6, 24
	...
	strb r6, [r5]
	bl sub_81012A0
	ldr r0, _08101768 @ =gUnknown_02039234
	strb r4, [r0]
	movs r0, 0x1
	b _0810177C
	.align 2, 0
...
sub_81013B8: @ 8101788
	...
	mov r8, r3
	movs r4, 0
	ldr r7, _08101820 @ =0x0201f000
	ldrb r0, [r7, 0x8]
	cmp r4, r0
	bcs _0810180E
	adds r6, r7, 0
	ldr r5, _08101824 @ =gUnknown_02039234
_081017BA:
	ldr r0, [r6]
	adds r0, r4
	ldrb r1, [r0]
	...
	cmp r8, r2
	bcc _08101802
	ldr r0, _0810182C @ =gUnknown_020391B4
	ldrb r1, [r5]
	lsls r1, 3
	adds r1, r0
	strb r4, [r1]
...
sub_8101460: @ 8101830
	...
	lsls r0, 24
	lsrs r6, r0, 24
	ldr r4, _08101888 @ =gUnknown_02039234
	movs r0, 0
	strb r0, [r4]
	adds r0, r6, 0
	bl sub_8101340
...
_08101856:
	...
	cmp r1, 0
	beq _08101894
	ldr r4, _08101890 @ =gUnknown_020391B4
	adds r0, r1, 0
	adds r1, r4, 0
	bl sub_8101118
	adds r0, r6, 0
...
_08101894:
	...
	lsls r0, 24
	lsrs r5, r0, 24
	ldr r0, _081018DC @ =0x0201f000
	ldrb r1, [r0, 0x8]
	cmp r5, r1
	bcc _08101856
_081018A2:
	ldr r0, _081018E0 @ =gUnknown_02039234
	ldrb r0, [r0]
	cmp r0, 0
	beq _081018D4
	ldr r0, _081018DC @ =0x0201f000
	ldr r2, _081018E4 @ =gUnknown_020391B4
	ldrb r1, [r2]
	ldr r0, [r0, 0x4]
	adds r0, r1
	ldrb r1, [r0]
...
sub_8101518: @ 81018E8
	...
	movs r2, 0x1
	bl DisplayYesNoMenu
	ldr r1, _08101908 @ =gUnknown_083EC9CC
	adds r0, r4, 0
	bl sub_80F914C
	pop {r4}
	pop {r0}
...
sub_810156C: @ 810193C
	...
	movs r2, 0x1
	bl DisplayYesNoMenu
	ldr r1, _0810195C @ =gUnknown_083EC9D4
	adds r0, r4, 0
	bl sub_80F914C
	pop {r4}
	pop {r0}
...
_081019F0:
	bl sub_81016F4
	ldr r0, _08101A0C @ =gUnknown_0300485C
	ldr r1, _08101A10 @ =sub_8101678
	str r1, [r0]
	ldr r0, _08101A14 @ =c2_exit_to_overworld_2_switch
	bl SetMainCallback2
	adds r0, r4, 0
	bl DestroyTask
_08101A06:
...
sub_8101648: @ 8101A18
	...
	cmp r0, 0x1
	bne _08101A38
	ldr r0, _08101A40 @ =gTasks
	lsls r1, r4, 2
	adds r1, r4
	lsls r1, 3
	adds r1, r0
	ldr r0, _08101A44 @ =Task_DecorationPCProcessMenuInput
	str r0, [r1]
_08101A38:
	pop {r4}
	pop {r0}
...
sub_81016C8: @ 8101A98
	push {lr}
	ldr r0, _08101AAC @ =gSaveBlock2
	ldrb r0, [r0, 0x8]
	cmp r0, 0
	bne _08101AB4
	ldr r0, _08101AB0 @ =gUnknown_083ECA5C
	bl LoadSpritePalette
	b _08101ABA
	.align 2, 0
...
_08101AB4:
	ldr r0, _08101AC0 @ =gUnknown_083ECA64
	bl LoadSpritePalette
_08101ABA:
	pop {r0}
	bx r0
...
sub_8101700: @ 8101AD0
	...
	cmp r0, 0
	bne _08101AF8
	ldr r1, _08101AF0 @ =gSecretBaseText_NoDecors
	ldr r2, _08101AF4 @ =sub_80FE428
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	b _08101B12
...
_08101AF8:
	...
	movs r1, 0x1
	strh r1, [r0, 0x1E]
	ldr r0, _08101B1C @ =gUnknown_020388F6
	strb r2, [r0]
	adds r0, r4, 0
	bl sub_80FE5AC
_08101B12:
...
unref_sub_8101750: @ 8101B20
	...
	cmp r0, 0
	bne _08101B48
	ldr r1, _08101B40 @ =gSecretBaseText_NoDecors
	ldr r2, _08101B44 @ =sub_80FE428
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	b _08101B62
...
_08101B48:
	...
	movs r1, 0x2
	strh r1, [r0, 0x1E]
	ldr r0, _08101B6C @ =gUnknown_020388F6
	strb r2, [r0]
	adds r0, r4, 0
	bl sub_80FE5AC
_08101B62:
...
sub_81017A0: @ 8101B70
	...
	cmp r0, 0x1
	bne _08101BD8
	ldr r0, _08101BBC @ =gStringVar1
	ldr r1, _08101BC0 @ =gUnknown_020388F5
	ldrb r2, [r1]
	ldr r1, _08101BC4 @ =gUnknown_020388D0
	ldr r1, [r1]
	adds r1, r2
	ldrb r1, [r1]
	lsls r1, 5
	ldr r2, _08101BC8 @ =0x083f7bf1
	adds r1, r2
	bl StringCopy
	ldr r4, _08101BCC @ =gStringVar4
	ldr r1, _08101BD0 @ =gSecretBaseText_WillBeDiscarded
	adds r0, r4, 0
	bl StringExpandPlaceholders
	ldr r2, _08101BD4 @ =sub_8101824
	adds r0, r5, 0
	adds r1, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
...
_08101BD8:
	ldr r1, _08101BEC @ =gSecretBaseText_DecorInUse
	ldr r2, _08101BF0 @ =sub_80FEFF4
	adds r0, r5, 0
	movs r3, 0
	bl DisplayItemMessageOnField
_08101BE4:
...
sub_8101824: @ 8101BF4
	...
	movs r2, 0x1
	bl DisplayYesNoMenu
	ldr r1, _08101C14 @ =gUnknown_083ECAA0
	adds r0, r4, 0
	bl sub_80F914C
	pop {r4}
	pop {r0}
...
sub_8101848: @ 8101C18
	...
	movs r3, 0xE
	bl MenuZeroFillWindowRect
	ldr r6, _08101C60 @ =gUnknown_020388F5
	ldrb r1, [r6]
	ldr r5, _08101C64 @ =gUnknown_020388D0
	ldr r0, [r5]
	adds r0, r1
	ldrb r0, [r0]
	bl sub_8109A30
	...
	adds r0, r4, 0
	bl sub_80FF098
	ldr r1, _08101C68 @ =gSecretBaseText_DecorThrownAway
	ldr r2, _08101C6C @ =sub_80FEFF4
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	pop {r4-r6}
