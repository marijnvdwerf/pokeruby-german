...
sub_80F7A34: @ 80F7DE4
	...
	movs r2, 0
	adds r4, r0, 0x2
	ldr r3, _080F7E18 @ =gUnknown_083E537C
_080F7DF8:
	lsls r0, r2, 1
	adds r1, r4, r0
	adds r0, r3
...
sub_80F7B14: @ 80F7EC4
	push {r4,lr}
	ldr r4, _080F7ED8 @ =gScriptResult
...
sub_80F7B2C: @ 80F7EDC
	ldr r0, _080F7EE8 @ =gScriptResult
	ldr r1, _080F7EEC @ =0x020284c8
	adds r1, 0x29
	ldrb r1, [r1]
	strh r1, [r0]
	bx lr
...
sub_80F7B40: @ 80F7EF0
	push {r4,r5,lr}
	ldr r5, _080F7F48 @ =0x020284c8
	adds r0, r5, 0
	adds r0, 0x1A
	ldr r4, _080F7F4C @ =gSaveBlock2
	adds r1, r4, 0
	bl StringCopy
	movs r2, 0
	adds r3, r5, 0
...
sub_80F7BA0: @ 80F7F50
	push {r4-r7,lr}
	ldr r1, _080F7FF8 @ =0x020284c8
	ldr r0, _080F7FFC @ =gSpecialVar_0x8004
	ldrh r0, [r0]
	adds r5, r1, 0
	adds r5, 0xE
	cmp r0, 0
...
sub_80F7C54: @ 80F8004
	push {lr}
	ldr r0, _080F801C @ =gSpecialVar_0x8004
	ldrb r0, [r0]
	bl sub_80F7F80
...
sub_80F7C70: @ 80F8020
	ldr r0, _080F802C @ =gScriptResult
	ldr r1, _080F8030 @ =0x020284c8
	ldrb r1, [r1, 0x1]
	strh r1, [r0]
	bx lr
	.align 2, 0
...
sub_80F7C90: @ 80F8040
	...
	lsls r0, 16
	lsrs r1, r0, 16
	ldr r0, _080F8058 @ =0x0000ffff
	cmp r1, r0
	bne _080F8060
	ldr r1, _080F805C @ =gScriptResult
	movs r0, 0
	b _080F806A
	.align 2, 0
...
_080F8060:
	ldr r0, _080F8070 @ =gStringVar1
	bl ConvertEasyChatWordsToString
	ldr r1, _080F8074 @ =gScriptResult
	movs r0, 0x1
_080F806A:
	strh r0, [r1]
	pop {r0}
...
sub_80F7CC8: @ 80F8078
	push {lr}
	ldr r2, _080F808C @ =0x020284c8
	ldrb r0, [r2, 0x1]
	cmp r0, 0xA
	bne _080F8094
	ldr r1, _080F8090 @ =gScriptResult
	movs r0, 0
	strh r0, [r1]
	strb r0, [r2, 0x1]
	b _080F809A
...
_080F8094:
	ldr r1, _080F80A0 @ =gScriptResult
	movs r0, 0x1
	strh r0, [r1]
_080F809A:
	pop {r0}
...
_080F80B2:
	...
	bl ConvertEasyChatWordsToString
	adds r2, r0, 0
	ldr r1, _080F810C @ =gOtherText_Is
	bl StringCopy
	adds r2, r0, 0
	ldr r0, _080F8110 @ =gUnknown_083E5388
	lsls r4, 2
	adds r4, r0
	ldr r1, [r4]
	adds r0, r2, 0
	bl StringCopy
	adds r2, r0, 0
	ldr r1, _080F8114 @ =gOtherText_DontYouAgree
	bl StringCopy
	b _080F8138
	.align 2, 0
...
_080F8118:
	ldr r0, _080F8150 @ =gStringVar4
	ldr r3, _080F8154 @ =gUnknown_083E53A8
	ldrb r1, [r5, 0x2]
	adds r2, r1, 0x1
	strb r2, [r5, 0x2]
	lsls r1, 24
...
_080F815C:
	strb r0, [r5, 0x1]
	ldr r1, _080F816C @ =gScriptResult
	movs r0, 0x1
	strh r0, [r1]
	pop {r4-r6}
	pop {r0}
...
sub_80F7DC0: @ 80F8170
	...
	push {r5-r7}
	sub sp, 0x18
	ldr r1, _080F8234 @ =gUnknown_083E53C8
	mov r0, sp
	movs r2, 0x18
	bl memcpy
	movs r5, 0
...
sub_80F7F80: @ 80F8330
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r0, _080F8358 @ =sub_80F8184
	movs r1, 0x50
	bl CreateTask
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _080F835C @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
...
_080F837C:
	...
	.4byte _080F852A
_080F8394:
	ldr r2, _080F83E4 @ =0x020284c8
	ldr r0, _080F83E8 @ =gSpecialVar_0x8004
	ldrh r0, [r0]
	adds r1, r2, 0
	adds r1, 0xE
	cmp r0, 0
...
_080F84A2:
	strh r0, [r6, 0x8]
	ldr r4, _080F84CC @ =gMPlay_SE2
	ldr r5, _080F84D0 @ =0x0000ffff
	ldrh r2, [r6, 0x6]
	adds r0, r4, 0
	adds r1, r5, 0
...
_080F84D4:
	...
	adds r0, r1
	strh r0, [r6, 0x6]
	ldr r4, _080F8518 @ =gMPlay_SE2
	ldr r5, _080F851C @ =0x0000ffff
	ldrh r2, [r6, 0x6]
	adds r0, r4, 0
	adds r1, r5, 0
	bl m4aMPlayVolumeControl
...
sub_80F8184: @ 80F8534
	...
	adds r0, r6
	lsls r0, 3
	ldr r1, _080F8564 @ =gTasks
	adds r5, r0, r1
	ldr r1, _080F8568 @ =gUnknown_03005DA0
	adds r0, r5, 0
	bl sub_80F7FB0
	movs r1, 0x8
	ldrsh r0, [r5, r1]
...
_080F8588:
	bl sub_80F7BA0
	ldr r4, _080F85BC @ =gMenuWindowPtr
	ldr r0, [r4]
	ldr r1, _080F85C0 @ =gWindowConfig_81E6CE4
	bl InitWindowFromConfig
	ldr r0, [r4]
	ldr r1, _080F85C4 @ =gStringVar4
	movs r2, 0xF
	str r2, [sp]
	movs r2, 0x2
	movs r3, 0x4
...
_080F85D4:
	...
	b _080F8776
_080F85D8:
	ldr r4, _080F85F0 @ =0x020284c8
	movs r2, 0xE
	ldrsh r1, [r5, r2]
	ldr r0, _080F85F4 @ =gStringVar4
	adds r1, r0
	movs r3, 0
	ldrb r0, [r1]
	ldr r7, _080F85F8 @ =gUnknown_03005DA0
	ldrh r2, [r5, 0x12]
	ldr r6, _080F85FC @ =gUnknown_020388BC
	b _080F860A
	.align 2, 0
...
_080F86BC:
	cmp r4, 0
	bne _080F86DC
	ldr r0, _080F86D8 @ =gMenuWindowPtr
	ldr r0, [r0]
	bl sub_8003418
	ldrh r0, [r5, 0xE]
	adds r0, 0x1
...
_080F8704:
	...
	movs r4, 0
	strb r4, [r0]
	ldr r0, _080F8720 @ =gMenuWindowPtr
	ldr r0, [r0]
	bl sub_8003418
	ldrh r0, [r5, 0xE]
	adds r0, 0x1
...
_080F8736:
	...
	b _080F8778
_080F873C:
	ldr r0, _080F874C @ =gMenuWindowPtr
	ldr r0, [r0]
	bl sub_8003418
_080F8744:
	ldrh r0, [r5, 0xA]
...
_080F8750:
	...
	strh r0, [r5, 0xE]
	strh r1, [r5, 0xA]
	ldr r0, _080F8764 @ =gUnknown_03005DA0
	ldrh r0, [r0, 0x4]
	strh r0, [r5, 0xC]
	movs r0, 0x4
	b _080F8776
...
sub_80F844C: @ 80F87FC
	...
	adds r3, r0, 0
	movs r2, 0
	ldr r1, _080F8810 @ =gUnknown_083E53E0
_080F8804:
	ldrb r0, [r1]
	cmp r0, r3
	bne _080F8814
...
_080F8814:
	...
	cmp r2, 0x23
	ble _080F8804
	ldr r0, _080F8824 @ =gUnknown_083E5610
_080F881E:
	pop {r1}
	bx r1
	.align 2, 0
...
sub_80F8598: @ 80F8948
	...
	adds r5, r0, 0
	adds r6, r1, 0
	ldr r0, _080F899C @ =0x020284c8
	adds r0, 0x4
	adds r0, r5, r0
	strb r6, [r0]
	ldr r1, _080F89A0 @ =gSaveBlock2
	adds r0, r5, 0
	bl sub_80F8560
	lsls r4, r6, 24
	lsrs r4, 24
...
sub_80F8650: @ 80F8A00
	...
	mov r7, sp
	mov r10, sp
	ldr r0, _080F8A84 @ =gUnknown_083E5620
	ldr r0, [r0]
	lsls r0, 3
	lsrs r0, 3
	adds r0, 0x3
	...
	bl sub_80F85FC
	movs r5, 0
	ldr r0, _080F8A88 @ =gUnknown_083E53E0
	mov r9, r0
	ldr r3, _080F8A8C @ =0x020284c8
_080F8A36:
	mov r1, r8
	adds r0, r1, r5
	ldrb r0, [r0]
...
sub_80F8700: @ 80F8AB0
	push {r4-r6,lr}
	adds r5, r0, 0
	ldr r0, _080F8AF8 @ =0x020284c8
	adds r0, 0x4
	adds r0, r5, r0
	ldrb r6, [r0]
	ldr r4, _080F8AFC @ =gStringVar1
	adds r0, r5, 0
	bl sub_80F84C8
	adds r1, r0, 0
	adds r0, r4, 0
	...
	movs r3, 0xA
	bl ConvertIntToDecimalStringN
	ldr r4, _080F8B00 @ =gStringVar2
	adds r0, r6, 0
	bl sub_80F8490
	adds r1, r0, 0
	adds r0, r4, 0
	bl StringCopy
	ldr r1, _080F8B04 @ =gStringVar3
	adds r0, r5, 0
	bl sub_80F8534
	adds r0, r6, 0
	bl sub_80F8484
...
_080F8B34:
	...
	bne _080F8B34
_080F8B54:
	ldr r0, _080F8B70 @ =gPCText_Cancel
	lsls r2, r4, 25
	movs r1, 0x80
	lsls r1, 18
	adds r2, r1
...
_080F8BC0:
	...
	bne _080F8BF0
_080F8BE2:
	ldr r1, _080F8BEC @ =gScriptResult
	movs r0, 0
	strh r0, [r1]
	b _080F8BF8
	.align 2, 0
...
_080F8BF0:
	ldr r0, _080F8C1C @ =gScriptResult
	strh r5, [r0]
	ldr r0, _080F8C20 @ =gUnknown_03000748
	strb r4, [r0]
_080F8BF8:
	bl sub_8072DEC
	movs r0, 0
...
sub_80F8888: @ 80F8C38
	push {lr}
	ldr r0, _080F8C48 @ =gUnknown_03000748
	ldrb r0, [r0]
	bl sub_80F8700
	pop {r0}
	bx r0
...
sub_80F88AC: @ 80F8C5C
	push {r4,r5,lr}
	ldr r1, _080F8C78 @ =0x020284c8
	ldr r5, _080F8C7C @ =gUnknown_03000748
	ldrb r0, [r5]
	adds r1, 0x4
	adds r1, r0, r1
	ldrb r4, [r1]
