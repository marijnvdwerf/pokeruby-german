...
_08048D86:
	lsls r0, 2
	ldr r1, _08048D94 @ =_080490BC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08048D90: .4byte gUnknown_03004824
_08048D94: .4byte _080490BC
	.align 2, 0
_08048D98:
	.4byte _08048DDC
	.4byte _08048DF8
...
sub_8049DE0: @ 8049DE0
	...
	bhi _08049E98
	lsls r0, 2
	ldr r1, _08049DFC @ =_0804A124
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08049DF8: .4byte gUnknown_03004824
_08049DFC: .4byte _0804A124
	.align 2, 0
_08049E00:
	.4byte _08049E40
	.4byte _08049E46
...
_0804AB64:
	...
	bhi _0804ABD2
	lsls r0, 2
	ldr r1, _0804AB7C @ =_0804AEE4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804AB7C: .4byte _0804AEE4
	.align 2, 0
_0804AB80:
	.4byte _0804AB98
	.4byte _0804ABB4
...
sub_804ABF8: @ 804ABF8
	...
	bhi _0804ACB0
	lsls r0, r1, 2
	ldr r1, _0804AC18 @ =_0804AF80
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804AC14: .4byte gUnknown_03004824
_0804AC18: .4byte _0804AF80
	.align 2, 0
_0804AC1C:
	.4byte _0804AC40
	.4byte _0804ACB0
...
_0804BBF4:
	lsls r0, 2
	ldr r1, _0804BC00 @ =_0804BF68
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804BC00: .4byte _0804BF68
	.align 2, 0
_0804BC04:
	.4byte _0804BC24
	.4byte _0804BCC4
...
_0804C2B6:
	lsls r0, 2
	ldr r1, _0804C2C4 @ =_0804C62C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0804C2C0: .4byte gUnknown_03004828
_0804C2C4: .4byte _0804C62C
	.align 2, 0
_0804C2C8:
	.4byte _0804C5EC
	.4byte _0804C66C
