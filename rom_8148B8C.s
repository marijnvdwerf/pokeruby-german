...
sub_8148F3C: @ 8148F3C
	...
	strh r1, [r3, 0xC]
	strh r2, [r3, 0xE]
	ldr r0, _08148FB8 @ =0x04000014
	strh r1, [r0]
	ldr r2, _08148FBC @ =0x04000016
...
_08148F7C:
	...
	strh r1, [r3, 0x12]
	strh r2, [r3, 0x14]
	ldr r0, _08148FC8 @ =0x04000018
	strh r1, [r0]
	movs r1, 0x8
	ldrsh r0, [r3, r1]
	cmp r0, 0
	beq _08148FD0
	ldr r2, _08148FCC @ =0x0400001a
	ldr r1, _08148FC0 @ =gUnknown_02039358
	ldr r0, _08148FC4 @ =gUnknown_0203935A
	ldrh r0, [r0]
	ldrh r1, [r1]
...
_08148FD8:
	...
	strh r1, [r3, 0x18]
	strh r2, [r3, 0x1A]
	ldr r0, _08149018 @ =0x0400001c
	strh r1, [r0]
	ldr r1, _0814901C @ =0x0400001e
...
sub_814A2D0: @ 814A2D0
	...
	lsls r1, 16
	lsrs r1, 16
	ldr r3, _0814A2F8 @ =gBardMusicTable
	lsls r2, r0, 2
	adds r2, r3
	ldr r4, [r2]
	bl sub_80EB3FC
	...
	bx r1
	.align 2, 0
_0814A2F8: .4byte gBardMusicTable
