...
PickLotteryCornerTicket: @ 8145B00
	push {r4-r7,lr}
	mov r7, r10
	mov r6, r9
	mov r5, r8
	push {r5-r7}
	ldr r1, _08145C24 @ =gSpecialVar_0x8004
	movs r0, 0
	strh r0, [r1]
	movs r0, 0
	mov r10, r0
...
_08145BD8:
	...
	cmp r6, 0xD
	bls _08145B76
	ldr r3, _08145C24 @ =gSpecialVar_0x8004
	ldrh r0, [r3]
	cmp r0, 0
	beq _08145C72
	ldr r2, _08145C34 @ =gSpecialVar_0x8005
	...
	cmp r2, 0xE
	bne _08145C44
	ldr r1, _08145C3C @ =gSpecialVar_0x8006
	movs r0, 0
	strh r0, [r1]
	movs r0, 0x64
	mov r1, r10
...
_08145C72:
	...
	bx r0
	.align 2, 0
_08145C80: .4byte gSpecialVar_0x8006
