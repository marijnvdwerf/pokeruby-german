...
sub_8046400: @ 8046724
	...
	lsls r5, 24
	lsrs r5, 24
	ldr r1, _08046774 @ =gUnknown_02024E6D
	movs r0, 0x1
	strb r0, [r1]
	ldr r6, _08046778 @ =gUnknown_02024A60
	ldrb r1, [r6]
	lsls r0, r1, 1
	adds r0, r1
	lsls r0, 2
	ldr r1, _0804677C @ =0x02017810
	adds r0, r1
	ldrb r1, [r0]
	movs r2, 0x8
	orrs r1, r2
	strb r1, [r0]
	ldr r0, _08046780 @ =sub_8046464
	movs r1, 0x5
	bl CreateTask
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _08046784 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
...
_080467C0:
	...
	cmp r0, 0
	beq _080467EC
	ldr r1, _080467E4 @ =gUnknown_02024A6A
	lsls r0, r5, 1
	adds r0, r1
	ldrh r1, [r0]
	movs r0, 0x64
	muls r0, r1
	ldr r1, _080467E8 @ =gEnemyParty
	b _080467FA
	.align 2, 0
_080467E4: .4byte gUnknown_02024A6A
_080467E8: .4byte gEnemyParty
_080467EC:
	ldr r1, _08046868 @ =gUnknown_02024A6A
	lsls r0, r5, 1
	adds r0, r1
	ldrh r1, [r0]
	movs r0, 0x64
	muls r0, r1
	ldr r1, _0804686C @ =gPlayerParty
_080467FA:
	adds r0, r1
	movs r1, 0x26
	bl GetMonData
	...
	adds r0, r4
	lsls r0, 3
	ldr r1, _08046870 @ =gSpriteTemplate_820AAB4
	adds r0, r1
	movs r1, 0x20
	movs r2, 0x50
	movs r3, 0x1D
	...
	cmp r2, 0xFF
	bne _080468BC
	ldr r0, _08046878 @ =gUnknown_02024C08
	strb r5, [r0]
	movs r0, 0x18
	strh r0, [r4, 0x20]
	movs r0, 0x44
...
_08046880:
	...
	adds r0, 0x18
	strh r0, [r4, 0x22]
	ldr r0, _080468B4 @ =gUnknown_02024C08
	strb r5, [r0]
	movs r3, 0
	strh r3, [r4, 0x2E]
	mov r0, r9
...
_080468BC:
	...
	ldr r1, _080468E8 @ =gUnknown_02024C08
	strb r0, [r1]
	movs r0, 0x1
	str r0, [sp]
_080468CA:
	ldr r0, _080468EC @ =gSprites
	lsls r1, r7, 4
	adds r1, r7
	lsls r1, 2
	adds r4, r1, r0
	ldr r5, _080468E8 @ =gUnknown_02024C08
	ldrb r0, [r5]
	strh r0, [r4, 0x3A]
	ldr r2, [sp]
	cmp r2, 0
...
_080468F0:
	...
	subs r0, 0x10
	strh r0, [r4, 0x36]
	ldr r0, _0804694C @ =0x0000ffd8
	strh r0, [r4, 0x38]
	adds r0, r4, 0
	bl sub_80786EC
	mov r3, r10
	strh r3, [r4, 0x6]
	ldr r1, _08046950 @ =gTasks
	mov r2, r10
	lsls r0, r2, 2
	add r0, r10
	lsls r0, 3
...
sub_80466F4: @ 8046A18
	...
	bne _08046A72
	strh r7, [r6, 0x38]
	ldr r0, _08046A78 @ =sub_8046760
	str r0, [r6, 0x1C]
	ldr r5, _08046A7C @ =gUnknown_02024BE0
	movs r1, 0x3A
	ldrsh r0, [r6, r1]
	adds r0, r5
	ldrb r1, [r0]
...
sub_8046760: @ 8046A84
	...
	bl PlaySE
_08046A9C:
	ldr r6, _08046AE8 @ =gSprites
	ldr r5, _08046AEC @ =gUnknown_02024BE0
	movs r1, 0x3A
	ldrsh r0, [r4, r1]
	adds r0, r5
	ldrb r1, [r0]
...
sub_8046C78: @ 8046F9C
	...
	lsrs r0, 24
	strh r0, [r6, 0x2E]
	ldr r0, _08047030 @ =sub_8046E9C
	str r0, [r6, 0x1C]
	ldr r0, _08047034 @ =gMain
	ldr r1, _08047038 @ =0x0000043d
	adds r0, r1
	ldrb r1, [r0]
	movs r0, 0x2
	ands r0, r1
...
_0804700C:
	...
	cmp r0, 0
	beq _08047044
	ldr r1, _0804703C @ =gUnknown_02024A6A
	lsls r0, r5, 1
	adds r0, r1
	ldrh r1, [r0]
	movs r0, 0x64
	muls r1, r0
	ldr r0, _08047040 @ =gEnemyParty
	adds r0, r1, r0
	movs r3, 0x19
	mov r8, r3
	b _08047058
...
_08047044:
	ldr r1, _080470B4 @ =gUnknown_02024A6A
	lsls r0, r5, 1
	adds r0, r1
	ldrh r1, [r0]
	movs r0, 0x64
	muls r1, r0
	ldr r0, _080470B8 @ =gPlayerParty
	adds r0, r1, r0
	movs r1, 0xE7
	mov r8, r1
_08047058:
...
_0804707E:
	...
	cmp r0, 0
	beq _080470D2
	ldr r0, _080470BC @ =0x02017840
	ldrb r1, [r0, 0x9]
	movs r0, 0x1
	ands r0, r1
	cmp r0, 0
	beq _080470D2
	ldr r0, _080470C0 @ =gUnknown_020239F8
	ldrh r1, [r0]
	movs r0, 0x40
	ands r0, r1
	cmp r0, 0
...
_080470C8:
	ldr r0, _080470EC @ =gMPlay_BGM
	ldr r1, _080470F0 @ =0x0000ffff
	movs r2, 0x80
...
_08047118:
	movs r4, 0x2
_0804711A:
	ldr r0, _08047190 @ =sub_8046AD0
	movs r1, 0x3
	bl CreateTask
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _08047194 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
	...
	strh r2, [r1, 0x26]
_08047140:
	ldr r5, _08047198 @ =gUnknown_02024BE0
	movs r1, 0x3A
	ldrsh r0, [r6, r1]
	adds r0, r5
	ldrb r1, [r0]
...
sub_8046E9C: @ 80471C0
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r6, _08047224 @ =gSprites
	ldr r0, _08047228 @ =gUnknown_02024BE0
	adds r3, r4, r0
	ldrb r1, [r3]
	lsls r0, r1, 4
	adds r0, r1
...
_08047248:
	...
	cmp r7, 0
	beq _080472C4
	ldr r2, _080472D0 @ =gSprites
	ldr r0, _080472D4 @ =gUnknown_02024BE0
	adds r0, r4, r0
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	...
	movs r1, 0
	strh r1, [r0, 0x26]
	ldr r0, _080472D8 @ =gUnknown_02024E6D
	strb r2, [r0]
	lsls r1, r4, 1
	adds r1, r4
	lsls r1, 2
	ldr r4, _080472DC @ =0x02017810
	adds r1, r4
	ldrb r2, [r1]
	movs r0, 0x9
	negs r0, r0
...
sub_8046FBC: @ 80472E0
	...
	cmp r1, 0x5F
	bne _08047318
	ldr r0, _08047310 @ =gUnknown_02024E6D
	movs r1, 0
	strb r1, [r0]
	bl m4aMPlayAllStop
	ldr r0, _08047314 @ =0x00000173
	bl PlaySE
	b _0804737A
	.align 2, 0
...
_08047318:
	ldr r0, _08047380 @ =0x0000013b
	cmp r1, r0
	bne _0804737A
	ldr r5, _08047384 @ =gSprites
	ldr r4, _08047388 @ =gUnknown_02024BE0
	movs r1, 0x3A
	ldrsh r0, [r6, r1]
	adds r0, r4
	ldrb r1, [r0]
	...
	ldr r0, _0804738C @ =gMain
	ldr r1, _08047390 @ =0x0000043d
	adds r0, r1
	ldrb r1, [r0]
	movs r0, 0x2
	ands r0, r1
...
sub_8047074: @ 8047398
	...
	adds r0, 0x18
	strh r0, [r4, 0x36]
	ldr r0, _080473E0 @ =0x0000ffe2
	strh r0, [r4, 0x38]
	ldrh r0, [r4, 0x3A]
	strh r0, [r4, 0x6]
	adds r0, r4, 0
	bl sub_80786EC
	ldr r0, _080473E4 @ =sub_80470C4
	str r0, [r4, 0x1C]
	pop {r4}
	pop {r0}
	bx r0
...
_080474DC:
	...
	cmp r4, r0
	bne _08047538
	ldr r0, _08047534 @ =sub_8047230
	b _0804753A
	.align 2, 0
_08047530: .4byte 0x02017840
_08047534: .4byte sub_8047230
_08047538:
	ldr r0, _08047550 @ =sub_8046C78
_0804753A:
	str r0, [r5, 0x1C]
	adds r0, r5, 0
	movs r1, 0
...
sub_8047254: @ 8047578
	...
	cmp r4, r0
	bne _080475C4
	ldr r0, _080475C0 @ =sub_8047230
	b _080475C6
	.align 2, 0
_080475BC: .4byte 0x02017840
_080475C0: .4byte sub_8047230
_080475C4:
	ldr r0, _080475D0 @ =sub_8046C78
_080475C6:
	str r0, [r5, 0x1C]
_080475C8:
	pop {r4,r5}
...
CreatePokeballSprite: @ 8047614
	...
	lsls r0, 24
	lsrs r7, r0, 24
	ldr r0, _080476E0 @ =gUnknown_0820A92C
	bl LoadCompressedObjectPic
	ldr r0, _080476E4 @ =gUnknown_0820A98C
	bl LoadCompressedObjectPalette
	ldr r0, _080476E8 @ =gSpriteTemplate_820AAB4
	mov r1, r9
	mov r2, r10
	adds r3, r4, 0
	bl CreateSprite
...
_08047730:
	...
	movs r5, 0
	strh r0, [r6, 0x30]
	ldr r0, _08047798 @ =sub_804748C
	str r0, [r6, 0x1C]
	ldr r0, _0804779C @ =gSprites
	lsls r4, r7, 4
	adds r4, r7
	lsls r4, 2
	adds r4, r0
...
sub_8047580: @ 80478A4
	...
	lsrs r0, 24
	mov r9, r0
	ldr r0, _08047948 @ =gUnknown_0820A92C
	bl LoadCompressedObjectPic
	ldr r0, _0804794C @ =gUnknown_0820A98C
	bl LoadCompressedObjectPalette
	ldr r0, _08047950 @ =gSpriteTemplate_820AAB4
	adds r1, r6, 0
	mov r2, r8
	adds r3, r4, 0
	bl CreateSprite
...
_08047998:
	...
	movs r5, 0
	strh r0, [r4, 0x30]
	ldr r0, _080479EC @ =sub_80476E0
	str r0, [r4, 0x1C]
	lsls r4, r7, 4
	adds r4, r7
	lsls r4, 2
	ldr r0, _080479F0 @ =gSprites
	adds r4, r0
	adds r0, r4, 0
	movs r1, 0x2
	bl StartSpriteAffineAnim
...
sub_8047754: @ 8047A78
	...
	cmp r0, 0
	beq _08047A8C
	ldr r0, _08047A90 @ =SpriteCallbackDummy
	str r0, [r2, 0x1C]
_08047A8C:
	pop {r0}
	bx r0
...
sub_804777C: @ 8047AA0
	...
	lsrs r0, 24
	adds r5, r0, 0
	ldr r0, _08047B20 @ =gUnknown_03004340
	adds r0, r5, r0
	ldrb r1, [r0]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	ldr r6, _08047B24 @ =gSprites
	adds r4, r0, r6
	movs r1, 0
	movs r0, 0x5
	strh r0, [r4, 0x2E]
...
sub_8047830: @ 8047B54
	...
	cmp r0, 0
	bne _08047B72
	ldr r0, _08047B78 @ =SpriteCallbackDummy
	str r0, [r2, 0x1C]
_08047B72:
	pop {r0}
	bx r0
...
sub_8047858: @ 8047B7C
	...
	lsls r4, 24
	lsrs r4, 24
	ldr r5, _08047BB4 @ =oamc_804BEB4
	adds r0, r5, 0
	bl object_new_hidden_with_callback
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _08047BB8 @ =gSprites
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	adds r3, r1, r2
	movs r0, 0x1
	strh r0, [r3, 0x2E]
	ldr r0, _08047BBC @ =gUnknown_03004340
	adds r4, r0
	ldrb r0, [r4]
	strh r0, [r3, 0x30]
	adds r2, 0x1C
...
sub_80478DC: @ 8047C00
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r0, _08047C5C @ =gUnknown_0820A92C
	lsls r6, r4, 3
	adds r5, r6, r0
	ldrh r0, [r5, 0x6]
	bl GetSpriteTileStartByTag
	lsls r0, 16
	ldr r1, _08047C60 @ =0xffff0000
	cmp r0, r1
	bne _08047C28
	adds r0, r5, 0
	bl LoadCompressedObjectPic
	ldr r0, _08047C64 @ =gUnknown_0820A98C
	adds r0, r6, r0
	bl LoadCompressedObjectPalette
_08047C28:
	cmp r4, 0x6
	...
	bge _08047C54
_08047C38:
	ldr r1, _08047C5C @ =gUnknown_0820A92C
	lsls r0, r4, 3
	adds r0, r1
	ldrh r0, [r0, 0x6]
	bl GetSpriteTileStartByTag
	adds r1, r0, 0
	lsls r1, 16
	ldr r0, _08047C68 @ =gUnknown_08D030D0
	lsrs r1, 11
	ldr r2, _08047C6C @ =0x06010100
	adds r1, r2
	bl LZDecompressVram
_08047C54:
	pop {r4-r6}
...
sub_804794C: @ 8047C70
	...
	adds r4, r0, 0
	lsls r4, 24
	ldr r0, _08047C94 @ =gUnknown_0820A92C
	lsrs r4, 21
	adds r0, r4, r0
	ldrh r0, [r0, 0x6]
	bl FreeSpriteTilesByTag
	ldr r0, _08047C98 @ =gUnknown_0820A98C
	adds r4, r0
	ldrh r0, [r4, 0x4]
...
sub_8047978: @ 8047C9C
	...
	cmp r0, 0
	beq _08047CC8
	ldr r1, _08047CC0 @ =gUnknown_02024A6A
	lsls r0, r4, 1
	adds r0, r1
	ldrh r1, [r0]
	movs r0, 0x64
	muls r0, r1
	ldr r1, _08047CC4 @ =gEnemyParty
	b _08047CD6
	.align 2, 0
_08047CC0: .4byte gUnknown_02024A6A
_08047CC4: .4byte gEnemyParty
_08047CC8:
	ldr r1, _08047CE8 @ =gUnknown_02024A6A
	lsls r0, r4, 1
	adds r0, r1
	ldrh r1, [r0]
	movs r0, 0x64
	muls r0, r1
	ldr r1, _08047CEC @ =gPlayerParty
_08047CD6:
	adds r0, r1
	movs r1, 0x26
	bl GetMonData
