...
_08069228:
	...
	cmp r0, 0
	bge _08069244
	ldr r0, _0806923C @ =gSpecialVars
	ldr r2, _08069240 @ =0xffff8000
	adds r1, r2
	lsls r1, 2
	adds r1, r0
	ldr r0, [r1]
	b _0806924A
	.align 2, 0
_0806923C: .4byte gSpecialVars
_08069240: .4byte 0xffff8000
_08069244:
	lsls r0, r2, 1
	ldr r1, _08069250 @ =0x0201ea74
	adds r0, r1
_0806924A:
	pop {r1}
	bx r1
