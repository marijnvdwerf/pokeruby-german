...
sub_813CCE8: @ 813CCE8
	...
	bhi _0813CD28
	lsls r0, 2
	ldr r1, _0813CD10 @ =_0813D0F0
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813CD0C: .4byte gTasks
_0813CD10: .4byte _0813D0F0
	.align 2, 0
_0813CD14:
	.4byte _0813CD28
	.4byte _0813CD5C
...
sub_813D788: @ 813D788
	...
	bhi _0813D830
	lsls r0, 2
	ldr r1, _0813D7A0 @ =_0813DB80
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813D7A0: .4byte _0813DB80
	.align 2, 0
_0813D7A4:
	.4byte _0813D7B8
	.4byte _0813D7C6
...
sub_813DB9C: @ 813DB9C
	...
	bhi _0813DBCC
	lsls r0, 2
	ldr r1, _0813DBB4 @ =_0813DF94
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813DBB4: .4byte _0813DF94
	.align 2, 0
_0813DBB8:
	.4byte _0813DBCC
	.4byte _0813DBF2
...
sub_813DE70: @ 813DE70
	...
	bhi _0813DEB0
	lsls r0, 2
	ldr r1, _0813DE90 @ =_0813E270
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813DE90: .4byte _0813E270
	.align 2, 0
_0813DE94:
	.4byte _0813DEB0
	.4byte _0813E0F8
...
sub_813E10C: @ 813E10C
	...
	bhi _0813E13C
	lsls r0, 2
	ldr r1, _0813E124 @ =_0813E504
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813E124: .4byte _0813E504
	.align 2, 0
_0813E128:
	.4byte _0813E13C
	.4byte _0813E178
...
sub_813E210: @ 813E210
	...
	bhi _0813E240
	lsls r0, 2
	ldr r1, _0813E228 @ =_0813E608
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813E228: .4byte _0813E608
	.align 2, 0
_0813E22C:
	.4byte _0813E240
	.4byte _0813E278
...
_0813E322:
	lsls r0, 2
	ldr r1, _0813E32C @ =_0813E70C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813E32C: .4byte _0813E70C
	.align 2, 0
_0813E330:
	.4byte _0813E4AC
	.4byte _0813E384
...
ball_number_to_ball_processing_index: @ 813FA14
	...
	bhi _0813FA8C
	lsls r0, 2
	ldr r1, _0813FA2C @ =_0813FE0C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0813FA2C: .4byte _0813FE0C
	.align 2, 0
_0813FA30:
	.4byte _0813FA60
	.4byte _0813FA64
...
_081401B0:
	lsls r0, r1, 2
	ldr r1, _081401BC @ =_0814059C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_081401BC: .4byte _0814059C
	.align 2, 0
_081401C0:
	.4byte _081401DC
	.4byte _08140226
...
_08141714:
	ldr r1, _08141734 @ =0x04000050
	ldr r2, _08141738 @ =0x00003f44
_08141718:
	adds r0, r2, 0
	strh r0, [r1]
	ldr r1, _0814173C @ =0x04000052
	movs r0, 0x10
	strh r0, [r1]
...
_08143E0C:
	...
	movs r3, 0
	bl BeginNormalPaletteFade
	ldr r0, _08143EA8 @ =0x0400001c
	strh r5, [r0]
	ldr r1, _08143EAC @ =0x0400001e
	movs r0, 0x20
	strh r0, [r1]
	subs r1, 0x10
...
sub_81441B8: @ 81441B8
	...
	bhi _08144218
	lsls r0, 2
	ldr r1, _081441E8 @ =_081445C8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_081441E4: .4byte gTasks
_081441E8: .4byte _081445C8
	.align 2, 0
_081441EC:
	.4byte _08144218
	.4byte _08144258
...
_08144680:
	lsls r0, 2
	ldr r1, _08144690 @ =_08144A70
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0814468C: .4byte gTasks
_08144690: .4byte _08144A70
	.align 2, 0
_08144694:
	.4byte _08144760
	.4byte _08144784
...
sub_8144934: @ 8144934
	...
	bhi _08144974
	lsls r0, 2
	ldr r1, _0814495C @ =_08144D3C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08144958: .4byte gTasks
_0814495C: .4byte _08144D3C
	.align 2, 0
_08144960:
	.4byte _08144974
	.4byte _081449B8
...
_08144A7E:
	lsls r0, 2
	ldr r1, _08144A88 @ =_08144E68
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08144A88: .4byte _08144E68
	.align 2, 0
_08144A8C:
	.4byte _08144AA0
	.4byte _08144B48
...
_08144EF0:
	...
	movs r1, 0
	strh r1, [r0]
	ldr r2, _08144F30 @ =0x0400001c
	movs r0, 0x8
	strh r0, [r2]
	ldr r0, _08144F34 @ =0x0400001e
	strh r1, [r0]
	subs r0, 0x6
	strh r1, [r0]
	adds r0, 0x2
...
sub_81452D0: @ 81452D0
	...
	lsrs r1, 16
	movs r2, 0
	ldr r7, _08145340 @ =gUnknown_0840B85A
	movs r6, 0xC0
	lsls r6, 19
	adds r1, 0x1
	ldr r3, _08145344 @ =0x000003ff
_081452EE:
	lsls r0, r2, 1
	adds r0, r4
	adds r0, r6
	...
	adds r3, r4, 0
	bl sub_814524C
	ldr r0, _08145348 @ =gUnknown_0840B869
	str r5, [sp]
	movs r1, 0xB
	movs r2, 0x7
	adds r3, r4, 0
	bl sub_814524C
	ldr r0, _0814534C @ =gUnknown_0840B878
	str r5, [sp]
	movs r1, 0xF
	movs r2, 0x7
	adds r3, r4, 0
	...
	bx r0
	.align 2, 0
_08145340: .4byte gUnknown_0840B85A
_08145344: .4byte 0x000003ff
_08145348: .4byte gUnknown_0840B869
_0814534C: .4byte gUnknown_0840B878
...
_08145394:
	...
	bhi _08145418
	lsls r0, 2
	ldr r1, _081453A8 @ =_08145760
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_081453A8: .4byte _08145760
	.align 2, 0
_081453AC:
	.4byte _081453C4
	.4byte _081453CE
...
_081454FC:
	...
	bhi _08145544
	lsls r0, 2
	ldr r1, _08145514 @ =_081458CC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08145514: .4byte _081458CC
	.align 2, 0
_08145518:
	.4byte _08145544
	.4byte _0814559E
