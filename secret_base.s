...
sub_80BB5D0: @ 80BB764
	ldr r0, _080BB770 @ =gUnknown_020387DC
	ldr r1, _080BB774 @ =gSpecialVar_0x8004
	ldrh r1, [r1]
	strb r1, [r0]
	bx lr
	.align 2, 0
...
sub_80BB5E4: @ 80BB778
	push {r4,lr}
	ldr r0, _080BB788 @ =gScriptResult
	movs r1, 0
	strh r1, [r0]
	movs r3, 0
	adds r4, r0, 0
...
_080BB792:
	cmp r3, 0x13
	bhi _080BB7BA
	ldr r2, _080BB7C0 @ =gUnknown_020387DC
	ldr r1, _080BB7C4 @ =gSaveBlock1
	lsls r0, r3, 2
	adds r0, r3
	lsls r0, 5
	adds r0, r1
	ldr r1, _080BB7C8 @ =0x00001a08
	adds r0, r1
	ldrb r1, [r2]
	ldrb r0, [r0]
	cmp r1, r0
...
sub_80BB63C: @ 80BB7D0
	push {lr}
	ldr r0, _080BB7E8 @ =gSaveBlock1
	ldr r1, _080BB7EC @ =0x00001a08
	adds r0, r1
	ldrb r1, [r0]
	cmp r1, 0
	beq _080BB7F4
	ldr r1, _080BB7F0 @ =gScriptResult
	movs r0, 0x1
	strh r0, [r1]
	b _080BB7F8
	.align 2, 0
...
_080BB7F4:
	ldr r0, _080BB7FC @ =gScriptResult
	strh r1, [r0]
_080BB7F8:
	pop {r0}
	bx r0
...
sub_80BB70C: @ 80BB8A0
	push {r4,lr}
	ldr r4, _080BB8B4 @ =gSpecialVar_0x8007
	bl sub_80BB66C
	lsls r0, 24
	lsrs r0, 24
	strh r0, [r4]
...
unref_sub_80BB724: @ 80BB8B8
	...
	lsls r1, 24
	movs r2, 0
	ldr r6, _080BB8DC @ =0x00000fff
	lsrs r3, r1, 24
	ldr r5, _080BB8E0 @ =0x000001ff
_080BB8C6:
	lsls r0, r2, 1
	adds r0, r4
	ldrh r1, [r0]
...
sub_80BB800: @ 80BB994
	...
	lsls r0, 16
	asrs r3, r0, 16
	ldr r1, _080BB9E0 @ =gUnknown_083D1358
	mov r8, r1
	adds r7, r0, 0
	mov r4, sp
	mov r6, r12
_080BB9C8:
	ldr r0, _080BB9E0 @ =gUnknown_083D1358
	lsls r1, r5, 2
	adds r2, r1, r0
	ldrh r0, [r2]
	cmp r0, r3
...
sub_80BB8CC: @ 80BBA60
	...
	ldr r0, _080BBAE0 @ =gUnknown_020387DC
	ldrb r1, [r0]
	ldr r3, _080BBAE4 @ =0x00001a08
	adds r0, r2, r3
	strb r1, [r0]
	movs r3, 0
	ldr r0, _080BBAE8 @ =0x00001a11
	adds r2, r0
	ldr r4, _080BBAEC @ =0x02024eae
_080BBA76:
	adds r1, r3, r2
	adds r0, r3, r4
	ldrb r0, [r0]
	...
	cmp r3, 0x3
	bls _080BBA76
	ldr r0, _080BBAF0 @ =0x00004054
	movs r1, 0
	bl VarSet
	ldr r6, _080BBAF4 @ =gSaveBlock2
	adds r0, r6, 0
	bl sub_80BB8A8
	adds r4, r0, 0
	lsls r4, 24
	lsrs r4, 24
	ldr r5, _080BBAF8 @ =0x0202713e
	adds r0, r5, 0
	movs r1, 0xFF
	movs r2, 0x7
	bl memset
	...
	orrs r0, r1
	strb r0, [r5]
	ldr r0, _080BBAFC @ =0x00004026
	ldr r1, _080BBB00 @ =gMapHeader
	ldrb r1, [r1, 0x14]
	bl VarSet
	pop {r4-r6}
	pop {r0}
...
_080BBB24:
	...
	asrs r4, r0, 16
_080BBB4A:
	ldr r0, _080BBB7C @ =gUnknown_083D1358
	lsls r1, r3, 2
	adds r2, r1, r0
	ldrh r0, [r2]
	cmp r0, r4
...
sub_80BBA14: @ 80BBBA8
	push {lr}
	ldr r0, _080BBBD4 @ =gUnknown_020387DC
	ldrb r0, [r0]
	movs r1, 0xA
	bl __udivsi3
	ldr r2, _080BBBD8 @ =gUnknown_083D1374
	lsls r0, 26
	asrs r0, 24
	adds r1, r0, r2
	ldrb r1, [r1]
...
_080BBC28:
	ldr r0, _080BBC6C @ =0x00004054
	bl VarGet
	lsls r0, 16
	lsrs r0, 16
	ldr r2, _080BBC70 @ =gSaveBlock1
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 5
	adds r1, r2
	ldr r0, _080BBC74 @ =0x00001a18
	adds r1, r0
	ldrb r0, [r1]
	cmp r0, 0xFE
	bhi _080BBC4A
...
_080BBC4A:
	bl sub_80BBA14
	bl warp_in
	ldr r0, _080BBC78 @ =gUnknown_0300485C
	ldr r1, _080BBC7C @ =sub_8080990
	str r1, [r0]
	ldr r0, _080BBC80 @ =CB2_LoadMap
	bl SetMainCallback2
	adds r0, r4, 0
	bl DestroyTask
_080BBC64:
...
sub_80BBAF0: @ 80BBC84
	push {lr}
	ldr r0, _080BBCB0 @ =sub_80BBA48
	movs r1, 0
	bl CreateTask
	movs r0, 0x1
	movs r1, 0
	bl fade_screen
	ldr r0, _080BBCB4 @ =gSaveBlock1
	movs r1, 0x4
	ldrsb r1, [r0, r1]
	movs r2, 0x5
	ldrsb r2, [r0, r2]
...
sub_80BBB24: @ 80BBCB8
	push {lr}
	ldr r0, _080BBCD4 @ =gMapHeader
	ldrb r0, [r0, 0x17]
	cmp r0, 0x9
	bne _080BBCDC
	ldr r0, _080BBCD8 @ =0x00004097
	bl VarGet
	lsls r0, 16
	cmp r0, 0
	bne _080BBCDC
...
sub_80BBB50: @ 80BBCE4
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r0, _080BBD1C @ =gPlayerAvatar
	ldrb r1, [r0, 0x5]
	lsls r0, r1, 3
	adds r0, r1
	lsls r0, 2
	ldr r1, _080BBD20 @ =gMapObjects
	adds r0, r1
	movs r1, 0x2
	bl FieldObjectTurn
	bl sub_807D770
...
sub_80BBBEC: @ 80BBD80
	...
	lsls r0, 24
	lsrs r6, r0, 24
	ldr r0, _080BBDF0 @ =gPaletteFade
	ldrb r1, [r0, 0x7]
	movs r0, 0x80
	ands r0, r1
	cmp r0, 0
	bne _080BBDE6
	ldr r0, _080BBDF4 @ =gUnknown_020387DC
	ldrb r0, [r0]
	movs r1, 0xA
	bl __udivsi3
	ldr r1, _080BBDF8 @ =gSaveBlock1
	movs r5, 0x4
	ldrsb r5, [r1, r5]
	ldrb r1, [r1, 0x5]
	lsls r1, 24
	...
	movs r2, 0x1
	negs r2, r2
	ldr r4, _080BBDFC @ =gUnknown_083D1374
	lsls r0, 26
	asrs r0, 24
	adds r3, r0, 0x2
	adds r3, r4
	...
	bl warp1_set
	bl warp_in
	ldr r1, _080BBE00 @ =gUnknown_0300485C
	ldr r0, _080BBE04 @ =sub_80BBB90
	str r0, [r1]
	ldr r0, _080BBE08 @ =CB2_LoadMap
	bl SetMainCallback2
	adds r0, r6, 0
	bl DestroyTask
_080BBDE6:
...
sub_80BBC78: @ 80BBE0C
	push {lr}
	ldr r0, _080BBE34 @ =sub_80BBBEC
	movs r1, 0
	bl CreateTask
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _080BBE38 @ =gTasks
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 3
	adds r1, r2
...
sub_80BBCCC: @ 80BBE60
	...
	mov r0, sp
	strh r1, [r0]
	ldr r6, _080BBF08 @ =gSaveBlock1
	mov r4, sp
	ldr r0, _080BBF0C @ =0x00001a2a
	adds r7, r6, r0
_080BBE90:
	lsls r0, r5, 2
	adds r0, r5
...
_080BBFE2:
	...
	ldr r0, [r2, 0x4]
	ldrh r1, [r0, 0x14]
	ldr r4, _080BC120 @ =gSpecialVar_0x8004
	ldrh r0, [r4]
	adds r0, 0xAE
	adds r7, r4, 0
	cmp r1, r0
...
_080BC022:
	...
	cmp r5, r0
	beq _080BC0F2
	ldr r7, _080BC124 @ =gSpecialVar_0x8006
	ldr r2, [sp, 0x8]
	adds r1, r2, r6
	ldrb r0, [r1]
	lsrs r0, 4
	strh r0, [r7]
	ldr r6, _080BC128 @ =gSpecialVar_0x8007
	ldrb r1, [r1]
	movs r0, 0xF
	ands r0, r1
	strh r0, [r6]
...
_080BC06E:
	...
	lsls r4, 3
	adds r1, r4, r1
	ldr r5, _080BC12C @ =0x00003f20
	adds r0, r5, 0
	ldrb r1, [r1, 0x1]
	adds r0, r1
	ldr r1, _080BC130 @ =gScriptResult
	strh r0, [r1]
	ldrh r0, [r1]
	mov r2, r9
	ldrb r1, [r2]
	lsls r1, 5
	ldr r3, _080BC134 @ =0x083f7c0c
	adds r1, r3
	ldr r1, [r1]
	ldrh r1, [r1]
	bl VarSet
	...
	ldr r1, _080BC130 @ =gScriptResult
	strh r0, [r1]
	ldr r2, _080BC120 @ =gSpecialVar_0x8004
	ldrh r0, [r2]
	adds r0, 0xAE
	lsls r0, 16
	lsrs r0, 16
	bl FlagReset
	ldr r3, _080BC130 @ =gScriptResult
	ldrb r0, [r3]
	mov r4, r10
	ldrb r1, [r4, 0x5]
	ldrb r2, [r4, 0x4]
	bl show_sprite
	ldr r5, _080BC130 @ =gScriptResult
	ldrb r0, [r5]
	ldrb r1, [r4, 0x5]
	ldrb r2, [r4, 0x4]
	movs r4, 0
	...
	ldrb r2, [r2, 0x4]
	bl sub_805C78C
	ldr r3, _080BC120 @ =gSpecialVar_0x8004
	ldrh r0, [r3]
	adds r0, 0x1
	strh r0, [r3]
_080BC0F2:
...
sub_80BBFA4: @ 80BC138
	push {r4,r5,lr}
	ldr r0, _080BC160 @ =0x00004054
	bl VarGet
	ldr r5, _080BC164 @ =0x0000401f
	ldr r4, _080BC168 @ =gUnknown_083D13EC
	lsls r0, 24
	lsrs r0, 24
	bl sub_80BCCA4
	lsls r0, 24
...
sub_80BBFD8: @ 80BC16C
	...
	cmp r3, r0
	bge _080BC1C4
	ldr r6, _080BC1B0 @ =gUnknown_020387DC
_080BC17C:
	lsls r3, 16
	asrs r1, r3, 16
	ldr r2, [r4, 0x10]
...
sub_80BC038: @ 80BC1CC
	...
	bl sub_80BBFD8
	bl sub_80BB5E4
	ldr r0, _080BC1E0 @ =gUnknown_081A2E14
...
sub_80BC050: @ 80BC1E4
	...
	bl sub_80BB5D0
	bl sub_80BB5E4
	ldr r0, _080BC1FC @ =gScriptResult
	ldrh r0, [r0]
	cmp r0, 0x1
	beq _080BC200
	movs r0, 0x1
...
_080BC258:
	...
	bl warp_in
	ldr r0, _080BC280 @ =gUnknown_0300485C
	ldr r1, _080BC284 @ =mapldr_default
	str r1, [r0]
	ldr r0, _080BC288 @ =CB2_LoadMap
	bl SetMainCallback2
...
sub_80BC114: @ 80BC2A8
	push {lr}
	ldr r0, _080BC2C0 @ =gSaveBlock1
	ldr r1, _080BC2C4 @ =0x00001a08
	adds r0, r1
	ldr r1, _080BC2C8 @ =gUnknown_020387DC
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	beq _080BC2D0
	ldr r1, _080BC2CC @ =gScriptResult
	movs r0, 0x1
	b _080BC2D4
	.align 2, 0
...
_080BC2D0:
	ldr r1, _080BC2DC @ =gScriptResult
	movs r0, 0
_080BC2D4:
	strh r0, [r1]
	pop {r0}
...
sub_80BC14C: @ 80BC2E0
	...
	lsrs r3, r0, 24
	movs r2, 0
	ldr r5, _080BC308 @ =gSaveBlock1
	ldr r4, _080BC30C @ =0x00001a08
_080BC2EC:
	lsls r0, r2, 16
	asrs r1, r0, 16
	lsls r0, r1, 2
...
sub_80BC190: @ 80BC324
	...
	movs r1, 0xFF
	strb r1, [r0]
	ldr r1, _080BC360 @ =gOtherText_PlayersBase
	adds r0, r5, 0
	bl de_sub_8073174
	pop {r4,r5}
	pop {r1}
...
GetSecretBaseMapName: @ 80BC364
	...
	push {r6}
	mov r8, r0
	ldr r6, _080BC3A8 @ =gUnknown_020387DC
	ldr r5, _080BC3AC @ =gSaveBlock1
	ldr r4, _080BC3B0 @ =0x00004054
	adds r0, r4, 0
	bl VarGet
	lsls r0, 16
	lsrs r0, 16
...
sub_80BC224: @ 80BC3B8
	...
	adds r4, r0
	lsls r4, 5
	ldr r0, _080BC3F4 @ =0x0202713e
	adds r4, r0
	ldr r5, _080BC3F8 @ =gStringVar1
	adds r0, r4, 0
	bl sub_80BB8A8
	adds r2, r0, 0
	lsls r2, 24
...
sub_80BC268: @ 80BC3FC
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _080BC41C @ =gSaveBlock1
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 5
	adds r1, r2
	ldr r0, _080BC420 @ =0x00001a09
	adds r1, r0
	ldrb r0, [r1]
	lsrs r0, 6
	cmp r0, 0
...
_080BC4B6:
	...
	cmp r4, 0x3
	bls _080BC4B6
	ldr r1, _080BC5C0 @ =0x020271b8
	adds r0, r1, r2
	strh r5, [r0]
	ldr r5, _080BC5C4 @ =0x020271c4
	adds r0, r5, r2
	mov r1, r9
	strh r1, [r0]
	ldr r2, _080BC5C8 @ =0x020271d0
	adds r0, r2, r6
	mov r5, r9
	strb r5, [r0]
	ldr r1, _080BC5CC @ =0x02027170
	adds r0, r1, r3
	mov r2, r9
	str r2, [r0]
	ldr r3, _080BC5D0 @ =0x020271d6
	adds r0, r3, r6
	strb r2, [r0]
	movs r0, 0x64
	adds r5, r6, 0
...
_080BC522:
	...
	adds r4, r6, 0
	muls r4, r0
	ldr r0, _080BC5B8 @ =gPlayerParty
	adds r4, r0
	adds r0, r4, 0
	movs r1, 0xB
	bl GetMonData
	ldr r5, _080BC5C0 @ =0x020271b8
	adds r1, r5, r7
	strh r0, [r1]
	adds r0, r4, 0
	movs r1, 0xC
	bl GetMonData
	ldr r2, _080BC5C4 @ =0x020271c4
	adds r1, r2, r7
	strh r0, [r1]
	adds r0, r4, 0
	movs r1, 0x38
	bl GetMonData
	ldr r1, _080BC5C8 @ =0x020271d0
	add r1, r10
	strb r0, [r1]
	adds r0, r4, 0
	movs r1, 0
...
sub_80BC440: @ 80BC5D4
	push {r4,r5,lr}
	ldr r4, _080BC5F0 @ =gSaveBlock1
	ldr r0, _080BC5F4 @ =0x00001a16
	adds r4, r0
	ldrh r5, [r4]
	movs r0, 0
	bl sub_80BB594
...
sub_80BC474: @ 80BC608
	push {r4-r7,lr}
	ldr r0, _080BC660 @ =gMapHeader
	ldr r4, [r0, 0x4]
	movs r6, 0
	ldrb r0, [r4, 0x3]
	cmp r6, r0
	bcs _080BC698
	ldr r3, _080BC664 @ =0x0202713c
_080BC618:
	ldr r2, [r4, 0x10]
	lsls r1, r6, 1
	adds r0, r1, r6
	...
	bl MapGridGetMetatileIdAt
	movs r1, 0
	ldr r5, _080BC668 @ =gUnknown_083D1358
	lsls r0, 16
	asrs r2, r0, 16
_080BC646:
	lsls r0, r1, 2
...
sub_80BC50C: @ 80BC6A0
	...
	movs r0, 0x14
	bl sav12_xor_increment
	ldr r4, _080BC6C4 @ =gSaveBlock1
	ldr r0, _080BC6C8 @ =0x00001a16
	adds r4, r0
	ldrh r5, [r4]
	movs r0, 0
	bl sub_80BB594
...
sub_80BC56C: @ 80BC700
	push {lr}
	ldr r0, _080BC720 @ =gUnknown_020387DC
	ldrb r0, [r0]
	bl sub_80BC14C
	lsls r0, 24
	lsrs r0, 24
	...
	cmp r1, 0x1
	bne _080BC728
	ldr r0, _080BC724 @ =gScriptResult
	strh r1, [r0]
	b _080BC746
	.align 2, 0
...
_080BC728:
	...
	cmp r0, 0x9
	bls _080BC740
	ldr r1, _080BC73C @ =gScriptResult
	movs r0, 0x2
	b _080BC744
	.align 2, 0
_080BC73C: .4byte gScriptResult
_080BC740:
	ldr r1, _080BC74C @ =gScriptResult
	movs r0, 0
_080BC744:
	strh r0, [r1]
_080BC746:
...
sub_80BC5BC: @ 80BC750
	push {lr}
	ldr r0, _080BC78C @ =gUnknown_020387DC
	ldrb r0, [r0]
	bl sub_80BC14C
	ldr r2, _080BC790 @ =gSaveBlock1
	lsls r0, 24
	lsrs r0, 24
	lsls r1, r0, 2
	adds r1, r0
...
SecretBasePC_Decoration: @ 80BC798
	push {lr}
	ldr r0, _080BC7A8 @ =Task_SecretBasePC_Decoration
	movs r1, 0
	bl CreateTask
	pop {r0}
	bx r0
...
SecretBasePC_Registry: @ 80BC7AC
	push {lr}
	ldr r0, _080BC7BC @ =Task_SecretBasePC_Registry
	movs r1, 0
	bl CreateTask
	pop {r0}
	bx r0
...
_080BC7F2:
	...
	adds r0, r5, 0
	bl sub_80BC7D8
	ldr r1, _080BC820 @ =gTasks
	lsls r0, r5, 2
	adds r0, r5
	lsls r0, 3
	adds r0, r1
	ldr r1, _080BC824 @ =sub_80BC824
	str r1, [r0]
	b _080BC834
	.align 2, 0
...
_080BC828:
	ldr r1, _080BC83C @ =gSecretBaseText_NoRegistry
	ldr r2, _080BC840 @ =sub_80BCC54
	adds r0, r5, 0
	movs r3, 0
...
_080BC8EE:
	...
	movs r2, 0x1C
	bl MenuFillWindowRectWithBlankTile
	ldr r0, _080BC938 @ =gUnknownText_Exit
	movs r1, 0x12
	adds r2, r4, 0
	bl MenuPrint
	movs r0, 0x1
...
sub_80BC824: @ 80BC9B8
	...
	adds r0, r5
	lsls r0, 3
	ldr r1, _080BC9EC @ =0x03004b38
	adds r4, r0, r1
	ldr r2, _080BC9F0 @ =gMain
	ldrh r1, [r2, 0x30]
	movs r0, 0x40
	ands r0, r1
	cmp r0, 0
...
sub_80BC980: @ 80BCB14
	...
	movs r3, 0x5
	bl MenuDrawTextWindow
	ldr r3, _080BCB6C @ =gUnknown_083D13D4
	movs r0, 0x2
	movs r1, 0x1
	movs r2, 0x2
	bl PrintMenuItems
	...
	movs r3, 0x2
	bl InitMenu
	ldr r1, _080BCB70 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080BCB74 @ =sub_80BC9E4
	str r1, [r0]
	add sp, 0x8
	pop {r4}
	pop {r0}
...
_080BCBCE:
	...
	movs r0, 0x5
	bl PlaySE
	ldr r4, _080BCBF8 @ =gUnknown_083D13D4
	bl GetMenuCursorPos
	lsls r0, 24
	lsrs r0, 21
	adds r4, 0x4
...
sub_80BCA84: @ 80BCC18
	...
	movs r3, 0x13
	bl MenuZeroFillWindowRect
	ldr r0, _080BCC70 @ =gStringVar1
	ldrb r1, [r4, 0x8]
	bl sub_80BC190
	ldr r4, _080BCC74 @ =gStringVar4
	ldr r1, _080BCC78 @ =gOtherText_OkayToDeleteFromRegistry
	adds r0, r4, 0
	bl StringExpandPlaceholders
	ldr r2, _080BCC7C @ =sub_80BCAEC
	adds r0, r5, 0
	adds r1, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
...
sub_80BCAEC: @ 80BCC80
	...
	movs r2, 0x1
	bl DisplayYesNoMenu
	ldr r1, _080BCCA0 @ =gUnknown_083D13E4
	adds r0, r4, 0
	bl sub_80F914C
	pop {r4}
	pop {r0}
...
sub_80BCB90: @ 80BCD24
	...
	movs r3, 0xD
	bl MenuZeroFillWindowRect
	ldr r1, _080BCD4C @ =gOtherText_RegisteredDataDeleted
	ldr r2, _080BCD50 @ =sub_80BCB10
	adds r0, r4, 0
	movs r3, 0
	bl DisplayItemMessageOnField
	pop {r4}
...
sub_80BCBC0: @ 80BCD54
	...
	adds r0, r4, 0
	bl sub_80BC7D8
	ldr r1, _080BCD84 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
	ldr r1, _080BCD88 @ =sub_80BC824
	str r1, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
sub_80BCC54: @ 80BCDE8
	...
	cmp r4, 0
	bne _080BCE20
	ldr r0, _080BCE1C @ =gUnknown_0815F399
	bl ScriptContext1_SetupScript
	b _080BCE26
	.align 2, 0
...
_080BCE20:
	ldr r0, _080BCE34 @ =gUnknown_0815F49A
	bl ScriptContext1_SetupScript
_080BCE26:
	adds r0, r5, 0
	bl DestroyTask
...
sub_80BCCA4: @ 80BCE38
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r1, _080BCE70 @ =gSaveBlock1
	lsls r4, r0, 2
	adds r4, r0
	lsls r4, 5
	adds r4, r1
	ldr r1, _080BCE74 @ =0x00001a11
	adds r0, r4, r1
	ldrb r0, [r0]
	movs r1, 0x5
	bl __umodsi3
	ldr r1, _080BCE78 @ =0x00001a09
	adds r4, r1
	ldrb r2, [r4]
	lsls r2, 27
	lsrs r2, 31
...
sub_80BCCE8: @ 80BCE7C
	...
	cmp r0, 0
	bne _080BCEA4
	ldr r0, _080BCEA0 @ =UnknownString_81A1BB2
	b _080BCF06
	.align 2, 0
...
_080BCEA4:
	cmp r0, 0x1
	bne _080BCEB0
	ldr r0, _080BCEAC @ =UnknownString_81A1F67
	b _080BCF06
	.align 2, 0
...
_080BCEB0:
	cmp r0, 0x2
	bne _080BCEBC
	ldr r0, _080BCEB8 @ =UnknownString_81A2254
	b _080BCF06
	.align 2, 0
...
_080BCEBC:
	cmp r0, 0x3
	bne _080BCEC8
	ldr r0, _080BCEC4 @ =UnknownString_81A25C3
	b _080BCF06
	.align 2, 0
...
_080BCEC8:
	cmp r0, 0x4
	bne _080BCED4
	ldr r0, _080BCED0 @ =UnknownString_81A2925
	b _080BCF06
	.align 2, 0
...
_080BCED4:
	cmp r0, 0x5
	bne _080BCEE0
	ldr r0, _080BCEDC @ =UnknownString_81A1D74
	b _080BCF06
	.align 2, 0
...
_080BCEE0:
	cmp r0, 0x6
	bne _080BCEEC
	ldr r0, _080BCEE8 @ =UnknownString_81A20C9
	b _080BCF06
	.align 2, 0
...
_080BCEEC:
	cmp r0, 0x7
	bne _080BCEF8
	ldr r0, _080BCEF4 @ =UnknownString_81A2439
	b _080BCF06
	.align 2, 0
...
_080BCEF8:
	cmp r1, 0x8
	beq _080BCF04
	ldr r0, _080BCF00 @ =UnknownString_81A2B2A
	b _080BCF06
	.align 2, 0
_080BCF00: .4byte UnknownString_81A2B2A
_080BCF04:
	ldr r0, _080BCF0C @ =UnknownString_81A2754
_080BCF06:
	pop {r1}
	bx r1
	.align 2, 0
...
unref_sub_80BCD7C: @ 80BCF10
	...
	lsrs r0, 24
	movs r5, 0
	ldr r7, _080BCF90 @ =gSaveBlock1
	lsls r1, r0, 2
	adds r1, r0
	lsls r6, r1, 5
	ldr r0, _080BCF94 @ =0x00001a3c
	adds r0, r7
	mov r10, r0
	ldr r1, _080BCF98 @ =0x00001a54
	adds r1, r7
	mov r9, r1
	ldr r2, _080BCF9C @ =0x00001a84
	adds r2, r7
	mov r8, r2
	ldr r0, _080BCFA0 @ =0x00000115
	mov r12, r0
_080BCF3E:
	lsls r4, r5, 2
	adds r0, r4, r6
	...
	mov r2, r12
	strh r2, [r0]
	ldr r2, _080BCFA4 @ =0x00001a90
	adds r0, r7, r2
	adds r1, r0
	strh r3, [r1]
	adds r2, r5, r6
	ldr r1, _080BCFA8 @ =0x00001a9c
	adds r0, r7, r1
	adds r0, r2, r0
	adds r1, r5, 0x5
	strb r1, [r0]
	ldr r1, _080BCFAC @ =0x00001aa2
	adds r0, r7, r1
	adds r2, r0
	adds r4, r5
	strb r4, [r2]
...
sub_80BCE4C: @ 80BCFE0
	push {lr}
	ldr r0, _080BD014 @ =0x00004054
	bl VarGet
	ldr r2, _080BD018 @ =gSaveBlock1
	lsls r0, 16
	lsrs r0, 16
	lsls r1, r0, 2
	adds r1, r0
	lsls r1, 5
	adds r1, r2
	ldr r0, _080BD01C @ =gScriptResult
	ldrb r0, [r0]
	ldr r2, _080BD020 @ =0x00001a09
	adds r1, r2
	movs r2, 0x1
	ands r2, r0
	lsls r2, 5
...
sub_80BCE90: @ 80BD024
	push {r4-r7,lr}
	ldr r0, _080BD098 @ =0x00004054
	bl VarGet
	lsls r0, 16
	lsrs r5, r0, 16
	ldr r0, _080BD09C @ =0x000008c2
	bl FlagGet
	lsls r0, 24
	cmp r0, 0
	bne _080BD068
	movs r3, 0
	ldr r7, _080BD0A0 @ =gSaveBlock1
	ldr r4, _080BD0A4 @ =0x00001a09
	movs r6, 0x21
	negs r6, r6
_080BD046:
	lsls r1, r3, 2
	...
	bl FlagSet
_080BD068:
	ldr r4, _080BD0A8 @ =gSpecialVar_0x8004
	lsls r0, r5, 24
	lsrs r0, 24
	bl sub_80BCCA4
	lsls r0, 24
	lsrs r0, 24
	strh r0, [r4]
	ldr r2, _080BD0AC @ =gScriptResult
	ldr r1, _080BD0A0 @ =gSaveBlock1
	lsls r0, r5, 2
	adds r0, r5
	lsls r0, 5
	adds r0, r1
	ldr r1, _080BD0A4 @ =0x00001a09
	adds r0, r1
	ldrb r0, [r0]
	lsls r0, 26
	lsrs r0, 31
...
sub_80BD034: @ 80BD1C8
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _080BD1F8 @ =gSaveBlock1
	lsls r4, r0, 2
	adds r4, r0
	lsls r4, 5
	adds r4, r2
	ldr r2, _080BD1FC @ =0x00001a08
	adds r0, r4, r2
	movs r2, 0xA0
	bl memcpy
	ldr r0, _080BD200 @ =0x00001a09
	adds r4, r0
	ldrb r1, [r4]
	movs r0, 0x3F
	ands r0, r1
...
sub_80BD12C: @ 80BD2C0
	...
	lsrs r2, r0, 24
	movs r1, 0
	ldr r4, _080BD2E4 @ =gSaveBlock1
	ldr r3, _080BD2E8 @ =0x00001a08
_080BD2CC:
	lsls r0, r1, 16
	asrs r1, r0, 16
	lsls r0, r1, 2
...
sub_80BD170: @ 80BD304
	push {r4,lr}
	movs r2, 0x1
	ldr r4, _080BD328 @ =gSaveBlock1
	ldr r3, _080BD32C @ =0x00001a08
_080BD30C:
	lsls r0, r2, 16
	asrs r1, r0, 16
	lsls r0, r1, 2
...
sub_80BD1FC: @ 80BD390
	...
	cmp r2, r0
	beq _080BD3E8
	ldr r0, _080BD3E0 @ =gSaveBlock1
	lsls r1, r2, 2
	adds r1, r2
	lsls r1, 5
	adds r1, r0
	ldr r0, _080BD3E4 @ =0x00001a09
	adds r1, r0
	ldrb r1, [r1]
	lsls r0, r1, 28
	lsrs r0, 28
...
_080BD8B0:
	movs r3, 0x1
	ldr r6, _080BD92C @ =gSaveBlock1
	movs r5, 0x10
	negs r5, r5
	ldr r4, _080BD930 @ =0x00001a09
_080BD8BA:
	lsls r0, r3, 2
	adds r0, r3
	lsls r0, 5
...
_080BD8DA:
	...
	bl sub_80BD280
	movs r3, 0x1
	ldr r4, _080BD92C @ =gSaveBlock1
	ldr r6, _080BD930 @ =0x00001a09
	adds r7, r4, 0
	movs r5, 0x3F
_080BD8F2:
	lsls r0, r3, 2
...
_080BD90A:
	...
	cmp r3, 0x13
	bls _080BD8F2
	ldr r0, _080BD934 @ =0x00001a16
	adds r2, r7, r0
	ldrh r1, [r2]
	ldr r0, _080BD938 @ =0x0000ffff
	cmp r1, r0
	beq _080BD924
	adds r0, r1, 0x1
	strh r0, [r2]
