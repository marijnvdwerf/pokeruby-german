...
_08094E6E:
	lsls r0, 2
	ldr r1, _08094E7C @ =_08094FD0
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08094E78: .4byte 0x0201b000
_08094E7C: .4byte _08094FD0
	.align 2, 0
_08094E80:
	.4byte _08094EAC
	.4byte _08094F28
...
_08095ECE:
	lsls r0, 2
	ldr r1, _08095EDC @ =_08096030
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08095ED8: .4byte gTasks
_08095EDC: .4byte _08096030
	.align 2, 0
_08095EE0:
	.4byte _08095EF4
	.4byte _08095F1C
...
_08096C90:
	lsls r0, 2
	ldr r1, _08096CA0 @ =_08096DF4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08096C9C: .4byte 0x02000000
_08096CA0: .4byte _08096DF4
	.align 2, 0
_08096CA4:
	.4byte _08096CC0
	.4byte _08096EE0
...
_08096CD0:
	lsls r0, 2
	ldr r1, _08096CDC @ =_08096E30
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08096CDC: .4byte _08096E30
	.align 2, 0
_08096CE0:
	.4byte _08096D20
	.4byte _08096FBA
...
_08097084:
	lsls r0, 2
	ldr r1, _08097094 @ =_080971E8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08097090: .4byte 0x02000000
_08097094: .4byte _080971E8
	.align 2, 0
_08097098:
	.4byte _080970B0
	.4byte _080970C8
...
_080970D8:
	lsls r0, 2
	ldr r1, _080970E4 @ =_08097238
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080970E4: .4byte _08097238
	.align 2, 0
_080970E8:
	.4byte _08097110
	.4byte _08097110
...
sub_8097390: @ 8097390
	...
	bhi _08097462
	lsls r0, 2
	ldr r1, _080973A8 @ =_080974FC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080973A4: .4byte 0x02000000
_080973A8: .4byte _080974FC
	.align 2, 0
_080973AC:
	.4byte _080973C4
	.4byte _080973FC
...
_08097478:
	lsls r0, 2
	ldr r1, _08097488 @ =_080975DC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08097484: .4byte 0x02000000
_08097488: .4byte _080975DC
	.align 2, 0
_0809748C:
	.4byte _080974A0
	.4byte _080974D8
...
_080975A0:
	lsls r0, 2
	ldr r1, _080975B0 @ =_08097704
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080975AC: .4byte 0x02000000
_080975B0: .4byte _08097704
	.align 2, 0
_080975B4:
	.4byte _080975EC
	.4byte _08097600
...
_080978C2:
	...
	bhi _08097968
	lsls r0, 2
	ldr r1, _080978DC @ =_08097A30
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080978DC: .4byte _08097A30
	.align 2, 0
_080978E0:
	.4byte _08097914
	.4byte _08097914
...
_08097BAE:
	lsls r0, r1, 2
	ldr r1, _08097BBC @ =_08097D10
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08097BB8: .4byte 0x02000000
_08097BBC: .4byte _08097D10
	.align 2, 0
_08097BC0:
	.4byte _08097BD4
	.4byte _08097C18
...
_08097CCE:
	lsls r0, r1, 2
	ldr r1, _08097CDC @ =_08097E30
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08097CD8: .4byte 0x02000000
_08097CDC: .4byte _08097E30
	.align 2, 0
_08097CE0:
	.4byte _08097CF4
	.4byte _08097D38
...
_080988B8:
	lsls r0, 2
	ldr r1, _080988C8 @ =_08098A1C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080988C4: .4byte gUnknown_083B6DF4
_080988C8: .4byte _08098A1C
	.align 2, 0
_080988CC:
	.4byte _080989F8
	.4byte _08098930
...
_08098954:
	ldr r4, _08098970 @ =0x02002694
	adds r1, r4, 0
	adds r1, 0x50
	adds r0, r4, 0
	bl StringCopy
	ldr r1, _08098974 @ =gUnknown_083B6DF4
	lsls r0, r5, 3
	adds r0, r1
	ldr r1, [r0]
	adds r0, r4, 0
	...
	b _08098A06
	.align 2, 0
_08098970: .4byte 0x02002694
_08098974: .4byte gUnknown_083B6DF4
_08098978:
	ldr r1, _080989B0 @ =gUnknown_083B6DF4
	lsls r0, r5, 3
	adds r0, r1
	ldr r6, [r0]
	adds r0, r6, 0
	...
	adds r4, r6, r4
	adds r4, 0x1
	ldr r5, _080989B4 @ =0x02002694
	adds r0, r5, 0
	adds r1, r6, 0
	bl StringCopy
	adds r2, r0, 0
	ldr r0, _080989B8 @ =0xffffeb66
	adds r5, r0
	adds r0, r2, 0
	adds r1, r5, 0
	bl StringCopy
	...
	b _08098A02
	.align 2, 0
_080989B0: .4byte gUnknown_083B6DF4
_080989B4: .4byte 0x02002694
_080989B8: .4byte 0xffffeb66
_080989BC:
	ldr r1, _080989F0 @ =gUnknown_083B6DF4
	lsls r0, r5, 3
	adds r0, r1
	ldr r6, [r0]
	adds r0, r6, 0
	...
	b _08098A02
	.align 2, 0
_080989F0: .4byte gUnknown_083B6DF4
_080989F4: .4byte 0x02002694
_080989F8:
	ldr r0, _08098A30 @ =0x02002694
	ldr r2, _08098A34 @ =gUnknown_083B6DF4
	lsls r1, r5, 3
	adds r1, r2
	ldr r1, [r1]
_08098A02:
...
_08098A1C:
	...
	bx r0
	.align 2, 0
_08098A30: .4byte 0x02002694
_08098A34: .4byte gUnknown_083B6DF4
_08098A38: .4byte 0x020026a6
...
sub_809A8C8: @ 809A8C8
	...
	bhi _0809A994
	lsls r0, 2
	ldr r1, _0809A8E0 @ =_0809AA38
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809A8E0: .4byte _0809AA38
	.align 2, 0
_0809A8E4:
	.4byte _0809A8F8
	.4byte _0809A8FE
...
sub_809AACC: @ 809AACC
	...
	bhi _0809AB84
	lsls r0, 2
	ldr r1, _0809AAE8 @ =_0809AC40
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809AAE8: .4byte _0809AC40
	.align 2, 0
_0809AAEC:
	.4byte _0809AB00
	.4byte _0809AB2E
...
_0809C58C:
	...
	bhi _0809C5D4
	lsls r0, 2
	ldr r1, _0809C5A8 @ =_0809C700
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809C5A8: .4byte _0809C700
	.align 2, 0
_0809C5AC:
	.4byte _0809C5C0
	.4byte _0809C5C4
...
_0809C788:
	...
	bhi _0809C7D0
	lsls r0, 2
	ldr r1, _0809C7A4 @ =_0809C8FC
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809C7A4: .4byte _0809C8FC
	.align 2, 0
_0809C7A8:
	.4byte _0809C7BC
	.4byte _0809C7C0
...
_0809D90E:
	...
	bhi _0809D9D6
	lsls r0, r7, 2
	ldr r1, _0809D91C @ =_0809DA74
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809D91C: .4byte _0809DA74
	.align 2, 0
_0809D920:
	.4byte _0809D93C
	.4byte _0809D9BC
...
sub_809DA1C: @ 809DA1C
	...
	bhi _0809DA78
	lsls r0, 2
	ldr r1, _0809DA34 @ =_0809DB8C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809DA30: .4byte 0x02018000
_0809DA34: .4byte _0809DB8C
	.align 2, 0
_0809DA38:
	.4byte _0809DA54
	.4byte _0809DA6C
...
_0809DF0E:
	lsls r0, 2
	ldr r1, _0809DF1C @ =_0809E074
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809DF18: .4byte 0x02018000
_0809DF1C: .4byte _0809E074
	.align 2, 0
_0809DF20:
	.4byte _0809DF54
	.4byte _0809DF64
...
_0809EC52:
	lsls r0, 2
	ldr r1, _0809EC60 @ =_0809EDB8
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809EC5C: .4byte 0x03004b38
_0809EC60: .4byte _0809EDB8
	.align 2, 0
_0809EC64:
	.4byte _0809EC7C
	.4byte _0809ED14
...
_0809EE8E:
	lsls r0, 2
	ldr r1, _0809EE9C @ =_0809EFF4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0809EE98: .4byte 0x03004b38
_0809EE9C: .4byte _0809EFF4
	.align 2, 0
_0809EEA0:
	.4byte _0809EEBC
	.4byte _0809EEE0
...
sub_80A0798: @ 80A0798
	...
	lsrs r2, 24
	mov r8, r2
	ldr r5, _080A0834 @ =gStringVar4
	bl GetNature
	adds r4, r0, 0
	lsls r4, 24
	lsrs r4, 24
	ldr r1, _080A0838 @ =gOtherText_Nature
	adds r0, r5, 0
	bl StringCopy
	adds r5, r0, 0
	ldr r0, _080A083C @ =gNatureNames
	lsls r4, 2
	adds r4, r0
	ldr r1, [r4]
	adds r0, r5, 0
	...
	bl sub_80A1E9C
	adds r5, r0, 0
	ldr r1, _080A0848 @ =gOtherText_Egg2
	bl StringCopy
	b _080A0930
	.align 2, 0
_080A0834: .4byte gStringVar4
_080A0838: .4byte gOtherText_Nature
_080A083C: .4byte gNatureNames
_080A0840: .4byte gOtherText_Terminator4
_080A0844: .4byte gStringVar1
_080A0848: .4byte gOtherText_Egg2
_080A084C:
	cmp r6, 0x57
	bhi _080A08E4
	adds r0, r7, 0
	...
	bl sub_80A1E9C
	adds r5, r0, 0
	ldr r1, _080A0890 @ =gOtherText_Met
	bl StringCopy
	b _080A0930
	.align 2, 0
_080A088C: .4byte gStringVar1
_080A0890: .4byte gOtherText_Met
_080A0894:
	adds r0, r7, 0
	movs r1, 0x25
	bl GetMonData
	...
	strb r0, [r5]
	adds r5, 0x1
	ldr r1, _080A08DC @ =gOtherText_FatefulEncounter
	b _080A08EC
	.align 2, 0
_080A08DC: .4byte gOtherText_FatefulEncounter
_080A08E0:
	cmp r6, 0x57
	bls _080A08F8
_080A08E4:
	...
	strb r0, [r5]
	adds r5, 0x1
	ldr r1, _080A08F4 @ =gOtherText_ObtainedInTrade
_080A08EC:
	adds r0, r5, 0
	bl StringCopy
	b _080A0930
	.align 2, 0
_080A08F4: .4byte gOtherText_ObtainedInTrade
_080A08F8:
	adds r0, r7, 0
	movs r1, 0x24
	bl GetMonData
	...
	bl sub_80A1E9C
	adds r5, r0, 0
	ldr r1, _080A094C @ =gOtherText_Met2
	bl StringCopy
_080A0930:
	ldr r0, _080A0950 @ =gStringVar4
	mov r1, r9
	mov r2, r8
	bl MenuPrint
	pop {r3,r4}
	...
	bx r0
	.align 2, 0
_080A0948: .4byte gStringVar1
_080A094C: .4byte gOtherText_Met2
_080A0950: .4byte gStringVar4
