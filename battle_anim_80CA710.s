...
_080CCDB8:
	...
	movs r0, 0x10
	strh r0, [r5, 0x3C]
	ldr r1, _080CCE00 @ =0x04000050
	movs r3, 0xFD
	lsls r3, 6
	adds r0, r3, 0
	strh r0, [r1]
	ldr r3, _080CCE04 @ =0x04000052
	ldrh r1, [r5, 0x3C]
	lsls r0, r1, 8
	subs r2, r1
	orrs r0, r2
...
sub_80CCF04: @ 80CCF04
	...
	movs r0, 0x10
	strh r0, [r4, 0x3C]
	ldr r1, _080CCF64 @ =0x04000050
	movs r2, 0xFD
	lsls r2, 6
	adds r0, r2, 0
	strh r0, [r1]
	ldr r2, _080CCF68 @ =0x04000052
	ldrh r0, [r4, 0x3C]
	lsls r0, 8
	ldrh r1, [r4, 0x3A]
	orrs r0, r1
...
_080D1CE4:
	...
	movs r1, 0xA0
	strh r1, [r0]
	ldr r0, _080D1D34 @ =0x04000040
	strh r2, [r0]
	adds r0, 0x4
	strh r1, [r0]
	ldr r1, _080D1D38 @ =0x04000048
...
_080DBE6A:
	strh r1, [r5, 0x20]
	ldr r1, _080DBE8C @ =0x04000050
	movs r2, 0xFD
	lsls r2, 6
	adds r0, r2, 0
	strh r0, [r1]
	ldr r0, _080DBE90 @ =0x04000052
	strh r7, [r0]
...
_080DC74E:
	movs r0, 0x8
	strh r0, [r5, 0x30]
	ldr r1, _080DC770 @ =0x04000050
	movs r2, 0xFD
	lsls r2, 6
	adds r0, r2, 0
	strh r0, [r1]
	ldr r2, _080DC774 @ =0x04000052
	ldrh r1, [r5, 0x30]
	movs r0, 0x10
	subs r0, r1
	lsls r0, 8
...
_080DE1E0:
	...
	strh r0, [r5, 0xE]
	strh r1, [r5, 0x10]
	ldr r1, _080DE244 @ =0x04000050
	movs r2, 0xFD
	lsls r2, 6
	adds r0, r2, 0
	strh r0, [r1]
	ldr r2, _080DE248 @ =0x04000052
	ldrh r0, [r5, 0xE]
	lsls r0, 8
	ldrh r1, [r5, 0xC]
	orrs r0, r1
...
_080DE5C0:
	ldr r1, _080DE5D4 @ =0x04000050
	ldr r3, _080DE5D8 @ =0x00003f44
	adds r0, r3, 0
_080DE5C6:
	strh r0, [r1]
	ldr r1, _080DE5DC @ =0x04000052
	movs r2, 0x80
	lsls r2, 5
	adds r0, r2, 0
	strh r0, [r1]
...
sub_80DFD58: @ 80DFD58
	...
	movs r0, 0
	strh r1, [r2, 0xA]
	ldr r5, _080DFDAC @ =0x04000052
	strh r1, [r5]
	strh r0, [r2, 0xC]
	cmp r3, 0
	bne _080DFDBA
	ldr r0, _080DFDB0 @ =0x04000050
	strh r3, [r0]
	strh r3, [r5]
	adds r0, r4, 0
	bl move_anim_task_del
...
_080E053C:
	...
	cmp r0, 0x1
	bne _080E054C
	ldr r0, _080E0548 @ =0x04000016
	b _080E054E
	.align 2, 0
_080E0548: .4byte 0x04000016
_080E054C:
	ldr r0, _080E0598 @ =0x0400001a
_080E054E:
	str r0, [sp, 0xC]
	movs r3, 0
	add r4, sp, 0xC
...
_080E05BC:
	ldr r1, _080E05FC @ =0x0400004a
	ldr r2, _080E0600 @ =0x00003f3b
_080E05C0:
	adds r0, r2, 0
	strh r0, [r1]
	ldr r1, _080E0604 @ =0x04000048
...
_080E4A00:
	...
	.4byte _080E4C00
_080E4A14:
	ldr r1, _080E4A48 @ =0x04000050
	ldr r3, _080E4A4C @ =0x00001842
	adds r0, r3, 0
	strh r0, [r1]
	ldr r0, _080E4A50 @ =0x04000052
