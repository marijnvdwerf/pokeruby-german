...
sub_80540D0: @ 80540D0
	...
	bhi _0805415E
	lsls r0, 2
	ldr r1, _080540E8 @ =_0805442C
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080540E8: .4byte _0805442C
	.align 2, 0
_080540EC:
	.4byte _08054100
	.4byte _08054114
...
sub_805483C: @ 805483C
	...
	bhi _08054934
	lsls r0, 2
	ldr r1, _08054850 @ =_08054B94
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08054850: .4byte _08054B94
	.align 2, 0
_08054854:
	.4byte _0805488C
	.4byte _080548A2
...
_0805494A:
	lsls r0, 2
	ldr r1, _08054954 @ =_08054C98
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08054954: .4byte _08054C98
	.align 2, 0
_08054958:
	.4byte _08054990
	.4byte _0805499C
...
sub_8054A9C: @ 8054A9C
	...
	bhi _08054B86
	lsls r0, 2
	ldr r1, _08054AB0 @ =_08054DF4
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08054AB0: .4byte _08054DF4
	.align 2, 0
_08054AB4:
	.4byte _08054AEC
	.4byte _08054AF6
...
_08055082:
	lsls r0, 2
	ldr r1, _0805508C @ =_080553D0
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0805508C: .4byte _080553D0
	.align 2, 0
_08055090:
	.4byte _080550E8
	.4byte _08055192
...
npc_something3: @ 8055D70
	...
	bhi _08055DC8
	lsls r0, 2
	ldr r1, _08055D8C @ =_080560D0
	adds r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08055D8C: .4byte _080560D0
	.align 2, 0
_08055D90:
	.4byte _08055DB8
	.4byte _08055DBC
