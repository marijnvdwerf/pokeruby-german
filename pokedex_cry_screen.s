...
sub_811A0C0: @ 811A0C0
	...
	cmp r0, 0x1
	bgt _0811A0D8
	ldr r0, _0811A0D4 @ =0x03006330
	b _0811A0F0
	.align 2, 0
_0811A0D0: .4byte gPcmDmaCounter
_0811A0D4: .4byte 0x03006330
_0811A0D8:
...
_0811A378:
	cmp r2, 0
	beq _0811A384
	ldr r0, _0811A380 @ =0x04000012
	b _0811A3C2
	.align 2, 0
_0811A380: .4byte 0x04000012
_0811A384:
	ldr r0, _0811A388 @ =0x04000010
	b _0811A3C2
	.align 2, 0
...
_0811A38C:
	cmp r2, 0
	beq _0811A398
	ldr r0, _0811A394 @ =0x04000016
	b _0811A3C2
	.align 2, 0
_0811A394: .4byte 0x04000016
_0811A398:
	ldr r0, _0811A39C @ =0x04000014
	b _0811A3C2
	.align 2, 0
...
_0811A3A0:
	cmp r2, 0
	beq _0811A3AC
	ldr r0, _0811A3A8 @ =0x0400001a
	b _0811A3C2
	.align 2, 0
_0811A3A8: .4byte 0x0400001a
_0811A3AC:
	ldr r0, _0811A3B0 @ =0x04000018
	b _0811A3C2
	.align 2, 0
...
_0811A3B4:
	cmp r2, 0
	beq _0811A3C0
	ldr r0, _0811A3BC @ =0x0400001e
	b _0811A3C2
	.align 2, 0
_0811A3BC: .4byte 0x0400001e
_0811A3C0:
	ldr r0, _0811A3C8 @ =0x0400001c
_0811A3C2:
	strh r1, [r0]
_0811A3C4:
	pop {r0}
...
_0811A42C:
	...
	mov r12, r0
	movs r5, 0
	ldr r2, _0811A48C @ =gUnknown_083FAE7C
	mov r9, r2
_0811A446:
	movs r3, 0
	adds r7, r5, 0x1
...
_0811A44C:
	...
	b _0811A4D2
	.align 2, 0
_0811A48C: .4byte gUnknown_083FAE7C
_0811A490:
	ldr r0, _0811A4E4 @ =gCryMeterNeedleSpriteSheets
	bl LoadSpriteSheets
	ldr r0, _0811A4E8 @ =gCryMeterNeedleSpritePalettes
	bl LoadSpritePalettes
	ldr r0, _0811A4EC @ =gSpriteTemplate_83FB774
	ldrb r1, [r4, 0x4]
	lsls r1, 19
	movs r2, 0xA0
	lsls r2, 14
...
_0811A4D2:
	...
	bx r1
	.align 2, 0
_0811A4E4: .4byte gCryMeterNeedleSpriteSheets
_0811A4E8: .4byte gCryMeterNeedleSpritePalettes
_0811A4EC: .4byte gSpriteTemplate_83FB774
_0811A4F0: .4byte 0x0201c800
