...
sub_80413C8: @ 80416EC
	...
	lsrs r0, 24
	add r4, r8
	ldr r2, _080417B8 @ =gSaveBlock1
	lsls r1, r0, 3
	adds r1, r0
	lsls r1, 2
	adds r1, r2
	adds r4, 0xA0
	ldr r0, _080417BC @ =0x00002b4c
	adds r1, r0
	ldm r1!, {r0,r2,r3}
	stm r4!, {r0,r2,r3}
	ldm r1!, {r0,r2,r3}
...
daycare_send: @ 80417C0
	push {lr}
	ldr r0, _080417D8 @ =gUnknown_03005CE0
	ldrb r1, [r0]
	movs r0, 0x64
	muls r0, r1
	ldr r1, _080417DC @ =gPlayerParty
	adds r0, r1
	ldr r1, _080417E0 @ =0x020286d0
	bl sub_80413C8
	pop {r0}
	bx r0
	.align 2, 0
...
sub_8041648: @ 804196C
	push {lr}
	ldr r0, _08041980 @ =0x020286d0
	ldr r1, _08041984 @ =gSpecialVar_0x8004
	ldrb r1, [r1]
	bl sub_8041570
	lsls r0, 16
	lsrs r0, 16
...
sub_80416E8: @ 8041A0C
	...
	lsls r0, 4
	adds r6, r0
	ldr r1, _08041A44 @ =gStringVar1
	adds r0, r6, 0
	bl pokemon_get_nick_
	ldr r0, _08041A48 @ =gStringVar2
	adds r1, r5, 0
	movs r2, 0
	movs r3, 0x2
...
sub_8041770: @ 8041A94
	push {lr}
	ldr r0, _08041AA8 @ =0x020286d0
	ldr r1, _08041AAC @ =gSpecialVar_0x8004
	ldrb r1, [r1]
	bl sub_8041728
	ldr r1, _08041AB0 @ =gSpecialVar_0x8005
	strh r0, [r1]
	pop {r0}
	bx r0
	.align 2, 0
...
sub_8041790: @ 8041AB4
	lsls r0, 16
	lsrs r0, 16
	ldr r2, _08041AD0 @ =gSaveBlock1
	ldr r1, _08041AD4 @ =0x000030ac
	adds r3, r2, r1
	ldr r1, [r3]
	adds r1, r0
	str r1, [r3]
	ldr r1, _08041AD8 @ =0x000030b0
	adds r2, r1
	ldr r1, [r2]
	adds r1, r0
	str r1, [r2]
...
sub_80417B8: @ 8041ADC
	push {r4,r5,lr}
	ldr r5, _08041AFC @ =gSpecialVar_0x8004
	ldrh r1, [r5]
	lsls r0, r1, 2
	adds r0, r1
	lsls r0, 4
	ldr r4, _08041B00 @ =0x020286d0
	adds r0, r4
	movs r1, 0xB
	bl GetBoxMonData
	cmp r0, 0
...
sub_8041870: @ 8041B94
	...
	movs r0, 0
	mov r8, r0
	ldr r0, _08041BC0 @ =gEvolutionTable
	mov r12, r0
_08041BA6:
	movs r7, 0
	movs r6, 0x1
...
pokemon_get_eggmoves: @ 8041E40
	...
	lsrs r3, r0, 16
	movs r2, 0
	ldr r5, _08041E68 @ =gEggMoves
	ldrh r1, [r5]
	ldr r7, _08041E6C @ =0x00004e20
	adds r0, r3, r7
	cmp r1, r0
	bne _08041E70
	movs r4, 0x1
...
_08041E70:
	...
	lsls r0, 16
	lsrs r2, r0, 16
	ldr r0, _08041EDC @ =0x00000471
	ldr r5, _08041EE0 @ =gEggMoves
	cmp r2, r0
	bhi _08041E92
	lsls r0, r2, 1
	adds r0, r5
	ldrh r1, [r0]
	ldr r7, _08041EE4 @ =0x00004e20
	adds r0, r3, r7
	cmp r1, r0
	bne _08041E70
	adds r0, r2, 0x1
...
daycare_build_child_moveset: @ 8041EE8
	...
	str r0, [sp]
	movs r6, 0
	ldr r5, _08041FEC @ =gUnknown_03000500
	movs r2, 0
	ldr r4, _08041FF0 @ =gUnknown_030004D8
	ldr r3, _08041FF4 @ =gUnknown_030004E0
_08041F08:
	lsls r1, r6, 1
	adds r0, r1, r5
	strh r2, [r0]
	...
	bls _08041F08
	movs r6, 0
	ldr r2, _08041FF8 @ =gUnknown_030004E8
	movs r1, 0
_08041F26:
	lsls r0, r6, 1
	adds r0, r2
	...
	bls _08041F26
	movs r6, 0
	ldr r2, _08041FFC @ =gUnknown_03000470
	movs r1, 0
_08041F3C:
	lsls r0, r6, 1
	adds r0, r2
	...
	lsls r0, 16
	lsrs r0, 16
	ldr r1, _08041FFC @ =gUnknown_03000470
	bl sub_804051C
	lsls r0, 24
	lsrs r0, 24
	str r0, [sp, 0x4]
	movs r6, 0
	ldr r1, _08041FF0 @ =gUnknown_030004D8
	mov r8, r1
_08041F6A:
	adds r5, r6, 0
	adds r5, 0xD
	...
	adds r1, r5, 0
	bl GetBoxMonData
	ldr r1, _08041FEC @ =gUnknown_03000500
	adds r4, r1
	strh r0, [r4]
	adds r0, r6, 0x1
	lsls r0, 16
	...
	cmp r6, 0x3
	bls _08041F6A
	ldr r1, _08041FF8 @ =gUnknown_030004E8
	adds r0, r7, 0
	...
	movs r6, 0
_08041FA6:
	ldr r0, _08041FF0 @ =gUnknown_030004D8
	lsls r1, r6, 1
	adds r2, r1, r0
	ldrh r1, [r2]
	mov r9, r0
	...
	bcs _0804200E
	adds r4, r2, 0
	ldr r2, _08042000 @ =0x0000ffff
_08041FBE:
	ldr r0, _08041FF8 @ =gUnknown_030004E8
	lsls r1, r5, 1
	adds r1, r0
	ldrh r0, [r4]
	ldrh r1, [r1]
...
_0804200E:
	...
	lsls r0, 16
	lsrs r6, r0, 16
	ldr r3, _08042138 @ =gUnknown_030004D8
	mov r9, r3
	cmp r6, 0x3
	bls _08041FA6
_0804201C:
...
_0804201E:
	...
	beq _08042080
	movs r5, 0
	ldr r0, _08042138 @ =gUnknown_030004D8
	adds r4, r2, r0
	ldr r6, _0804213C @ =0x0000ffff
	mov r9, r0
_0804203A:
	ldr r3, _08042140 @ =0x00000121
	adds r0, r5, r3
	lsls r0, 16
	lsrs r0, 16
...
_08042080:
	...
	mov r2, r9
	ldrh r0, [r2]
	ldr r3, _08042144 @ =gUnknown_030004E0
	mov r10, r3
	cmp r0, 0
	beq _080420EA
	mov r4, r9
	ldr r0, _08042148 @ =gUnknown_03000500
	mov r9, r0
	mov r12, r10
_080420A0:
	movs r5, 0
...
_080420F4:
	...
	cmp r5, r0
	bcs _0804215C
	ldr r2, _0804213C @ =0x0000ffff
_08042102:
	ldr r1, _0804214C @ =gUnknown_03000470
	lsls r0, r5, 1
	adds r0, r1
	ldrh r1, [r0]
	cmp r1, 0
...
_0804215C:
	...
	cmp r6, 0x3
	bhi _08042174
	ldr r0, _08042184 @ =gUnknown_030004E0
	lsls r1, r6, 1
	adds r1, r0
	ldrh r1, [r1]
	mov r10, r0
...
sub_8042044: @ 8042368
	...
	add r2, sp, 0x10
	bl SetMonData
	ldr r2, _08042418 @ =gUnknown_08209AD4
	adds r0, r7, 0
	movs r1, 0x2
	bl SetMonData
	lsls r2, r5, 3
...
sub_80420FC: @ 8042420
	...
	add r2, sp, 0x10
	bl SetMonData
	ldr r2, _080424BC @ =gUnknown_08209AD4
	adds r0, r6, 0
	movs r1, 0x2
	bl SetMonData
	lsls r2, r5, 3
...
_08042568:
	...
	cmp r0, 0
	bne _0804259C
	ldr r0, _08042598 @ =gSpecialVar_0x8004
	strh r6, [r0]
	movs r0, 0x1
	b _080425B6
	.align 2, 0
...
_080425AA:
	adds r6, 0x1
_080425AC:
	ldr r0, _080425C0 @ =gPlayerPartyCount
	ldrb r0, [r0]
	cmp r6, r0
	bcc _08042568
_080425B4:
...
sub_8042328: @ 804264C
	push {r4-r6,lr}
	ldr r6, _08042678 @ =gUnknown_03005CE0
	ldrb r0, [r6]
	movs r5, 0x64
	muls r0, r5
	ldr r4, _0804267C @ =gPlayerParty
	adds r0, r4
	ldr r1, _08042680 @ =gStringVar1
	bl pokemon_get_nick_
	ldrb r0, [r6]
	muls r0, r5
	adds r0, r4
...
_0804284C:
	...
	movs r1, 0
_08042852:
	ldr r0, _08042864 @ =gStringVar4
	ldr r2, _08042868 @ =gUnknown_08209AC4
	lsls r1, 2
	adds r1, r2
	ldr r1, [r1]
	bl StringCopy
...
AppendGenderSymbol: @ 80428E8
	...
	cmp r0, 0
	bne _08042924
	ldr r1, _08042904 @ =gOtherText_MaleSymbol3
	b _08042926
	.align 2, 0
...
_08042908:
	...
	cmp r0, 0
	bne _08042924
	ldr r1, _08042920 @ =gOtherText_FemaleSymbol3
	b _08042926
	.align 2, 0
_08042920: .4byte gOtherText_FemaleSymbol3
_08042924:
	ldr r1, _08042934 @ =gOtherText_GenderlessSymbol
_08042926:
	adds r0, r4, 0
	bl StringAppend
	pop {r4}
...
_0804296C:
	...
	mov r1, sp
	bl StringCopy
	ldr r4, _080429CC @ =gOtherText_NewLine2
	adds r0, r7, 0
	adds r1, r4, 0
	bl StringAppend
	adds r0, r7, 0
	...
	adds r1, r4, 0
	bl StringAppend
	ldr r1, _080429D0 @ =gOtherText_CancelAndLv
	adds r0, r7, 0
	bl StringAppend
	add sp, 0x28
	pop {r3,r4}
...
_080429EA:
	...
	strb r0, [r4, 0x2]
	adds r0, r4, 0x3
	ldr r1, _08042A4C @ =gOtherText_NewLine2
	bl StringCopy
	adds r4, r0, 0
	adds r0, r5, 0x1
	lsls r0, 24
...
DaycareLevelMenuProcessKeyInput: @ 8042A50
	...
	lsrs r4, r0, 24
	adds r5, r4, 0
	ldr r0, _08042A84 @ =gMain
	ldrh r1, [r0, 0x2E]
	movs r0, 0x40
	ands r0, r1
	cmp r0, 0
	beq _08042A8C
	ldr r0, _08042A88 @ =gTasks
	lsls r1, r4, 2
	adds r1, r4
	lsls r1, 3
	adds r1, r0
...
_08042AC0:
	...
	movs r0, 0x5
	bl PlaySE
	ldr r3, _08042B00 @ =gUnknown_03005CE0
	ldr r2, _08042B04 @ =gScriptResult
	ldr r1, _08042B08 @ =gTasks
	lsls r0, r4, 2
	adds r0, r4
	lsls r0, 3
	adds r0, r1
...
_08042B0C:
	...
	beq _08042B3A
	bl sub_8072DEC
	ldr r0, _08042B40 @ =gUnknown_03005CE0
	ldr r1, _08042B44 @ =gScriptResult
	strh r4, [r1]
	movs r1, 0x2
	strb r1, [r0]
	adds r0, r5, 0
...
ShowDaycareLevelMenu: @ 8042B48
	...
	movs r3, 0x3
	bl InitMenu
	ldr r0, _08042BA8 @ =DaycareLevelMenuProcessKeyInput
	movs r1, 0x3
	bl CreateTask
	add sp, 0x6C
	pop {r4}
...
ChooseSendDaycareMon: @ 8042BAC
	...
	movs r1, 0
	bl OpenPartyMenu
	ldr r1, _08042BC0 @ =gMain
	ldr r0, _08042BC4 @ =c2_exit_to_overworld_2_switch
	str r0, [r1, 0x8]
	pop {r0}
	bx r0
	.align 2, 0
